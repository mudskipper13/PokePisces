...
const u8 gText_PkmnNoLongerExposed[] = _("{STR_VAR_1} is no\nlonger exposed.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnStoppedPanicking[] = _("{STR_VAR_1} stopped\npanicking.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnFriendlyBaseVar2Fell[] = _("{STR_VAR_1} likes you less...");
const u8 gText_PkmnAdoresBaseVar2Fell[] = _("{STR_VAR_1} hates you...");
...
const u8 gText_BoostPp[] = _("Up PP of which move?");
...
const u8 gText_Defense3[] = _("DEFENCE");
...
const u8 gText_DestiWait[] = _("Wait a bit");
...
const u8 gText_PokenavMap_ZoomedOutButtons[] = _("{R_BUTTON}ZOOM {B_BUTTON}CANCEL");
const u8 gText_PokenavMap_CanFlyButtons[] = _("{R_BUTTON}ZOOM {A_BUTTON}FLY {B_BUTTON}CANCEL");
const u8 gText_PokenavMap_ZoomedInButtons[] = _("{R_BUTTON}FULL {B_BUTTON}CANCEL");
...
const u8 gText_TMCase_Blue[] =          _("{COLOR_HIGHLIGHT_SHADOW BLUE TRANSPARENT 2}{STR_VAR_2}");
