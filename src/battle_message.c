...
static const u8 sText_ItemWontLowerCertainStat[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF2}\nprevents {B_BUFF1} loss!");
...
static const u8 sText_PkmnsAllyXPreventsYsZ[] = _("{B_DEF_NAME_WITH_PREFIX}'s ally prevents\n{B_ATK_NAME_WITH_PREFIX}'s\l{B_CURRENT_MOVE} from working!");
...
static const u8 sText_PkmnsAbilityRestoredHPALittle[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}\nrestored its HP a little!");
...
static const u8 sText_ShieldedFromCriticalHits[] = _("The {B_CURRENT_MOVE} shielded {B_ATK_TEAM2} team\nfrom critical hits and super effective moves!");
...
static const u8 sText_PkmnSurroundedWithVeils[] = _("{B_DEF_NAME_WITH_PREFIX} surrounded itself\nwith veils of water and heat!");
...
static const u8 sText_MiasmaDmg[] = _("{B_ATK_NAME_WITH_PREFIX}'s Miasma is hurting\n{B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_AnticipationEvadeActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} anticipated\nan attack!");
...
static const u8 sText_AttackerGotOverInfatuation[] =_("{B_ATK_NAME_WITH_PREFIX} was cured\nby Mental Herb!");
...
static const u8 sText_WaterVeilProtected[] = _("{B_DEF_NAME_WITH_PREFIX} is protected\nby a water veil!");
static const u8 sText_WaterVeilEnters[] = _("{B_DEF_NAME_WITH_PREFIX} was cured\nof its burns!");
...
static const u8 sText_SolarPowerGains[] = _("{B_ATK_NAME_WITH_PREFIX} gained a count of\ndaybreak, putting it at {B_BUFF1}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_ABILITYWEAKENEDFSURROUNDINGMONSSTATS - BATTLESTRINGS_TABLE_START] = sText_AbilityWeakenedSurroundingMonsStats,
    [STRINGID_ABILITYSUMMONEDMIST - BATTLESTRINGS_TABLE_START] = sText_AbilitySummonedMist,
    [STRINGID_ABILITYENTRANCED - BATTLESTRINGS_TABLE_START] = sText_AbilityEntranced,
    ...
    [STRINGID_WATERVEILENTERS - BATTLESTRINGS_TABLE_START] = sText_WaterVeilEnters,
    [STRINGID_WATERVEILPROTECTED - BATTLESTRINGS_TABLE_START] = sText_WaterVeilProtected,
    ...
    [STRINGID_ATTACKERCANTESCAPENOW - BATTLESTRINGS_TABLE_START] = sText_AttackerCantEscapeNow,
    ...
    [STRINGID_PKMNHURTSWITHINATTK - BATTLESTRINGS_TABLE_START] = sText_PkmnHurtsWithInAttk,
    ...
    [STRINGID_PKMNSABILITYRESTOREDHPALITTLE - BATTLESTRINGS_TABLE_START] = sText_PkmnsAbilityRestoredHPALittle,
    ...
    [STRINGID_MIASMADMG - BATTLESTRINGS_TABLE_START] = sText_MiasmaDmg,
    ...
    [STRINGID_STARSGRACESTART - BATTLESTRINGS_TABLE_START] = sText_StarsGraceStart,
    ...
    [STRINGID_ANTICIPATIONEVADEACTIVATES - BATTLESTRINGS_TABLE_START] = sText_AnticipationEvadeActivates,
    ...
    [STRINGID_STRONGHOLDDOESNTALLOW - BATTLESTRINGS_TABLE_START] = sText_StrongholdDoesntAllow,
    ...
    [STRINGID_PKMNSITEMCAUSEBURN - BATTLESTRINGS_TABLE_START] = sText_PkmnsItemCauseBurn,
    ...
    [STRINGID_CURSEDBODYTORMENTED - BATTLESTRINGS_TABLE_START] = sText_CursedBodyTormented,
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_ANTICIPATION_EVADE] = STRINGID_ANTICIPATIONEVADEACTIVATES,
...
const u16 gGotBurnedStringIds[] =
{
    ...
    [B_MSG_STATUSED_BY_ITEM]    = STRINGID_PKMNSITEMCAUSEBURN
};
...
const u8 gText_BattleSwitchWhich[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}\nWhich?");
