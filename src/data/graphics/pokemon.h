...
const u32 gMonFrontPic_LottabatsHuddled[] = INCBIN_U32("graphics/pokemon/100lottabats/huddled/front.4bpp.lz");
const u32 gMonPalette_LottabatsHuddled[] = INCBIN_U32("graphics/pokemon/100lottabats/huddled/normal.gbapal.lz");
const u32 gMonBackPic_LottabatsHuddled[] = INCBIN_U32("graphics/pokemon/100lottabats/huddled/back.4bpp.lz");
const u32 gMonShinyPalette_LottabatsHuddled[] = INCBIN_U32("graphics/pokemon/100lottabats/huddled/shiny.gbapal.lz");
const u8 gMonIcon_LottabatsHuddled[] = INCBIN_U8("graphics/pokemon/100lottabats/huddled/icon.4bpp");
