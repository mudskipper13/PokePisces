...
const struct Tileset gTileset_ozoneinsitute =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_ozoneinsitute,
    .palettes = gTilesetPalettes_ozoneinsitute,
    .metatiles = gMetatiles_ozoneinsitute,
    .metatileAttributes = gMetatileAttributes_ozoneinsitute,
    .callback = NULL,
};

const struct Tileset gTileset_Chimney =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Chimney,
    .palettes = gTilesetPalettes_Chimney,
    .metatiles = gMetatiles_Chimney,
...
const struct Tileset gTileset_Seaside =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Seaside,
    .palettes = gTilesetPalettes_Seaside,
    .metatiles = gMetatiles_Seaside,
    .metatileAttributes = gMetatileAttributes_Seaside,
    .callback = NULL,
};

const struct Tileset gTileset_heypeta =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_heypeta,
    .palettes = gTilesetPalettes_heypeta,
    .metatiles = gMetatiles_heypeta,
    .metatileAttributes = gMetatileAttributes_heypeta,
    .callback = NULL,
};

const struct Tileset gTileset_Golden =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Golden,
    .palettes = gTilesetPalettes_Golden,
    .metatiles = gMetatiles_Golden,
    .metatileAttributes = gMetatileAttributes_Golden,
    .callback = NULL,
};

const struct Tileset gTileset_BirchLab =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_BirchLab,
    .palettes = gTilesetPalettes_BirchLab,
    .metatiles = gMetatiles_BirchLab,
...
const struct Tileset gTileset_OldStoneBuildings =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_OldStoneBuildings,
    .palettes = gTilesetPalettes_OldStoneBuildings,
    .metatiles = gMetatiles_OldStoneBuildings,
