const struct BattleMove gBattleMoves[MOVES_COUNT_Z] =
{
    ...
    [MOVE_ACID] =
    {
        .effect = EFFECT_DEFENSE_DOWN_HIT_2,
        .power = 40,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 30,
    ...
    [MOVE_ARCANE_POWER] =
    {
        .effect = EFFECT_ALL_STATS_UP_2_HIT,
        .power = 70,
        .type = TYPE_DRAGON,
        .accuracy = 90,
        .pp = 5,
    ...
    [MOVE_POWER_JAM] =
    {
        .effect = EFFECT_ALL_STATS_UP_2_HIT_FOE,
        .power = 255,
        .type = TYPE_RELIC,
        .accuracy = 100,
        .pp = 1,
    ...
    [MOVE_GLIMMER] =
    {
        .effect = EFFECT_SP_ATTACK_ACCURACY_UP,
        .power = 0,
        .type = TYPE_FIRE,
        .accuracy = 0,
        .pp = 15,
