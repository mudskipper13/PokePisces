...
const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_PHANTOM_FORCE] = _("Phase Force"),
    ...
    [MOVE_STEAM_ERUPTION] = _("Steam Burst"),
    ...
    [MOVE_STOMPING_TANTRUM] = _("Anger Stomps"),
    ...
    [MOVE_FALSE_SURRENDER] = _("False Forfeit"),
    ...
    [MOVE_DUAL_WINGBEAT] = _("Double Wing"),
    [MOVE_SCORCHING_SANDS] = _("Searing Sands"),
    [MOVE_JUNGLE_HEALING] = _("Florescence"),
    [MOVE_WICKED_BLOW] = _("Wicked Blow"),
    [MOVE_SURGING_STRIKES] = _("Surging Strikes"),
    [MOVE_THUNDER_CAGE] = _("Thunder Cage"),
    [MOVE_DRAGON_ENERGY] = _("Draco Energy"),
    ...
    [MOVE_MOUNTAIN_GALE] = _("Berg Gale"),
    [MOVE_VICTORY_DANCE] = _("Victory Dance"),
    [MOVE_HEADLONG_RUSH] = _("Bull Rush"),
    ...
    [MOVE_LUMINA_CRASH] = _("Psyche Crash"),
    ...
    [MOVE_REVIVAL_BLESSING] = _("Don't Give Up"),
    ...
    [MOVE_KOWTOW_CLEAVE] = _("Cowtow Cleave"),
    ...
    [MOVE_CHILLING_WATER] = _("Chill Water"),
    ...
    [MOVE_DOUBLE_SHOCK] = _("Overcharge"),
    ...
    [MOVE_COLD_MEND] = _("Cold Mend"),
    [MOVE_TERRAIN_SNAP] = _("Terrain Snap"),
    [MOVE_WEATHER_FORCE] = _("Weather Force"),
    [MOVE_VIPER_STRIKE] = _("Viper Strike"),
    ...
    [MOVE_STELLAR_FIST] = _("Stellar Fist"),
    ...
    [MOVE_SPINDA_SWING] = _("Spinda Swing"),
    ...
    [MOVE_MASS_DESTRUCTION] = _("Mass Destruct"),
    ...
    [MOVE_SNAPBLOSSOM] = _("Snapblossom"),
    [MOVE_GRASS_CANNON] = _("Grass Cannon"),
    [MOVE_BOUNDARY] = _("Boundary"),
    [MOVE_SAVAGE_WING] = _("Savage Wing"),
    [MOVE_PLASMA_CUTTER] = _("Plasma Cutter"),
    [MOVE_PARTY_TRICK] = _("Party Trick"),
    [MOVE_MYTH_BUSTER] = _("Myth Buster"),
    [MOVE_DANCE_MANIA] = _("Dance Mania"),
    [MOVE_HOT_STEP] = _("Hot Step"),
    [MOVE_VINE_PALM_STRIKE] = _("Vine Palm Strike"),
    [MOVE_BEATBOX] = _("Beatbox"),
    [MOVE_LEG_DAY] = _("Leg Day"),
    [MOVE_EVAPORATE] = _("Evaporate"),
    [MOVE_RED_EYES] = _("Red Eyes"),
    [MOVE_JUMP_N_POP] = _("Jump & Pop"),
    [MOVE_IGNITION] = _("Ignition"),
    [MOVE_SHARP_GLIDE] = _("Sharp Glide"),
    [MOVE_CRASH_LAND] = _("Crash Land"),
    [MOVE_AIR_CANNON] = _("Air Cannon"),
    [MOVE_BANSHRIEK] = _("Banshriek"),
    [MOVE_GREEN_GUISE] = _("Green Guise"),
    [MOVE_SAND_BURIAL] = _("Sand Burial"),
    [MOVE_RAGING_EARTH] = _("Raging Earth"),
    [MOVE_WILDER_DANCE] = _("Wilder Dance"),
    [MOVE_FROST_SHRED] = _("Frost Shred"),
    [MOVE_GLACIAL_SHIFT] = _("Glacial Shift"),
    [MOVE_AXEL_HEEL] = _("Axel Heel"),
    [MOVE_SNOWFADE] = _("Snowfade"),
    [MOVE_BREAK_LANCE] = _("Break Lance"),
    [MOVE_GRAND_SLAM] = _("Grand Slam"),
    [MOVE_BEAT_DROP] = _("Beat Drop"),
    [MOVE_PURIFICATION] = _("Purification"),
    [MOVE_SURPRISE_EGG] = _("Surprise Egg"),
    [MOVE_POISON_DART] = _("Poison Dart"),
    [MOVE_GRAVITON_ARM] = _("Graviton Arm"),
    [MOVE_PSY_SWAP] = _("Psy Swap"),
    [MOVE_STALAG_BLAST] = _("Stalag Blast"),
    [MOVE_MOON_BEAM] = _("Moon Beam"),
    [MOVE_HUNKER_DOWN] = _("Hunker Down"),
    [MOVE_SHIELDS_UP] = _("Shields Up"),
    [MOVE_HAYWIRE] = _("Haywire"),
    [MOVE_OVERTAKE] = _("Overtake"),
    [MOVE_SILVER_EDGE] = _("Silver Edge"),
    [MOVE_HEAVY_SWING] = _("Heavy Swing"),
    [MOVE_HIGH_ROLL_HIT] = _("High Roll Hit"),
    [MOVE_SHARPSHOOT] = _("Sharpshoot"),
    [MOVE_RAZOR_BEAM] = _("Razor Beam"),
    [MOVE_AQUASCADE] = _("Aquascade"),
    [MOVE_TORPEDOES] = _("Torpedoes"),
...
const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_LIQUIDATION] = _("Liquidation"),
    [MOVE_PRISMATIC_LASER] = _("Prism Laser"),
    [MOVE_SPECTRAL_THIEF] = _("PhantomThief"),
    [MOVE_SUNSTEEL_STRIKE] = _("MeteorStrike"),
    [MOVE_MOONGEIST_BEAM] = _("Eclipse Ray"),
    [MOVE_TEARFUL_LOOK] = _("Tearful Look"),
    [MOVE_ZING_ZAP] = _("Zing Zap"),
    [MOVE_NATURES_MADNESS] = _("Nature's Fury"),
    ...
    [MOVE_TRIPLE_AXEL] = _("Triple Axel"),
    [MOVE_DUAL_WINGBEAT] = _("Double Wing"),
    [MOVE_SCORCHING_SANDS] = _("SearingSands"),
    [MOVE_JUNGLE_HEALING] = _("Florescence"),
    [MOVE_WICKED_BLOW] = _("Wicked Blow"),
    ...
    [MOVE_ICE_SPINNER] = _("Ice Spinner"),
    [MOVE_GLAIVE_RUSH] = _("Glaive Rush"),
    [MOVE_REVIVAL_BLESSING] = _("Don'tGiveUp"),
    [MOVE_SALT_CURE] = _("Salt Cure"),
    [MOVE_TRIPLE_DIVE] = _("Triple Dive"),
    [MOVE_MORTAL_SPIN] = _("Mortal Spin"),
    [MOVE_DOODLE] = _("Doodle"),
    ...
    [MOVE_COLD_MEND] = _("Cold Mend"),
    [MOVE_TERRAIN_SNAP] = _("Terrain Snap"),
    [MOVE_WEATHER_FORCE] = _("WeatherForce"),
    [MOVE_VIPER_STRIKE] = _("Viper Strike"),
    [MOVE_THINK_FAST] = _("Think Fast"),
    [MOVE_PINPOINT] = _("Pinpoint"),
    [MOVE_WATER_FLOG] = _("Water Flog"),
