const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GROWLITHE]             = {{EVO_MOVE, MOVE_RAGING_FURY, SPECIES_ARCANINE}},
    [SPECIES_GROWLITHE_HISUIAN]     = {{EVO_MOVE, MOVE_RAGING_FURY, SPECIES_ARCANINE_HISUIAN}},
    ...
    [SPECIES_LEDYBA]                = {{EVO_LEVEL, 20, SPECIES_LEDIAN}},
    ...
    [SPECIES_SEEDOT]                = {{EVO_LEVEL, 16, SPECIES_NUZLEAF}},
    [SPECIES_NUZLEAF]               = {{EVO_ITEM_HOLD, ITEM_EERIE_MASK, SPECIES_SHIFTRY}},
    ...
    [SPECIES_ZORUA]                 = {{EVO_ITEM_HOLD, ITEM_COMEDY_MASK, SPECIES_ZERAORA},
                                       {EVO_ITEM_HOLD, ITEM_TRAGEDY_MASK, SPECIES_ZARUDE}},
    ...
    [SPECIES_PAWNIARD]              = {{EVO_LEVEL, 32, SPECIES_BISHARP}},
    [SPECIES_BISHARP]               = {{EVO_ITEM_HOLD, ITEM_LEADERS_CREST, SPECIES_KINGAMBIT}},
    ...
    [SPECIES_SYCOPLOD]              = {{EVO_LEVEL, 31, SPECIES_SYCOSTROM}},
    [SPECIES_GUPSPAR]               = {{EVO_LEVEL, 20, SPECIES_VANGAR}},
    [SPECIES_VANGAR]                = {{EVO_FRIENDSHIP_MOVE_TYPE, TYPE_FLYING, SPECIES_GHAERIAL}},
    [SPECIES_QUILWARD]              = {{EVO_LEVEL, 18, SPECIES_BONFEU}},
    [SPECIES_BONFEU]                = {{EVO_LEVEL, 34, SPECIES_INFRAREC}},
    [SPECIES_BERM]                  = {{EVO_LEVEL, 16, SPECIES_MOODA}},
    [SPECIES_MOODA]                 = {{EVO_LEVEL, 38, SPECIES_BERMUDON}},
    [SPECIES_ICKSQUEEK]             = {{EVO_LEVEL, 27, SPECIES_KOMORODE}},
    [SPECIES_EBIBI]                 = {{EVO_LEVEL, 22, SPECIES_MAKIBI}},
    [SPECIES_MAKIBI]                = {{EVO_LEVEL, 42, SPECIES_EBIROSASHI}},    
    [SPECIES_KITIKITI]              = {{EVO_LEVEL, 14, SPECIES_MOSKOPO}},
    [SPECIES_MOSKOPO]               = {{EVO_LEVEL_FEMALE_BERSERK_GENE, 44, SPECIES_ABSOLARIA}},
    [SPECIES_KYUDI]                 = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_KOMBAKYU}},
    [SPECIES_FLUFFSIR]              = {{EVO_FRIENDSHIP, 0, SPECIES_FLUFFREAR}},
    [SPECIES_SAINTISOW]             = {{EVO_MED_FRIENDSHIP, 0, SPECIES_SANCTISOW}},
    ...
    [SPECIES_SPRYTE]                = {{EVO_HIT_BY_SLASH_MOVE, 25, SPECIES_GUMONA},
                                       {EVO_HIT_BY_PIERCE_MOVE, 25, SPECIES_NANGGAL},
                                       {EVO_HIT_BY_BLUNT_MOVE, 25, SPECIES_SHEEDRAKE}},
    ...
    [SPECIES_COFFIDDLE]             = {{EVO_LEVEL, 36, SPECIES_CRAVERAVE}},
    [SPECIES_FUZKY]                 = {{EVO_MOVE, MOVE_REST, SPECIES_COOLMUTTE}},
    [SPECIES_CREAM]                 = {{EVO_LEVEL, 33, SPECIES_CREMELETTS}},
    [SPECIES_SNURROWL]              = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_STOLYCE}},
    [SPECIES_MARINAROC]             = {{EVO_ITEM_HOLD, ITEM_METAL_COAT, SPECIES_METTATOLL}},
    [SPECIES_POMELONIAN]            = {{EVO_LEVEL, 30, SPECIES_GOURDOUG}},
    [SPECIES_MATCHLIT]              = {{EVO_FRIENDSHIP, 0, SPECIES_YAGANGRAN}},
    [SPECIES_PIDIUM]                = {{EVO_LEVEL, 36, SPECIES_MEDGEON}},
    [SPECIES_MAGGORDE]              = {{EVO_LEVEL, 14, SPECIES_FLAGUE}},
    [SPECIES_FLAGUE]                = {{EVO_LEVEL_MALE_KINGS_ROCK, 44, SPECIES_CULTIPEX}},
    [SPECIES_EERIKO]                = {{EVO_LEVEL, 22, SPECIES_MANNIKO}},
    [SPECIES_MANNIKO]               = {{EVO_LEVEL, 32, SPECIES_KOWAKO}},
    [SPECIES_UMBRAT]                = {{EVO_LEVEL, 22, SPECIES_CHIROBERRA}},
    [SPECIES_CHIROBERRA]            = {{EVO_FRIENDSHIP, 0, SPECIES_WEROBERRA}},
    [SPECIES_SACKYTWACK]            = {{EVO_LEVEL, 28, SPECIES_STRAWNGMAN}},
    [SPECIES_BUTTERWEE]             = {{EVO_LEVEL, 25, SPECIES_PETRIPA}},
    [SPECIES_PETRIPA]               = {{EVO_LEVEL, 45, SPECIES_CATTOWYRM}},
    [SPECIES_BRAMBOOZLE]            = {{EVO_LEVEL, 30, SPECIES_HOAXPOCUS}},
    [SPECIES_PITAGON]               = {{EVO_POISONED, 0, SPECIES_PUTREGON}},
    [SPECIES_GOLTIGATOR]            = {{EVO_MOVE, MOVE_STORM_FURY, SPECIES_KAPRIKOLA}},
    [SPECIES_BLOTTA]                = {{EVO_MOVE, MOVE_BITTER_MALICE, SPECIES_SCHACHTTA}},
    [SPECIES_CATTUCLID]             = {{EVO_LEVEL, 35, SPECIES_FRACTOFLY}},
    [SPECIES_GRAVELITO]             = {{EVO_MOVE, MOVE_GRASS_WHISTLE, SPECIES_MEGALITO}},
    [SPECIES_COMBUN]                = {{EVO_BATTLE_TERRAIN, BATTLE_TERRAIN_SNOW_ROUTE, SPECIES_HAIBUN},
                                       {EVO_BATTLE_TERRAIN, BATTLE_TERRAIN_SAND, SPECIES_BURBUN}, 
                                       {EVO_BATTLE_TERRAIN, BATTLE_TERRAIN_BUILDING, SPECIES_INGBUN}}, 
    [SPECIES_COBBTLE]               = {{EVO_ITEM_HOLD, ITEM_KINGS_ROCK, SPECIES_MONTORT}},
    [SPECIES_CORISP]                = {{EVO_MOVE, MOVE_RAGING_FURY, SPECIES_KROLPYRE}},
    [SPECIES_TOXITIDE]              = {{EVO_LEVEL, 35, SPECIES_TOXITURF}},
    [SPECIES_PEBBLER]               = {{EVO_ITEM, ITEM_SANDSTONE, SPECIES_DUNEWICH},
                                       {EVO_ITEM, ITEM_SANDBAG, SPECIES_MAJADIJUNN}, 
    ...
    [SPECIES_WANNEGG]               = {{EVO_LEVEL, 32, SPECIES_EGGNEGGMA}},
    [SPECIES_LEVLADE]               = {{EVO_LEVEL, 20, SPECIES_SHOCKORE}},
    [SPECIES_SHOCKORE]              = {{EVO_FRIENDSHIP, 0, SPECIES_PLASMANTIS}},
    [SPECIES_HARACE]                = {{EVO_LEVEL, 28, SPECIES_TORSTEVIC}},
    [SPECIES_CHIKA]                 = {{EVO_LEVEL_ATK_GT_SPATK, 30, SPECIES_SWORDUC},
                                       {EVO_LEVEL_ATK_LT_SPATK, 30, SPECIES_GOSMARK}},
    [SPECIES_RAITAIC]               = {{EVO_MOVE, MOVE_STORM_FURY, SPECIES_NIMBOZOA}},
    [SPECIES_MINOTE]                = {{EVO_LEVEL, 20, SPECIES_TUNAP}},
    [SPECIES_TUNAP]                 = {{EVO_LEVEL, 40, SPECIES_BASSHARK}},
    [SPECIES_SHARGUY]               = {{EVO_LEVEL, 20, SPECIES_SHARPREY}},
    [SPECIES_SHARPREY]              = {{EVO_LEVEL, 40, SPECIES_CHUNGRIM}},
    [SPECIES_SQUEESHY]              = {{EVO_LEVEL, 20, SPECIES_SQUISHIME}},
    [SPECIES_SQUISHIME]             = {{EVO_LEVEL, 40, SPECIES_OCTOHIME}},
    [SPECIES_COLFIN]                = {{EVO_LEVEL_DARK_TYPE_MON_IN_PARTY, 38, SPECIES_MYSTICIAN}},
    [SPECIES_SCALLYWARG]            = {{EVO_LEVEL, 30, SPECIES_WAARGH},
                                       {EVO_ITEM_HOLD, ITEM_CURSED_AMULET, SPECIES_SKELLYWARG}},
    [SPECIES_CASOWARY]              = {{EVO_PANICKED, 0, SPECIES_PASSAWARY}},
    [SPECIES_BOOZARD]               = {{EVO_LEVEL, 35, SPECIES_COCKABOO}},
    [SPECIES_SUDCUB]                = {{EVO_FRIENDSHIP, 0, SPECIES_TARDRITCH}},
    [SPECIES_DRAKULARK]             = {{EVO_LEVEL, 30, SPECIES_NOSFERAPTR}},
    [SPECIES_GARJIRA]               = {{EVO_ITEM_HOLD, ITEM_DRAGON_SCALE, SPECIES_GARZILLA}},
    [SPECIES_RETROROACH]            = {{EVO_ITEM_HOLD, ITEM_NEO_BATTERY, SPECIES_NEOROACH}},
    [SPECIES_SPITFAX]               = {{EVO_ITEM_HOLD, ITEM_BERRY_MIC, SPECIES_RAPSCALEON}},
    [SPECIES_AGOMAGO]               = {{EVO_LEVEL, 25, SPECIES_MORFTREE}},
    [SPECIES_MORFTREE]              = {{EVO_LEVEL, 45, SPECIES_EPOCHOTL}},
    [SPECIES_VIVISU]                = {{EVO_LEVEL, 30, SPECIES_SOLASU}},
    [SPECIES_SOLASU]                = {{EVO_LEVEL, 55, SPECIES_SUMMERASU}},
    [SPECIES_OROFLOW]               = {{EVO_LEVEL, 30, SPECIES_ORROCAST}},
    [SPECIES_ORROCAST]              = {{EVO_LEVEL, 55, SPECIES_ORROWHELM}},
    [SPECIES_INFAIRNO]              = {{EVO_SILENCE_ACTIVATED, 1, SPECIES_PURGATIVAL}},
#endif
