...
const u16 gEggMoves[] = {
    ...
    egg_moves(SPIRITOAST,
        MOVE_MEMENTO,
        MOVE_JUMP_N_POP,
        MOVE_ENDURE),

    egg_moves(DUDUNSPARS,
        MOVE_DIG,
        MOVE_DRAGON_DANCE,
        MOVE_WILDER_DANCE,
        MOVE_QUIVER_DANCE),
    ...
    egg_moves(CINDRILLON,
        MOVE_HORN_DRILL,
        MOVE_QUIVER_DANCE,
        MOVE_IGNITION,
        MOVE_SWORDS_DANCE),

    egg_moves(ARMAGATTON,
        MOVE_ELECTRO_SHOT,
        MOVE_UPPER_HAND,
        MOVE_HEAVY_CANNON,
        MOVE_HEAVY_CELL,
