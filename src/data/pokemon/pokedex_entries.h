const struct PokedexEntry gPokedexEntries[] =
{
    ...
    {
        .categoryName = _("Feeding"),
        .height = 1,
        .weight = 3,
        .description = gMaggordePokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FLAGUE] =
    {
        ...
        .height = 8,
        .weight = 55,
        .description = gFlaguePokedexText,
        .pokemonScale = 383,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Abhorrent"),
        .height = 21,
        .weight = 800,
        .description = gCultipexPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 365,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_EERIKO] =
    {
        ...
        .height = 4,
        .weight = 8,
        .description = gEerikoPokedexText,
        .pokemonScale = 440,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MANNIKO] =
    {
        ...
        .height = 8,
        .weight = 28,
        .description = gMannikoPokedexText,
        .pokemonScale = 354,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_KOWAKO] =
    {
        ...
        .height = 15,
        .weight = 65,
        .description = gKowakoPokedexText,
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_UMBRAT] =
    {
        ...
        .height = 3,
        .weight = 68,
        .description = gUmbratPokedexText,
        .pokemonScale = 571,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CHIROBERRA] =
    {
        ...
        .height = 9,
        .weight = 143,
        .description = gChiroberraPokedexText,
        .pokemonScale = 293,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WEROBERRA] =
    {
        ...
        .height = 21,
        .weight = 850,
        .description = gWeroberraPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_SACKYTWACK] =
    {
        ...
        .height = 1,
        .weight = 3,
        .description = gSackytwackPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LAWPARD] =
    {
        ...
        .height = 13,
        .weight = 327,
        .description = gLawpardPokedexText,
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Smoky Ape"),
        .height = 18,
        .weight = 630,
        .description = gOohbaabaPokedexText,
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    {
        .categoryName = _("Unyielding"),
        .height = 11,
        .weight = 2300,
        .description = gGolderockPokedexText,
        .pokemonScale = 378,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Sugar Rock"),
        .height = 3,
        .weight = 49,
        .description = gMaynimoPokedexText,
        .pokemonScale = 593,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Small"),
        .height = 3,
        .weight = 5,
        .description = gButterweePokedexText,
        .pokemonScale = 508,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PETRIPA] =
    {
        ...
        .height = 8,
        .weight = 710,
        .description = gPetripaPokedexText,
        .pokemonScale = 372,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CATTOWYRM] =
    {
        ...
        .height = 100,
        .weight = 3050,
        .description = gCattowyrmPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 788,
        .trainerOffset = 18,
    ...
    {
        .categoryName = _("Thorn Pox"),
        .height = 7,
        .weight = 31,
        .description = gBramboozlePokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Pollen Pox"),
        .height = 15,
        .weight = 130,
        .description = gHoaxpocusPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
        .trainerOffset = -1,
    ...
    {
        .categoryName = _("Pulpy"),
        .height = 3,
        .weight = 18,
        .description = gPitagonPokedexText,
        .pokemonScale = 541,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PUTREGON] =
    {
        ...
        .height = 23,
        .weight = 1100,
        .description = gPutregonPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
    ...
    {
        .categoryName = _("Sky Bolt"),
        .height = 8,
        .weight = 166,
        .description = gGoltigatorPokedexText,
        .pokemonScale = 366,
        .pokemonOffset = 11,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Empyrean"),
        .height = 25,
        .weight = 1005,
        .description = gKaprikolaPokedexText,
        .pokemonScale = 257,
        .pokemonOffset = 0,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [NATIONAL_DEX_BLOTTA] =
    {
        ...
        .height = 4,
        .weight = 80,
        .description = gBlottaPokedexText,
        .pokemonScale = 480,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Corrupt"),
        .height = 9,
        .weight = 188,
        .description = gSchachttaPokedexText,
        .pokemonScale = 413,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Spearhead"),
        .height = 24,
        .weight = 1006,
        .description = gSylvreignPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    {
        .categoryName = _("Pattern"),
        .height = 7,
        .weight = 288,
        .description = gCattuclidPokedexText,
        .pokemonScale = 350,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Unending"),
        .height = 27,
        .weight = 920,
        .description = gFractoflyPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Sun Praise"),
        .height = 3,
        .weight = 234,
        .description = gGravelitoPokedexText,
        .pokemonScale = 541,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEGALITO] =
    {
        ...
        .height = 12,
        .weight = 1205,
        .description = gMegalitoPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_COMBUN] =
    {
        .categoryName = _("Adaptation"),
        .height = 8,
        .weight = 65,
        .description = gCombunPokedexText,
        .pokemonScale = 283,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HAIBUN] =
    {
        ...
        .height = 9,
        .weight = 74,
        .description = gHaibunPokedexText,
        .pokemonScale = 306,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BURBUN] =
    {
        ...
        .height = 12,
        .weight = 92,
        .description = gBurbunPokedexText,
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_INGBUN] =
    {
        ...
        .height = 11,
        .weight = 277,
        .description = gIngbunPokedexText,
        .pokemonScale = 339,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Roasting"),
        .height = 10,
        .weight = 293,
        .description = gChaffawPokedexText,
        .pokemonScale = 320,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FERROR] =
    {
        .categoryName = _("Impenetrable"),
        .height = 20,
        .weight = 3200,
        .description = gFerrorPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 300,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_COBBTLE] =
    {
        ...
        .height = 7,
        .weight = 1257,
        .description = gCobbtlePokedexText,
        .pokemonScale = 365,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MONTORT] =
    {
        ...
        .height = 24,
        .weight = 3100,
        .description = gMontortPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    {
        .categoryName = _("Land Whale"),
        .height = 300,
        .weight = 9999,
        .description = gBolterockPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 2797,
        .trainerOffset = 18,
    ...
    [NATIONAL_DEX_VOREON] =
    {
        .categoryName = _("Voracious"),
        .height = 5,
        .weight = 148,
        .description = gVoreonPokedexText,
        .pokemonScale = 481,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CORISP] =
    {
        .categoryName = _("Fire Coral"),
        .height = 5,
        .weight = 39,
        .description = gCorispPokedexText,
        .pokemonScale = 539,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_KROLPYRE] =
    {
        ...
        .height = 15,
        .weight = 780,
        .description = gKrolpyrePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 269,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_TOXITIDE] =
    {
        ...
        .height = 3,
        .weight = 87,
        .description = gToxitidePokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TOXITURF] =
    {
        ...
        .height = 17,
        .weight = 270,
        .description = gToxiturfPokedexText,
        .pokemonScale = 307,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Sand Doll"),
        .height = 9,
        .weight = 180,
        .description = gPebblerPokedexText,
        .pokemonScale = 258,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Sand Witch"),
        .height = 22,
        .weight = 1495,
        .description = gDunewichPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    {
        .categoryName = _("Sand Djinn"),
        .height = 34,
        .weight = 1884,
        .description = gMajadijunnPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 405,
        .trainerOffset = 8,
    ...
    [NATIONAL_DEX_CAPYBARA] =
    {
        ...
        .height = 11,
        .weight = 405,
        .description = gCapybaraPokedexText,
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ABARBINASH] =
    {
        ...
        .height = 21,
        .weight = 995,
        .description = gAbarbinashPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 423,
        .trainerOffset = 11,
    ...
    {
        .categoryName = _("Adversity"),
        .height = 49,
        .weight = 930,
        .description = gJarameraPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    {
        .categoryName = _("Pompous"),
        .height = 24,
        .weight = 2200,
        .description = gBlinguinPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_BIYAKO] =
    {
        ...
        .height = 5,
        .weight = 101,
        .description = gBiyakoPokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BEHEKO] =
    {
        ...
        .height = 21,
        .weight = 550,
        .description = gBehekoPokedexText,
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_HEMOKO] =
    {
        .categoryName = _("White"),
        .height = 1,
        .weight = 1,
        .description = gHemokoPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Lepus"),
        .height = 8,
        .weight = 4,
        .description = gLepucytePokedexText,
        .pokemonScale = 439,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Revenge"),
        .height = 40,
        .weight = 130,
        .description = gLeukunehoPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 411,
        .trainerOffset = 5,
    ...
    [NATIONAL_DEX_WELPROOT] =
    {
        ...
        .height = 8,
        .weight = 97,
        .description = gWelprootPokedexText,
        .pokemonScale = 366,
        .pokemonOffset = 9,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Root Drake"),
        .height = 16,
        .weight = 548,
        .description = gDraekarotPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 312,
        .trainerOffset = 1,
    ...
    {
        .categoryName = _("Great Drake"),
        .height = 40,
        .weight = 1266,
        .description = gKarodoraugPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 411,
        .trainerOffset = 5,
    ...
    [NATIONAL_DEX_COFORCHEE] =
    {
        ...
        .height = 8,
        .weight = 755,
        .description = gCoforcheePokedexText,
        .pokemonScale = 372,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Baneful"),
        .height = 4,
        .weight = 330,
        .description = gMustybanePokedexText,
        .pokemonScale = 324,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WANNEGG] =
    {
        ...
        .height = 3,
        .weight = 7,
        .description = gWanneggPokedexText,
        .pokemonScale = 288,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_EGGNEGGMA] =
    {
        ...
        .height = 15,
        .weight = 280,
        .description = gEggneggmaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 302,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_LEVLADE] =
    {
        ...
        .height = 3,
        .weight = 36,
        .description = gLevladePokedexText,
        .pokemonScale = 508,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SHOCKORE] =
    {
        ...
        .height = 9,
        .weight = 106,
        .description = gShockorePokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PLASMANTIS] =
    {
        ...
        .height = 18,
        .weight = 560,
        .description = gPlasmantisPokedexText,
        .pokemonScale = 278,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HARACE] =
    {
        ...
        .height = 7,
        .weight = 80,
        .description = gHaracePokedexText,
        .pokemonScale = 365,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Maglev"),
        .height = 11,
        .weight = 804,
        .description = gTorstevicPokedexText,
        .pokemonScale = 312,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Melee"),
        .height = 22,
        .weight = 1128,
        .description = gSworducPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [NATIONAL_DEX_GOSMARK] =
    {
        ...
        .height = 9,
        .weight = 592,
        .description = gGosmarkPokedexText,
        .pokemonScale = 293,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CORDELICT] =
    {
        ...
        .height = 9,
        .weight = 380,
        .description = gCordelictPokedexText,
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MERALCORE] =
    {
        ...
        .height = 18,
        .weight = 1557,
        .description = gMeralcorePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Electrojelly"),
        .height = 10,
        .weight = 6,
        .description = gRaitaicPokedexText,
        .pokemonScale = 366,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_NIMBOZOA] =
    {
        ...
        .height = 21,
        .weight = 60,
        .description = gNimbozoaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 365,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_MINOTE] =
    {
        .categoryName = _("Small Fish"),
        .height = 2,
        .weight = 26,
        .description = gMinotePokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Sea Whale"),
        .height = 90,
        .weight = 2200,
        .description = gBassharkPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 516,
        .trainerOffset = 13,
    ...
    {
        .categoryName = _("Nibbling"),
        .height = 2,
        .weight = 35,
        .description = gSharguyPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Leeching"),
        .height = 33,
        .weight = 888,
        .description = gSharpreyPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 405,
        .trainerOffset = 8,
    ...
    {
        .categoryName = _("Chunking"),
        .height = 187,
        .weight = 4600,
        .description = gChungrimPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 1838,
        .trainerOffset = 19,
    ...
    {
        .categoryName = _("Squishy"),
        .height = 5,
        .weight = 29,
        .description = gSqueeshyPokedexText,
        .pokemonScale = 412,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SQUISHIME] =
    {
        ...
        .height = 12,
        .weight = 87,
        .description = gSquishimePokedexText,
        .pokemonScale = 280,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Ruler"),
        .height = 20,
        .weight = 199,
        .description = gOctohimePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 5,
    ...
    [NATIONAL_DEX_COLFIN] =
    {
        ...
        .height = 12,
        .weight = 455,
        .description = gColfinPokedexText,
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MYSTICIAN] =
    {
        ...
        .height = 37,
        .weight = 909,
        .description = gMysticianPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 610,
        .trainerOffset = 17,
    ...
    {
        .categoryName = _("Oxidize"),
        .height = 26,
        .weight = 2910,
        .description = gWalrustPokedexText,
        .pokemonScale = 266,
        .pokemonOffset = 3,
        .trainerScale = 399,
        .trainerOffset = 4,
    ...
    {
        .categoryName = _("Sea Pup"),
        .height = 6,
        .weight = 99,
        .description = gScallywargPokedexText,
        .pokemonScale = 542,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WAARGH] =
    {
        .categoryName = _("Sea Dog"),
        .height = 14,
        .weight = 307,
        .description = gWaarghPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Sea Beard"),
        .height = 21,
        .weight = 505,
        .description = gSkellywargPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 365,
        .trainerOffset = 7,
    ...
    {
        .categoryName = _("Frightened"),
        .height = 15,
        .weight = 295,
        .description = gCasowaryPokedexText,
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Passed Out"),
        .height = 27,
        .weight = 296,
        .description = gPassawaryPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Glow Eye"),
        .height = 8,
        .weight = 40,
        .description = gBoozardPokedexText,
        .pokemonScale = 362,
        .pokemonOffset = -5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_COCKABOO] =
    {
        ...
        .height = 28,
        .weight = 488,
        .description = gCockabooPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 3,
        .trainerScale = 300,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Ice Heel"),
        .height = 11,
        .weight = 250,
        .description = gAxelfinPokedexText,
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Ice Claw"),
        .height = 4,
        .weight = 266,
        .description = gMoraganPokedexText,
        .pokemonScale = 457,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SHIVERSNAP] =
    {
        ...
        .height = 40,
        .weight = 655,
        .description = gShiversnapPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 411,
        .trainerOffset = 5,
    ...
    {
        .categoryName = _("Bulldozer"),
        .height = 16,
        .weight = 1305,
        .description = gExcatatorPokedexText,
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    {
        .categoryName = _("Killer Bean"),
        .height = 3,
        .weight = 33,
        .description = gMarsoyartPokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Fire Screw"),
        .height = 3,
        .weight = 100,
        .description = gCindrillonPokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Some Hand"),
        .height = 16,
        .weight = 1870,
        .description = gArmagattonPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("False Snake"),
        .height = 1,
        .weight = 34,
        .description = gFakysnakyPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Legwear"),
        .height = 10,
        .weight = 160,
        .description = gPantneyPokedexText,
        .pokemonScale = 341,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_NYARLY] =
    {
        .categoryName = _("Feline"),
        .height = 7,
        .weight = 70,
        .description = gNyarlyPokedexText,
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SUDCUB] =
    {
        .categoryName = _("Waterbear"),
        .height = 10,
        .weight = 110,
        .description = gSudcubPokedexText,
        .pokemonScale = 360,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = -1,
    ...
    {
        .categoryName = _("Elderbeast"),
        .height = 33,
        .weight = 1355,
        .description = gTardritchPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 405,
        .trainerOffset = 8,
    ...
    [NATIONAL_DEX_BLABBU] =
    {
        ...
        .height = 4,
        .weight = 325,
        .description = gBlabbuPokedexText,
        .pokemonScale = 513,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TURRYTURRY] =
    {
        ...
        .height = 3,
        .weight = 1,
        .description = gTurryturryPokedexText,
        .pokemonScale = 288,
        .pokemonOffset = -9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PROMISCBUS] =
    {
        ...
        .height = 18,
        .weight = 406,
        .description = gPromiscbusPokedexText,
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_GUMBORREE] =
    {
        ...
        .height = 17,
        .weight = 392,
        .description = gGumborreePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 275,
        .trainerOffset = 2,
    ...
    {
        .categoryName = _("Backup"),
        .height = 8,
        .weight = 144,
        .description = gKoremaiPokedexText,
        .pokemonScale = 418,
        .pokemonOffset = -4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_KORESATO] =
    {
        ...
        .height = 8,
        .weight = 142,
        .description = gKoresatoPokedexText,
        .pokemonScale = 418,
        .pokemonOffset = -4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DRAKULARK] =
    {
        ...
        .height = 3,
        .weight = 23,
        .description = gDrakularkPokedexText,
        .pokemonScale = 465,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Atrocity"),
        .height = 13,
        .weight = 198,
        .description = gNosferaptrPokedexText,
        .pokemonScale = 290,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Salvation"),
        .height = 11,
        .weight = 300,
        .description = gOlFlookiePokedexText,
        .pokemonScale = 327,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_JUSTRICHA] =
    {
        ...
        .height = 30,
        .weight = 591,
        .description = gJustrichaPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("lasreveR"),
        .height = 8,
        .weight = 252,
        .description = gAjokujokuPokedexText,
        .pokemonScale = 362,
        .pokemonOffset = -5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Cat Dragon"),
        .height = 10,
        .weight = 123,
        .description = gGarjiraPokedexText,
        .pokemonScale = 320,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GARZILLA] =
    {
        ...
        .height = 19,
        .weight = 1130,
        .description = gGarzillaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 299,
        .trainerOffset = 2,
    ...
    {
        .categoryName = _("Adoration"),
        .height = 18,
        .weight = 468,
        .description = gYandemicPokedexText,
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_LUNASTER] =
    {
        ...
        .height = 12,
        .weight = 130,
        .description = gLunasterPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_JACKABOX] =
    {
        ...
        .height = 9,
        .weight = 116,
        .description = gJackaboxPokedexText,
        .pokemonScale = 363,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FOOLTAGE] =
    {
        ...
        .height = 6,
        .weight = 5,
        .description = gFooltagePokedexText,
        .pokemonScale = 424,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Transcient"),
        .height = 24,
        .weight = 15,
        .description = gAetherealPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_MOTHRAMITY] =
    {
        ...
        .height = 55,
        .weight = 1110,
        .description = gMothramityPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [NATIONAL_DEX_GLAREYALE] =
    {
        ...
        .height = 70,
        .weight = 1850,
        .description = gGlareyalePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 448,
        .trainerOffset = 12,
    ...
    {
        .categoryName = _("Sky Whale"),
        .height = 300,
        .weight = 9999,
        .description = gLevialagoPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 2797,
        .trainerOffset = 18,
    ...
    {
        .categoryName = _("Electrofeed"),
        .height = 1,
        .weight = 2,
        .description = gRetroroachPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_NEOROACH] =
    {
        ...
        .height = 11,
        .weight = 20,
        .description = gNeoroachPokedexText,
        .pokemonScale = 312,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Pseudo"),
        .height = 4,
        .weight = 35,
        .description = gSpitfaxPokedexText,
        .pokemonScale = 545,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Spontaneous"),
        .height = 12,
        .weight = 122,
        .description = gRapscaleonPokedexText,
        .pokemonScale = 277,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Nascent"),
        .height = 6,
        .weight = 233,
        .description = gAgomagoPokedexText,
        .pokemonScale = 424,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Neotenic"),
        .height = 54,
        .weight = 1505,
        .description = gEpochotlPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [NATIONAL_DEX_VIVISU] =
    {
        ...
        .height = 5,
        .weight = 1,
        .description = gVivisuPokedexText,
        .pokemonScale = 411,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SOLASU] =
    {
        .categoryName = _("Daylight"),
        .height = 12,
        .weight = 9,
        .description = gSolasuPokedexText,
        .pokemonScale = 278,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Sun Beam"),
        .height = 15,
        .weight = 92,
        .description = gSummerasuPokedexText,
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORROCAST] =
    {
        ...
        .height = 24,
        .weight = 525,
        .description = gOrrocastPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_SHAYON] =
    {
        .categoryName = _("Ascent"),
        .height = 62,
        .weight = 4444,
        .description = gShaYonPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 360,
        .trainerOffset = 7,
    ...
    [NATIONAL_DEX_LUOSHAN] =
    {
        ...
        .height = 59,
        .weight = 2222,
        .description = gLuoShanPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 360,
        .trainerOffset = 7,
