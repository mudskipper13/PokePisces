...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW | B_WEATHER_SANDSTORM), ABILITY_FORECAST},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM_SANDY, B_WEATHER_SANDSTORM},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CASTFORM, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW | B_WEATHER_SANDSTORM)},
...
static const struct FormChange sFlagueFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FLAGUE, ITEM_NONE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_FLAGUE_PRINCE, ITEM_SILVER_CROWN},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sGaoterraFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_SWITCH, SPECIES_GAOTERRA},
    {FORM_CHANGE_FAINT,         SPECIES_GAOTERRA},
...
static const struct FormChange sShunyongFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_TURN_END,   SPECIES_SHUNYONG_GOLDEN_OFFENSE, ABILITY_GOLDEN_MEAN},
    {FORM_CHANGE_BATTLE_TURN_END,   SPECIES_SHUNYONG,                ABILITY_GOLDEN_MEAN},
