const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_QUILWARD] = sQuilwardLevelUpLearnset,
    [SPECIES_BONFEU] = sBonfeuLevelUpLearnset,
    [SPECIES_INFRAREC] = sInfrarecLevelUpLearnset,
    [SPECIES_BERM] = sBermLevelUpLearnset,
    [SPECIES_MOODA] = sMoodaLevelUpLearnset,
    [SPECIES_BERMUDON] = sBermudonLevelUpLearnset,
    ...
    [SPECIES_EBIBI] = sEbibiLevelUpLearnset,
    [SPECIES_MAKIBI] = sMakibiLevelUpLearnset,
    [SPECIES_EBIROSASHI] = sEbirosashiLevelUpLearnset,
    [SPECIES_KITIKITI] = sKitikitiLevelUpLearnset,
    [SPECIES_MOSKOPO] = sMoskopoLevelUpLearnset,
    [SPECIES_ABSOLARIA] = sAbsolariaLevelUpLearnset,
    ...
    [SPECIES_HAPPEA] = sHappeaLevelUpLearnset,
    [SPECIES_COFFIDDLE] = sCoffiddleLevelUpLearnset,
    [SPECIES_CRAVERAVE] = sCraveraveLevelUpLearnset,
    [SPECIES_FUZKY] = sFuzkyLevelUpLearnset,
    [SPECIES_COOLMUTTE] = sCoolmutteLevelUpLearnset,
    [SPECIES_CREAM] = sCreamLevelUpLearnset,
    ...
    [SPECIES_MATCHLIT] = sMatchlitLevelUpLearnset,
    [SPECIES_YAGANGRAN] = sYagangranLevelUpLearnset,
    [SPECIES_PIDIUM] = sPidiumLevelUpLearnset,
    [SPECIES_MEDGEON] = sMedgeonLevelUpLearnset,
    [SPECIES_MAGGORDE] = sMaggordeLevelUpLearnset,
    [SPECIES_FLAGUE] = sFlagueLevelUpLearnset,
    [SPECIES_CULTIPEX] = sCultipexLevelUpLearnset,
    [SPECIES_EERIKO] = sEerikoLevelUpLearnset,
    [SPECIES_MANNIKO] = sMannikoLevelUpLearnset,
    [SPECIES_KOWAKO] = sKowakoLevelUpLearnset,
    [SPECIES_UMBRAT] = sUmbratLevelUpLearnset,
    [SPECIES_CHIROBERRA] = sChiroberraLevelUpLearnset,
    [SPECIES_WEROBERRA] = sWeroberraLevelUpLearnset,
    [SPECIES_SACKYTWACK] = sSackytwackLevelUpLearnset,
    [SPECIES_STRAWNGMAN] = sStrawngmanLevelUpLearnset,
    [SPECIES_LAWPARD] = sLawpardLevelUpLearnset,
    [SPECIES_OOHBAABA] = sOohbaabaLevelUpLearnset,
    [SPECIES_GOLDEROCK] = sGolderockLevelUpLearnset,
    [SPECIES_MAYNIMO] = sMaynimoLevelUpLearnset,
    [SPECIES_BUTTERWEE] = sButterweeLevelUpLearnset,
    [SPECIES_PETRIPA] = sPetripaLevelUpLearnset,
    [SPECIES_CATTOWYRM] = sCattowyrmLevelUpLearnset,
    [SPECIES_BRAMBOOZLE] = sBramboozleLevelUpLearnset,
    [SPECIES_HOAXPOCUS] = sHoaxpocusLevelUpLearnset,
    [SPECIES_PITAGON] = sPitagonLevelUpLearnset,
    [SPECIES_PUTREGON] = sPutregonLevelUpLearnset,
    [SPECIES_GOLTIGATOR] = sGoltigatorLevelUpLearnset,
    [SPECIES_KAPRIKOLA] = sKaprikolaLevelUpLearnset,
    [SPECIES_BLOTTA] = sBlottaLevelUpLearnset,
    [SPECIES_SCHACHTTA] = sSchachttaLevelUpLearnset,
    [SPECIES_SYLVREIGN] = sSylvreignLevelUpLearnset,
    [SPECIES_CATTUCLID] = sCattuclidLevelUpLearnset,
    [SPECIES_FRACTOFLY] = sFractoflyLevelUpLearnset,
    [SPECIES_GRAVELITO] = sGravelitoLevelUpLearnset,
    [SPECIES_MEGALITO] = sMegalitoLevelUpLearnset,
    [SPECIES_COMBUN] = sCombunLevelUpLearnset,
    [SPECIES_HAIBUN] = sHaibunLevelUpLearnset,
    [SPECIES_BURBUN] = sBurbunLevelUpLearnset,
    [SPECIES_INGBUN] = sIngbunLevelUpLearnset,
    [SPECIES_CHAFFAW] = sChaffawLevelUpLearnset,
    [SPECIES_FERROR] = sFerrorLevelUpLearnset,
    [SPECIES_COBBTLE] = sCobbtleLevelUpLearnset,
    [SPECIES_MONTORT] = sMontortLevelUpLearnset,
    [SPECIES_BOLTEROCK] = sBolterockLevelUpLearnset,
    [SPECIES_VOREON] = sVoreonLevelUpLearnset,
    [SPECIES_CORISP] = sCorispLevelUpLearnset,
    [SPECIES_KROLPYRE] = sKrolpyreLevelUpLearnset,
    [SPECIES_TOXITIDE] = sToxitideLevelUpLearnset,
    [SPECIES_TOXITURF] = sToxiturfLevelUpLearnset,
    [SPECIES_PEBBLER] = sPebblerLevelUpLearnset,
    [SPECIES_DUNEWICH] = sDunewichLevelUpLearnset,
    [SPECIES_MAJADIJUNN] = sMajadijunnLevelUpLearnset,
    [SPECIES_CAPYBARA] = sCapybaraLevelUpLearnset,
    [SPECIES_ABARBINASH] = sAbarbinashLevelUpLearnset,
    [SPECIES_JARAMERA] = sJarameraLevelUpLearnset,
    [SPECIES_BLINGUIN] = sBlinguinLevelUpLearnset,
    [SPECIES_BIYAKO] = sBiyakoLevelUpLearnset,
    [SPECIES_BEHEKO] = sBehekoLevelUpLearnset,
    [SPECIES_HEMOKO] = sHemokoLevelUpLearnset,
    [SPECIES_LEPUCYTE] = sLepucyteLevelUpLearnset,
    [SPECIES_LEUKUNEHO] = sLeukunehoLevelUpLearnset,
    [SPECIES_WELPROOT] = sWelprootLevelUpLearnset,
    [SPECIES_DRAEKAROT] = sDraekarotLevelUpLearnset,
    [SPECIES_KARODORAUG] = sKarodoraugLevelUpLearnset,
    [SPECIES_COFORCHEE] = sCoforcheeLevelUpLearnset,
    [SPECIES_MUSTYBANE] = sMustybaneLevelUpLearnset,
    [SPECIES_WANNEGG] = sWanneggLevelUpLearnset,
    [SPECIES_EGGNEGGMA] = sEggneggmaLevelUpLearnset,
    [SPECIES_LEVLADE] = sLevladeLevelUpLearnset,
    [SPECIES_SHOCKORE] = sShockoreLevelUpLearnset,
    [SPECIES_PLASMANTIS] = sPlasmantisLevelUpLearnset,
    [SPECIES_HARACE] = sHaraceLevelUpLearnset,
    [SPECIES_TORSTEVIC] = sTorstevicLevelUpLearnset,
    [SPECIES_CHIKA] = sChikaLevelUpLearnset,
    [SPECIES_SWORDUC] = sSworducLevelUpLearnset,
    [SPECIES_GOSMARK] = sGosmarkLevelUpLearnset,
    [SPECIES_CORDELICT] = sCordelictLevelUpLearnset,
    [SPECIES_MERALCORE] = sMeralcoreLevelUpLearnset,
    [SPECIES_RAITAIC] = sRaitaicLevelUpLearnset,
    [SPECIES_NIMBOZOA] = sNimbozoaLevelUpLearnset,
    [SPECIES_MINOTE] = sMinoteLevelUpLearnset,
    [SPECIES_TUNAP] = sTunapLevelUpLearnset,
    [SPECIES_BASSHARK] = sBassharkLevelUpLearnset,
    [SPECIES_SHARGUY] = sSharguyLevelUpLearnset,
    [SPECIES_SHARPREY] = sSharpreyLevelUpLearnset,
    [SPECIES_CHUNGRIM] = sChungrimLevelUpLearnset,
    [SPECIES_SQUEESHY] = sSqueeshyLevelUpLearnset,
    [SPECIES_SQUISHIME] = sSquishimeLevelUpLearnset,
    [SPECIES_OCTOHIME] = sOctohimeLevelUpLearnset,
    [SPECIES_COLFIN] = sColfinLevelUpLearnset,
    [SPECIES_MYSTICIAN] = sMysticianLevelUpLearnset,
    [SPECIES_WALRUST] = sWalrustLevelUpLearnset,
    [SPECIES_SCALLYWARG] = sScallywargLevelUpLearnset,
    [SPECIES_WAARGH] = sWaarghLevelUpLearnset,
    [SPECIES_SKELLYWARG] = sSkellywargLevelUpLearnset,
    [SPECIES_CASOWARY] = sCasowaryLevelUpLearnset,
    [SPECIES_PASSAWARY] = sPassawaryLevelUpLearnset,
    [SPECIES_BOOZARD] = sBoozardLevelUpLearnset,
    [SPECIES_COCKABOO] = sCockabooLevelUpLearnset,
    [SPECIES_AXELFIN] = sAxelfinLevelUpLearnset,
    [SPECIES_MORAGAN] = sMoraganLevelUpLearnset,
    [SPECIES_SHIVERSNAP] = sShiversnapLevelUpLearnset,
    [SPECIES_EXCATATOR] = sExcatatorLevelUpLearnset,
    [SPECIES_MARSOYART] = sMarsoyartLevelUpLearnset,
    [SPECIES_CINDRILLON] = sCindrillonLevelUpLearnset,
    [SPECIES_ARMAGATTON] = sArmagattonLevelUpLearnset,
    [SPECIES_FAKYSNAKY] = sFakysnakyLevelUpLearnset,
    [SPECIES_PANTNEY] = sPantneyLevelUpLearnset,
    [SPECIES_NYARLY] = sNyarlyLevelUpLearnset,
    [SPECIES_SUDCUB] = sSudcubLevelUpLearnset,
    [SPECIES_TARDRITCH] = sTardritchLevelUpLearnset,
    [SPECIES_BLABBU] = sBlabbuLevelUpLearnset,
    [SPECIES_TURRYTURRY] = sTurryturryLevelUpLearnset,
    [SPECIES_FAERED] = sFaeredLevelUpLearnset,
    [SPECIES_PROMISCBUS] = sPromiscbusLevelUpLearnset,
    [SPECIES_GUMBORREE] = sGumborreeLevelUpLearnset,
    [SPECIES_KOREMAI] = sKoremaiLevelUpLearnset,
    [SPECIES_KORESATO] = sKoresatoLevelUpLearnset,
    [SPECIES_DRAKULARK] = sDrakularkLevelUpLearnset,
    [SPECIES_NOSFERAPTR] = sNosferaptrLevelUpLearnset,
    [SPECIES_OLFLOOKIE] = sOlFlookieLevelUpLearnset,
    [SPECIES_JUSTRICHA] = sJustrichaLevelUpLearnset,
    [SPECIES_AJOKUJOKU] = sAjokujokuLevelUpLearnset,
    [SPECIES_GARJIRA] = sGarjiraLevelUpLearnset,
    [SPECIES_GARZILLA] = sGarzillaLevelUpLearnset,
    [SPECIES_YANDEMIC] = sYandemicLevelUpLearnset,
    [SPECIES_LUNASTER] = sLunasterLevelUpLearnset,
    [SPECIES_JACKABOX] = sJackaboxLevelUpLearnset,
    [SPECIES_FOOLTAGE] = sFooltageLevelUpLearnset,
    [SPECIES_AETHEREAL] = sAetherealLevelUpLearnset,
    [SPECIES_MOTHRAMITY] = sMothramityLevelUpLearnset,
    [SPECIES_GLAREYALE] = sGlareyaleLevelUpLearnset,
    [SPECIES_LEVIALAGO] = sLevialagoLevelUpLearnset,
    [SPECIES_RETROROACH] = sRetroroachLevelUpLearnset,
    [SPECIES_NEOROACH] = sNeoroachLevelUpLearnset,
    [SPECIES_SPITFAX] = sSpitfaxLevelUpLearnset,
    [SPECIES_RAPSCALEON] = sRapscaleonLevelUpLearnset,
    [SPECIES_AGOMAGO] = sAgomagoLevelUpLearnset,
    [SPECIES_MORFTREE] = sMorftreeLevelUpLearnset,
    [SPECIES_EPOCHOTL] = sEpochotlLevelUpLearnset,
    [SPECIES_VIVISU] = sVivisuLevelUpLearnset,
    [SPECIES_SOLASU] = sSolasuLevelUpLearnset,
    [SPECIES_SUMMERASU] = sSummerasuLevelUpLearnset,
    [SPECIES_OROFLOW] = sOroflowLevelUpLearnset,
    [SPECIES_ORROCAST] = sOrrocastLevelUpLearnset,
    [SPECIES_ORROWHELM] = sOrrowhelmLevelUpLearnset,
    ...
    [SPECIES_DAKKAPOD] = sDakkapodLevelUpLearnset,
    ...
    [SPECIES_YOLKWEEN] = sYolkweenLevelUpLearnset,
    [SPECIES_WALLY] = sWallyLevelUpLearnset,
    [SPECIES_POTTRICIA] = sPottriciaLevelUpLearnset,
#endif
    // Megas
    ...
    [SPECIES_LOTTABATS_DISPERSED] = sLottabatsLevelUpLearnset,
    ...
    [SPECIES_SPINDA_PLAINS] = sSpindaPlainsLevelUpLearnset,
    ...
    [SPECIES_SHISHIMA_ALT] = sShishimaLevelUpLearnset,
    ...
    [SPECIES_FLAGUE_PRINCE] = sFlagueLevelUpLearnset,
#endif
};
