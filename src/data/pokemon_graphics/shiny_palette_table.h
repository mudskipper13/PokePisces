const struct CompressedSpritePalette gMonShinyPaletteTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SHINY_PAL(SPINDA_CAVE, gMonShinyPalette_SpindaCave),
    ...
    SPECIES_SHINY_PAL(TIDPIT, gMonShinyPalette_Tidpit),
    SPECIES_SHINY_PAL(SLIDLOW, gMonShinyPalette_Slidlow),
    SPECIES_SHINY_PAL(CARDIOVOR, gMonShinyPalette_Cardiovor),
    SPECIES_SHINY_PAL(FIEFREET, gMonShinyPalette_Fiefreet),
    SPECIES_SHINY_PAL(BALBYRN, gMonShinyPalette_Balbyrn),
    SPECIES_SHINY_PAL(BLAZIZAHAK, gMonShinyPalette_Blazizahak),
    SPECIES_SHINY_PAL(PRONGY, gMonShinyPalette_Prongy),
    SPECIES_SHINY_PAL(TRIDALIER, gMonShinyPalette_Tridalier),
    SPECIES_SHINY_PAL(TRITONAUT, gMonShinyPalette_Tritonaut),
    SPECIES_SHINY_PAL(SNELFREND, gMonShinyPalette_Snelfrend),
    SPECIES_SHINY_PAL(SYCOPLOD, gMonShinyPalette_Sycoplod),
    SPECIES_SHINY_PAL(SYCOSTROM, gMonShinyPalette_Sycostrom),
    SPECIES_SHINY_PAL(GUPSPAR, gMonShinyPalette_Gupspar),
    SPECIES_SHINY_PAL(VANGAR, gMonShinyPalette_Vangar),
    SPECIES_SHINY_PAL(GHAERIAL, gMonShinyPalette_Ghaerial),
    SPECIES_SHINY_PAL(QUILWARD, gMonShinyPalette_Quilward),
    SPECIES_SHINY_PAL(BONFEU, gMonShinyPalette_Bonfeu),
    SPECIES_SHINY_PAL(INFRAREC, gMonShinyPalette_Infrarec),
    SPECIES_SHINY_PAL(BERM, gMonShinyPalette_Berm),
    SPECIES_SHINY_PAL(MOODA, gMonShinyPalette_Mooda),
    SPECIES_SHINY_PAL(BERMUDON, gMonShinyPalette_Bermudon),
    SPECIES_SHINY_PAL(MARINAROC, gMonShinyPalette_Marinaroc),
    SPECIES_SHINY_PAL(METTATOLL, gMonShinyPalette_Mettatoll),
    SPECIES_SHINY_PAL(ICKSQUEEK, gMonShinyPalette_Icksqueek),
    SPECIES_SHINY_PAL(KOMORODE, gMonShinyPalette_Komorode),
    SPECIES_SHINY_PAL(ANNIHILAPE, gMonShinyPalette_Annihilape),
    SPECIES_SHINY_PAL(EBIBI, gMonShinyPalette_Ebibi),
    SPECIES_SHINY_PAL(MAKIBI, gMonShinyPalette_Makibi),
    SPECIES_SHINY_PAL(EBIROSASHI, gMonShinyPalette_Ebirosashi),
    SPECIES_SHINY_PAL(KITIKITI, gMonShinyPalette_Kitikiti),
    SPECIES_SHINY_PAL(MOSKOPO, gMonShinyPalette_Moskopo),
    SPECIES_SHINY_PAL(ABSOLARIA, gMonShinyPalette_Absolaria),
    SPECIES_SHINY_PAL(KYUDI, gMonShinyPalette_Kyudi),
    SPECIES_SHINY_PAL(KOMBAKYU, gMonShinyPalette_Kombakyu),
    SPECIES_SHINY_PAL(FLUFFSIR, gMonShinyPalette_Fluffsir),
    SPECIES_SHINY_PAL(FLUFFREAR, gMonShinyPalette_Fluffrear),
    SPECIES_SHINY_PAL(SAINTISOW, gMonShinyPalette_Saintisow),
    SPECIES_SHINY_PAL(SANCTISOW, gMonShinyPalette_Sanctisow),
    SPECIES_SHINY_PAL(SOWPHIROTH, gMonShinyPalette_Sowphiroth),
    SPECIES_SHINY_PAL(TOXEXOT, gMonShinyPalette_Toxexot),
    SPECIES_SHINY_PAL(PSEUDRA, gMonShinyPalette_Pseudra),
    SPECIES_SHINY_PAL(MANDIMYTE, gMonShinyPalette_Mandimyte),
    SPECIES_SHINY_PAL(TERMINYTE, gMonShinyPalette_Terminyte),
    SPECIES_SHINY_PAL(SNOTLOUD, gMonShinyPalette_Snotloud),
    SPECIES_SHINY_PAL(SICKBEAT, gMonShinyPalette_Sickbeat),
    SPECIES_SHINY_PAL(SPRYTE, gMonShinyPalette_Spryte),
    SPECIES_SHINY_PAL(GUMONA, gMonShinyPalette_Gumona),
    SPECIES_SHINY_PAL(NANGGAL, gMonShinyPalette_Nanggal),
    SPECIES_SHINY_PAL(SHEEDRAKE, gMonShinyPalette_Sheedrake),
    SPECIES_SHINY_PAL(TRANSERA, gMonShinyPalette_Transera),
    SPECIES_SHINY_PAL(BIVAGUE, gMonShinyPalette_Bivague),
    SPECIES_SHINY_PAL(LUSCKAW, gMonShinyPalette_Lusckaw),
    SPECIES_SHINY_PAL(SADSOD, gMonShinyPalette_Sadsod),
    SPECIES_SHINY_PAL(MAERACHOLY, gMonShinyPalette_Maeracholy),
    SPECIES_SHINY_PAL(LUMELMO, gMonShinyPalette_Lumelmo),
    SPECIES_SHINY_PAL(LUMENDELA, gMonShinyPalette_Lumendela),
    SPECIES_SHINY_PAL(STOMAWAY, gMonShinyPalette_Stomaway),
    SPECIES_SHINY_PAL(CRAWLAXY, gMonShinyPalette_Crawlaxy),
    SPECIES_SHINY_PAL(MAGNALURE, gMonShinyPalette_Magnalure),
    SPECIES_SHINY_PAL(MAGNANICOR, gMonShinyPalette_Magnanicor),
    SPECIES_SHINY_PAL(CRYPLIN, gMonShinyPalette_Cryplin),
    SPECIES_SHINY_PAL(UHEFOE, gMonShinyPalette_Uhefoe),
    SPECIES_SHINY_PAL(MYSTOMANIA, gMonShinyPalette_Mystomania),
    SPECIES_SHINY_PAL(LYORESA, gMonShinyPalette_Lyoresa),
    SPECIES_SHINY_PAL(KODOUGH, gMonShinyPalette_Kodough),
    SPECIES_SHINY_PAL(SLICKSLICE, gMonShinyPalette_Slickslice),
    ...
    SPECIES_SHINY_PAL(COOLMUTTE, gMonShinyPalette_Coolmutte),
    SPECIES_SHINY_PAL(CREAM, gMonShinyPalette_Cream),
    ...
    SPECIES_SHINY_PAL(MAGGORDE, gMonShinyPalette_Maggorde),
    SPECIES_SHINY_PAL(FLAGUE, gMonShinyPalette_Flague),
    SPECIES_SHINY_PAL(CULTIPEX, gMonShinyPalette_Cultipex),
    SPECIES_SHINY_PAL(EERIKO, gMonShinyPalette_Eeriko),
    SPECIES_SHINY_PAL(MANNIKO, gMonShinyPalette_Manniko),
    SPECIES_SHINY_PAL(KOWAKO, gMonShinyPalette_Kowako),
    SPECIES_SHINY_PAL(UMBRAT, gMonShinyPalette_Umbrat),
    SPECIES_SHINY_PAL(CHIROBERRA, gMonShinyPalette_Chiroberra),
    SPECIES_SHINY_PAL(WEROBERRA, gMonShinyPalette_Weroberra),
    SPECIES_SHINY_PAL(SACKYTWACK, gMonShinyPalette_Sackytwack),
    SPECIES_SHINY_PAL(STRAWNGMAN, gMonShinyPalette_Strawngman),
    SPECIES_SHINY_PAL(LAWPARD, gMonShinyPalette_Lawpard),
    SPECIES_SHINY_PAL(OOHBAABA, gMonShinyPalette_Oohbaaba),
    SPECIES_SHINY_PAL(GOLDEROCK, gMonShinyPalette_Golderock),
    SPECIES_SHINY_PAL(MAYNIMO, gMonShinyPalette_Maynimo),
    SPECIES_SHINY_PAL(BUTTERWEE, gMonShinyPalette_Butterwee),
    SPECIES_SHINY_PAL(PETRIPA, gMonShinyPalette_Petripa),
    SPECIES_SHINY_PAL(CATTOWYRM, gMonShinyPalette_Cattowyrm),
    SPECIES_SHINY_PAL(BRAMBOOZLE, gMonShinyPalette_Bramboozle),
    SPECIES_SHINY_PAL(HOAXPOCUS, gMonShinyPalette_Hoaxpocus),
    SPECIES_SHINY_PAL(PITAGON, gMonShinyPalette_Pitagon),
    SPECIES_SHINY_PAL(PUTREGON, gMonShinyPalette_Putregon),
    SPECIES_SHINY_PAL(GOLTIGATOR, gMonShinyPalette_Goltigator),
    SPECIES_SHINY_PAL(KAPRIKOLA, gMonShinyPalette_Kaprikola),
    SPECIES_SHINY_PAL(BLOTTA, gMonShinyPalette_Blotta),
    SPECIES_SHINY_PAL(SCHACHTTA, gMonShinyPalette_Schachtta),
    SPECIES_SHINY_PAL(SYLVREIGN, gMonShinyPalette_Sylvreign),
    SPECIES_SHINY_PAL(CATTUCLID, gMonShinyPalette_Cattuclid),
    SPECIES_SHINY_PAL(FRACTOFLY, gMonShinyPalette_Fractofly),
    SPECIES_SHINY_PAL(GRAVELITO, gMonShinyPalette_Gravelito),
    SPECIES_SHINY_PAL(MEGALITO, gMonShinyPalette_Megalito),
    SPECIES_SHINY_PAL(COMBUN, gMonShinyPalette_Combun),
    SPECIES_SHINY_PAL(HAIBUN, gMonShinyPalette_Haibun),
    SPECIES_SHINY_PAL(BURBUN, gMonShinyPalette_Burbun),
    SPECIES_SHINY_PAL(INGBUN, gMonShinyPalette_Ingbun),
    SPECIES_SHINY_PAL(CHAFFAW, gMonShinyPalette_Chaffaw),
    SPECIES_SHINY_PAL(FERROR, gMonShinyPalette_Ferror),
    SPECIES_SHINY_PAL(COBBTLE, gMonShinyPalette_Cobbtle),
    SPECIES_SHINY_PAL(MONTORT, gMonShinyPalette_Montort),
    SPECIES_SHINY_PAL(BOLTEROCK, gMonShinyPalette_Bolterock),
    SPECIES_SHINY_PAL(VOREON, gMonShinyPalette_Voreon),
    SPECIES_SHINY_PAL(CORISP, gMonShinyPalette_Corisp),
    SPECIES_SHINY_PAL(KROLPYRE, gMonShinyPalette_Krolpyre),
    SPECIES_SHINY_PAL(TOXITIDE, gMonShinyPalette_Toxitide),
    SPECIES_SHINY_PAL(TOXITURF, gMonShinyPalette_Toxiturf),
    SPECIES_SHINY_PAL(PEBBLER, gMonShinyPalette_Pebbler),
    SPECIES_SHINY_PAL(DUNEWICH, gMonShinyPalette_Dunewich),
    SPECIES_SHINY_PAL(MAJADIJUNN, gMonShinyPalette_Majadijunn),
    SPECIES_SHINY_PAL(CAPYBARA, gMonShinyPalette_Capybara),
    SPECIES_SHINY_PAL(ABARBINASH, gMonShinyPalette_Abarbinash),
    SPECIES_SHINY_PAL(JARAMERA, gMonShinyPalette_Jaramera),
    SPECIES_SHINY_PAL(BLINGUIN, gMonShinyPalette_Blinguin),
    SPECIES_SHINY_PAL(BIYAKO, gMonShinyPalette_Biyako),
    SPECIES_SHINY_PAL(BEHEKO, gMonShinyPalette_Beheko),
    SPECIES_SHINY_PAL(HEMOKO, gMonShinyPalette_Hemoko),
    SPECIES_SHINY_PAL(LEPUCYTE, gMonShinyPalette_Lepucyte),
    SPECIES_SHINY_PAL(LEUKUNEHO, gMonShinyPalette_Leukuneho),
    SPECIES_SHINY_PAL(WELPROOT, gMonShinyPalette_Welproot),
    SPECIES_SHINY_PAL(DRAEKAROT, gMonShinyPalette_Draekarot),
    SPECIES_SHINY_PAL(KARODORAUG, gMonShinyPalette_Karodoraug),
    SPECIES_SHINY_PAL(COFORCHEE, gMonShinyPalette_Coforchee),
    SPECIES_SHINY_PAL(MUSTYBANE, gMonShinyPalette_Mustybane),
    SPECIES_SHINY_PAL(WANNEGG, gMonShinyPalette_Wannegg),
    SPECIES_SHINY_PAL(EGGNEGGMA, gMonShinyPalette_Eggneggma),
    SPECIES_SHINY_PAL(LEVLADE, gMonShinyPalette_Levlade),
    SPECIES_SHINY_PAL(SHOCKORE, gMonShinyPalette_Shockore),
    SPECIES_SHINY_PAL(PLASMANTIS, gMonShinyPalette_Plasmantis),
    SPECIES_SHINY_PAL(HARACE, gMonShinyPalette_Harace),
    SPECIES_SHINY_PAL(TORSTEVIC, gMonShinyPalette_Torstevic),
    SPECIES_SHINY_PAL(CHIKA, gMonShinyPalette_Chika),
    SPECIES_SHINY_PAL(SWORDUC, gMonShinyPalette_Sworduc),
    SPECIES_SHINY_PAL(GOSMARK, gMonShinyPalette_Gosmark),
    SPECIES_SHINY_PAL(CORDELICT, gMonShinyPalette_Cordelict),
    SPECIES_SHINY_PAL(MERALCORE, gMonShinyPalette_Meralcore),
    SPECIES_SHINY_PAL(RAITAIC, gMonShinyPalette_Raitaic),
    SPECIES_SHINY_PAL(NIMBOZOA, gMonShinyPalette_Nimbozoa),
    SPECIES_SHINY_PAL(MINOTE, gMonShinyPalette_Minote),
    SPECIES_SHINY_PAL(TUNAP, gMonShinyPalette_Tunap),
    SPECIES_SHINY_PAL(BASSHARK, gMonShinyPalette_Basshark),
    SPECIES_SHINY_PAL(SHARGUY, gMonShinyPalette_Sharguy),
    SPECIES_SHINY_PAL(SHARPREY, gMonShinyPalette_Sharprey),
    SPECIES_SHINY_PAL(CHUNGRIM, gMonShinyPalette_Chungrim),
    SPECIES_SHINY_PAL(SQUEESHY, gMonShinyPalette_Squeeshy),
    SPECIES_SHINY_PAL(SQUISHIME, gMonShinyPalette_Squishime),
    SPECIES_SHINY_PAL(OCTOHIME, gMonShinyPalette_Octohime),
    SPECIES_SHINY_PAL(COLFIN, gMonShinyPalette_Colfin),
    SPECIES_SHINY_PAL(MYSTICIAN, gMonShinyPalette_Mystician),
    SPECIES_SHINY_PAL(WALRUST, gMonShinyPalette_Walrust),
    SPECIES_SHINY_PAL(SCALLYWARG, gMonShinyPalette_Scallywarg),
    SPECIES_SHINY_PAL(WAARGH, gMonShinyPalette_Waargh),
    SPECIES_SHINY_PAL(SKELLYWARG, gMonShinyPalette_Skellywarg),
    SPECIES_SHINY_PAL(CASOWARY, gMonShinyPalette_Casowary),
    SPECIES_SHINY_PAL(PASSAWARY, gMonShinyPalette_Passawary),
    SPECIES_SHINY_PAL(BOOZARD, gMonShinyPalette_Boozard),
    SPECIES_SHINY_PAL(COCKABOO, gMonShinyPalette_Cockaboo),
    SPECIES_SHINY_PAL(AXELFIN, gMonShinyPalette_Axelfin),
    SPECIES_SHINY_PAL(MORAGAN, gMonShinyPalette_Moragan),
    SPECIES_SHINY_PAL(SHIVERSNAP, gMonShinyPalette_Shiversnap),
    SPECIES_SHINY_PAL(EXCATATOR, gMonShinyPalette_Excatator),
    SPECIES_SHINY_PAL(MARSOYART, gMonShinyPalette_Marsoyart),
    SPECIES_SHINY_PAL(CINDRILLON, gMonShinyPalette_Cindrillon),
    SPECIES_SHINY_PAL(ARMAGATTON, gMonShinyPalette_Armagatton),
    SPECIES_SHINY_PAL(FAKYSNAKY, gMonShinyPalette_Fakysnaky),
    SPECIES_SHINY_PAL(PANTNEY, gMonShinyPalette_Pantney),
    SPECIES_SHINY_PAL(NYARLY, gMonShinyPalette_Nyarly),
    SPECIES_SHINY_PAL(SUDCUB, gMonShinyPalette_Sudcub),
    SPECIES_SHINY_PAL(TARDRITCH, gMonShinyPalette_Tardritch),
    SPECIES_SHINY_PAL(BLABBU, gMonShinyPalette_Blabbu),
    SPECIES_SHINY_PAL(TURRYTURRY, gMonShinyPalette_Turryturry),
    SPECIES_SHINY_PAL(FAERED, gMonShinyPalette_Faered),
    SPECIES_SHINY_PAL(PROMISCBUS, gMonShinyPalette_Promiscbus),
    SPECIES_SHINY_PAL(GUMBORREE, gMonShinyPalette_Gumborree),
    SPECIES_SHINY_PAL(KOREMAI, gMonShinyPalette_Koremai),
    SPECIES_SHINY_PAL(KORESATO, gMonShinyPalette_Koresato),
    SPECIES_SHINY_PAL(DRAKULARK, gMonShinyPalette_Drakulark),
    SPECIES_SHINY_PAL(NOSFERAPTR, gMonShinyPalette_Nosferaptr),
    SPECIES_SHINY_PAL(OLFLOOKIE, gMonShinyPalette_OlFlookie),
    SPECIES_SHINY_PAL(JUSTRICHA, gMonShinyPalette_Justricha),
    SPECIES_SHINY_PAL(AJOKUJOKU, gMonShinyPalette_Ajokujoku),
    SPECIES_SHINY_PAL(GARJIRA, gMonShinyPalette_Garjira),
    SPECIES_SHINY_PAL(GARZILLA, gMonShinyPalette_Garzilla),
    SPECIES_SHINY_PAL(YANDEMIC, gMonShinyPalette_Yandemic),
    SPECIES_SHINY_PAL(LUNASTER, gMonShinyPalette_Lunaster),
    SPECIES_SHINY_PAL(JACKABOX, gMonShinyPalette_Jackabox),
    SPECIES_SHINY_PAL(FOOLTAGE, gMonShinyPalette_Fooltage),
    SPECIES_SHINY_PAL(AETHEREAL, gMonShinyPalette_Aethereal),
    SPECIES_SHINY_PAL(MOTHRAMITY, gMonShinyPalette_Mothramity),
    SPECIES_SHINY_PAL(GLAREYALE, gMonShinyPalette_Glareyale),
    SPECIES_SHINY_PAL(LEVIALAGO, gMonShinyPalette_Levialago),
    SPECIES_SHINY_PAL(RETROROACH, gMonShinyPalette_Retroroach),
    SPECIES_SHINY_PAL(NEOROACH, gMonShinyPalette_Neoroach),
    SPECIES_SHINY_PAL(SPITFAX, gMonShinyPalette_Spitfax),
    SPECIES_SHINY_PAL(RAPSCALEON, gMonShinyPalette_Rapscaleon),
    SPECIES_SHINY_PAL(AGOMAGO, gMonShinyPalette_Agomago),
    SPECIES_SHINY_PAL(MORFTREE, gMonShinyPalette_Morftree),
    SPECIES_SHINY_PAL(EPOCHOTL, gMonShinyPalette_Epochotl),
    SPECIES_SHINY_PAL(VIVISU, gMonShinyPalette_Vivisu),
    SPECIES_SHINY_PAL(SOLASU, gMonShinyPalette_Solasu),
    SPECIES_SHINY_PAL(SUMMERASU, gMonShinyPalette_Summerasu),
    SPECIES_SHINY_PAL(OROFLOW, gMonShinyPalette_Oroflow),
    SPECIES_SHINY_PAL(ORROCAST, gMonShinyPalette_Orrocast),
    SPECIES_SHINY_PAL(ORROWHELM, gMonShinyPalette_Orrowhelm),
    SPECIES_SHINY_PAL(SHAYON, gMonShinyPalette_ShaYon),
    SPECIES_SHINY_PAL(LUOSHAN, gMonShinyPalette_LuoShan),
    SPECIES_SHINY_PAL(LOTTABATS, gMonShinyPalette_Lottabats),
    SPECIES_SHINY_PAL(LOTTABATS_DISPERSED, gMonShinyPalette_LottabatsDispersed),
    ...
    SPECIES_SHINY_PAL(BISHOUCHA, gMonShinyPalette_Bishoucha),
    SPECIES_SHINY_PAL(BISHOUCHA_WARMONGER, gMonShinyPalette_BishouchaWarmonger),
    SPECIES_SHINY_PAL(PAPYPUS, gMonShinyPalette_Papypus),
    SPECIES_SHINY_PAL(PAPYPUS_FEMALE, gMonShinyPalette_PapypusFemale),
    SPECIES_SHINY_PAL(CINDRILLON_PIROUETTE, gMonShinyPalette_CindrillonPirouette),
    SPECIES_SHINY_PAL(CINDRILLON_FEAROUETTE, gMonShinyPalette_CindrillonFearouette),
    SPECIES_SHINY_PAL(SHISHIMA, gMonShinyPalette_Shishima),
    SPECIES_SHINY_PAL(SHISHIMA_PUNISHER, gMonShinyPalette_ShishimaPunisher),
    SPECIES_SHINY_PAL(SHUNYONG, gMonShinyPalette_Shunyong),
    ...
    SPECIES_SHINY_PAL(CASTFORM_SANDY, gMonShinyPalette_CastformSandy),
    SPECIES_SHINY_PAL(SHISHIMA_ALT, gMonShinyPalette_Shishima),
    SPECIES_SHINY_PAL(SHISHIMA_PUNISHER_ALT, gMonShinyPalette_ShishimaPunisherAlt),
    SPECIES_SHINY_PAL(LYOLICA, gMonShinyPalette_Lyolica),
    SPECIES_SHINY_PAL(FAKYSNAKY_BUSTED, gMonShinyPalette_FakysnakyBusted),
    SPECIES_SHINY_PAL(FLAGUE_PRINCE, gMonShinyPalette_FlaguePrince),
#endif
