const struct CompressedSpritePalette gMonPaletteTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_PAL(SPINDA_CAVE, gMonPalette_SpindaCave),
    SPECIES_PAL(SPINDA_DESERT, gMonPalette_SpindaDesert),
    SPECIES_PAL(SPINDA_FOREST, gMonPalette_SpindaForest),
    SPECIES_PAL(SPINDA_MOUNTAIN, gMonPalette_SpindaMountain),
    SPECIES_PAL(SPINDA_PLAINS, gMonPalette_SpindaPlains),
    ...
    SPECIES_PAL(TIDPIT, gMonPalette_Tidpit),
    SPECIES_PAL(SLIDLOW, gMonPalette_Slidlow),
    SPECIES_PAL(CARDIOVOR, gMonPalette_Cardiovor),
    SPECIES_PAL(FIEFREET, gMonPalette_Fiefreet),
    SPECIES_PAL(BALBYRN, gMonPalette_Balbyrn),
    SPECIES_PAL(BLAZIZAHAK, gMonPalette_Blazizahak),
    SPECIES_PAL(PRONGY, gMonPalette_Prongy),
    SPECIES_PAL(TRIDALIER, gMonPalette_Tridalier),
    SPECIES_PAL(TRITONAUT, gMonPalette_Tritonaut),
    SPECIES_PAL(SNELFREND, gMonPalette_Snelfrend),
    SPECIES_PAL(SYCOPLOD, gMonPalette_Sycoplod),
    SPECIES_PAL(SYCOSTROM, gMonPalette_Sycostrom),
    SPECIES_PAL(GUPSPAR, gMonPalette_Gupspar),
    SPECIES_PAL(VANGAR, gMonPalette_Vangar),
    SPECIES_PAL(GHAERIAL, gMonPalette_Ghaerial),
    SPECIES_PAL(QUILWARD, gMonPalette_Quilward),
    SPECIES_PAL(BONFEU, gMonPalette_Bonfeu),
    SPECIES_PAL(INFRAREC, gMonPalette_Infrarec),
    SPECIES_PAL(BERM, gMonPalette_Berm),
    SPECIES_PAL(MOODA, gMonPalette_Mooda),
    SPECIES_PAL(BERMUDON, gMonPalette_Bermudon),
    SPECIES_PAL(MARINAROC, gMonPalette_Marinaroc),
    SPECIES_PAL(METTATOLL, gMonPalette_Mettatoll),
    SPECIES_PAL(ICKSQUEEK, gMonPalette_Icksqueek),
    SPECIES_PAL(KOMORODE, gMonPalette_Komorode),
    SPECIES_PAL(ANNIHILAPE, gMonPalette_Annihilape),
    SPECIES_PAL(EBIBI, gMonPalette_Ebibi),
    SPECIES_PAL(MAKIBI, gMonPalette_Makibi),
    SPECIES_PAL(EBIROSASHI, gMonPalette_Ebirosashi),
    SPECIES_PAL(KITIKITI, gMonPalette_Kitikiti),
    SPECIES_PAL(MOSKOPO, gMonPalette_Moskopo),
    SPECIES_PAL(ABSOLARIA, gMonPalette_Absolaria),
    SPECIES_PAL(KYUDI, gMonPalette_Kyudi),
    SPECIES_PAL(KOMBAKYU, gMonPalette_Kombakyu),
    SPECIES_PAL(FLUFFSIR, gMonPalette_Fluffsir),
    SPECIES_PAL(FLUFFREAR, gMonPalette_Fluffrear),
    SPECIES_PAL(SAINTISOW, gMonPalette_Saintisow),
    SPECIES_PAL(SANCTISOW, gMonPalette_Sanctisow),
    SPECIES_PAL(SOWPHIROTH, gMonPalette_Sowphiroth),
    SPECIES_PAL(TOXEXOT, gMonPalette_Toxexot),
    SPECIES_PAL(PSEUDRA, gMonPalette_Pseudra),
    SPECIES_PAL(MANDIMYTE, gMonPalette_Mandimyte),
    SPECIES_PAL(TERMINYTE, gMonPalette_Terminyte),
    SPECIES_PAL(SNOTLOUD, gMonPalette_Snotloud),
    SPECIES_PAL(SICKBEAT, gMonPalette_Sickbeat),
    SPECIES_PAL(SPRYTE, gMonPalette_Spryte),
    SPECIES_PAL(GUMONA, gMonPalette_Gumona),
    SPECIES_PAL(NANGGAL, gMonPalette_Nanggal),
    SPECIES_PAL(SHEEDRAKE, gMonPalette_Sheedrake),
    SPECIES_PAL(TRANSERA, gMonPalette_Transera),
    SPECIES_PAL(BIVAGUE, gMonPalette_Bivague),
    SPECIES_PAL(LUSCKAW, gMonPalette_Lusckaw),
    SPECIES_PAL(SADSOD, gMonPalette_Sadsod),
    SPECIES_PAL(MAERACHOLY, gMonPalette_Maeracholy),
    SPECIES_PAL(LUMELMO, gMonPalette_Lumelmo),
    SPECIES_PAL(LUMENDELA, gMonPalette_Lumendela),
    SPECIES_PAL(STOMAWAY, gMonPalette_Stomaway),
    SPECIES_PAL(CRAWLAXY, gMonPalette_Crawlaxy),
    SPECIES_PAL(MAGNALURE, gMonPalette_Magnalure),
    SPECIES_PAL(MAGNANICOR, gMonPalette_Magnanicor),
    SPECIES_PAL(CRYPLIN, gMonPalette_Cryplin),
    SPECIES_PAL(UHEFOE, gMonPalette_Uhefoe),
    SPECIES_PAL(MYSTOMANIA, gMonPalette_Mystomania),
    SPECIES_PAL(LYORESA, gMonPalette_Lyoresa),
    SPECIES_PAL(KODOUGH, gMonPalette_Kodough),
    SPECIES_PAL(SLICKSLICE, gMonPalette_Slickslice),
    SPECIES_PAL(LOAFOOF, gMonPalette_Loafoof),
    SPECIES_PAL(SPIRITOAST, gMonPalette_Spiritoast),
    ...
    SPECIES_PAL(COOLMUTTE, gMonPalette_Coolmutte),
    SPECIES_PAL(CREAM, gMonPalette_Cream),
    SPECIES_PAL(CREMELETTS, gMonPalette_Cremeletts),
    SPECIES_PAL(SNURROWL, gMonPalette_Snurrowl),
    SPECIES_PAL(STOLYCE, gMonPalette_Stolyce),
    SPECIES_PAL(POMELONIAN, gMonPalette_Pomelonian),
    SPECIES_PAL(GOURDOUG, gMonPalette_Gourdoug),
    SPECIES_PAL(FOGGLEHIND, gMonPalette_Fogglehind),
    SPECIES_PAL(MATCHLIT, gMonPalette_Matchlit),
    SPECIES_PAL(YAGANGRAN, gMonPalette_Yagangran),
    SPECIES_PAL(PIDIUM, gMonPalette_Pidium),
    SPECIES_PAL(MEDGEON, gMonPalette_Medgeon),
    SPECIES_PAL(MAGGORDE, gMonPalette_Maggorde),
    SPECIES_PAL(FLAGUE, gMonPalette_Flague),
    SPECIES_PAL(CULTIPEX, gMonPalette_Cultipex),
    SPECIES_PAL(EERIKO, gMonPalette_Eeriko),
    SPECIES_PAL(MANNIKO, gMonPalette_Manniko),
    SPECIES_PAL(KOWAKO, gMonPalette_Kowako),
    SPECIES_PAL(UMBRAT, gMonPalette_Umbrat),
    SPECIES_PAL(CHIROBERRA, gMonPalette_Chiroberra),
    SPECIES_PAL(WEROBERRA, gMonPalette_Weroberra),
    SPECIES_PAL(SACKYTWACK, gMonPalette_Sackytwack),
    SPECIES_PAL(STRAWNGMAN, gMonPalette_Strawngman),
    SPECIES_PAL(LAWPARD, gMonPalette_Lawpard),
    SPECIES_PAL(OOHBAABA, gMonPalette_Oohbaaba),
    SPECIES_PAL(GOLDEROCK, gMonPalette_Golderock),
    SPECIES_PAL(MAYNIMO, gMonPalette_Maynimo),
    SPECIES_PAL(BUTTERWEE, gMonPalette_Butterwee),
    SPECIES_PAL(PETRIPA, gMonPalette_Petripa),
    SPECIES_PAL(CATTOWYRM, gMonPalette_Cattowyrm),
    SPECIES_PAL(BRAMBOOZLE, gMonPalette_Bramboozle),
    SPECIES_PAL(HOAXPOCUS, gMonPalette_Hoaxpocus),
    SPECIES_PAL(PITAGON, gMonPalette_Pitagon),
    SPECIES_PAL(PUTREGON, gMonPalette_Putregon),
    SPECIES_PAL(GOLTIGATOR, gMonPalette_Goltigator),
    SPECIES_PAL(KAPRIKOLA, gMonPalette_Kaprikola),
    SPECIES_PAL(BLOTTA, gMonPalette_Blotta),
    SPECIES_PAL(SCHACHTTA, gMonPalette_Schachtta),
    SPECIES_PAL(SYLVREIGN, gMonPalette_Sylvreign),
    SPECIES_PAL(CATTUCLID, gMonPalette_Cattuclid),
    SPECIES_PAL(FRACTOFLY, gMonPalette_Fractofly),
    SPECIES_PAL(GRAVELITO, gMonPalette_Gravelito),
    SPECIES_PAL(MEGALITO, gMonPalette_Megalito),
    SPECIES_PAL(COMBUN, gMonPalette_Combun),
    SPECIES_PAL(HAIBUN, gMonPalette_Haibun),
    SPECIES_PAL(BURBUN, gMonPalette_Burbun),
    SPECIES_PAL(INGBUN, gMonPalette_Ingbun),
    SPECIES_PAL(CHAFFAW, gMonPalette_Chaffaw),
    SPECIES_PAL(FERROR, gMonPalette_Ferror),
    SPECIES_PAL(COBBTLE, gMonPalette_Cobbtle),
    SPECIES_PAL(MONTORT, gMonPalette_Montort),
    SPECIES_PAL(BOLTEROCK, gMonPalette_Bolterock),
    SPECIES_PAL(VOREON, gMonPalette_Voreon),
    SPECIES_PAL(CORISP, gMonPalette_Corisp),
    SPECIES_PAL(KROLPYRE, gMonPalette_Krolpyre),
    SPECIES_PAL(TOXITIDE, gMonPalette_Toxitide),
    SPECIES_PAL(TOXITURF, gMonPalette_Toxiturf),
    SPECIES_PAL(PEBBLER, gMonPalette_Pebbler),
    SPECIES_PAL(DUNEWICH, gMonPalette_Dunewich),
    SPECIES_PAL(MAJADIJUNN, gMonPalette_Majadijunn),
    SPECIES_PAL(CAPYBARA, gMonPalette_Capybara),
    SPECIES_PAL(ABARBINASH, gMonPalette_Abarbinash),
    SPECIES_PAL(JARAMERA, gMonPalette_Jaramera),
    SPECIES_PAL(BLINGUIN, gMonPalette_Blinguin),
    SPECIES_PAL(BIYAKO, gMonPalette_Biyako),
    SPECIES_PAL(BEHEKO, gMonPalette_Beheko),
    SPECIES_PAL(HEMOKO, gMonPalette_Hemoko),
    SPECIES_PAL(LEPUCYTE, gMonPalette_Lepucyte),
    SPECIES_PAL(LEUKUNEHO, gMonPalette_Leukuneho),
    SPECIES_PAL(WELPROOT, gMonPalette_Welproot),
    SPECIES_PAL(DRAEKAROT, gMonPalette_Draekarot),
    SPECIES_PAL(KARODORAUG, gMonPalette_Karodoraug),
    SPECIES_PAL(COFORCHEE, gMonPalette_Coforchee),
    SPECIES_PAL(MUSTYBANE, gMonPalette_Mustybane),
    SPECIES_PAL(WANNEGG, gMonPalette_Wannegg),
    SPECIES_PAL(EGGNEGGMA, gMonPalette_Eggneggma),
    SPECIES_PAL(LEVLADE, gMonPalette_Levlade),
    SPECIES_PAL(SHOCKORE, gMonPalette_Shockore),
    SPECIES_PAL(PLASMANTIS, gMonPalette_Plasmantis),
    SPECIES_PAL(HARACE, gMonPalette_Harace),
    SPECIES_PAL(TORSTEVIC, gMonPalette_Torstevic),
    SPECIES_PAL(CHIKA, gMonPalette_Chika),
    SPECIES_PAL(SWORDUC, gMonPalette_Sworduc),
    SPECIES_PAL(GOSMARK, gMonPalette_Gosmark),
    SPECIES_PAL(CORDELICT, gMonPalette_Cordelict),
    SPECIES_PAL(MERALCORE, gMonPalette_Meralcore),
    SPECIES_PAL(RAITAIC, gMonPalette_Raitaic),
    SPECIES_PAL(NIMBOZOA, gMonPalette_Nimbozoa),
    SPECIES_PAL(MINOTE, gMonPalette_Minote),
    SPECIES_PAL(TUNAP, gMonPalette_Tunap),
    SPECIES_PAL(BASSHARK, gMonPalette_Basshark),
    SPECIES_PAL(SHARGUY, gMonPalette_Sharguy),
    SPECIES_PAL(SHARPREY, gMonPalette_Sharprey),
    SPECIES_PAL(CHUNGRIM, gMonPalette_Chungrim),
    SPECIES_PAL(SQUEESHY, gMonPalette_Squeeshy),
    SPECIES_PAL(SQUISHIME, gMonPalette_Squishime),
    SPECIES_PAL(OCTOHIME, gMonPalette_Octohime),
    SPECIES_PAL(COLFIN, gMonPalette_Colfin),
    SPECIES_PAL(MYSTICIAN, gMonPalette_Mystician),
    SPECIES_PAL(WALRUST, gMonPalette_Walrust),
    SPECIES_PAL(SCALLYWARG, gMonPalette_Scallywarg),
    SPECIES_PAL(WAARGH, gMonPalette_Waargh),
    SPECIES_PAL(SKELLYWARG, gMonPalette_Skellywarg),
    SPECIES_PAL(CASOWARY, gMonPalette_Casowary),
    SPECIES_PAL(PASSAWARY, gMonPalette_Passawary),
    SPECIES_PAL(BOOZARD, gMonPalette_Boozard),
    SPECIES_PAL(COCKABOO, gMonPalette_Cockaboo),
    SPECIES_PAL(AXELFIN, gMonPalette_Axelfin),
    SPECIES_PAL(MORAGAN, gMonPalette_Moragan),
    SPECIES_PAL(SHIVERSNAP, gMonPalette_Shiversnap),
    SPECIES_PAL(EXCATATOR, gMonPalette_Excatator),
    SPECIES_PAL(MARSOYART, gMonPalette_Marsoyart),
    SPECIES_PAL(CINDRILLON, gMonPalette_Cindrillon),
    SPECIES_PAL(ARMAGATTON, gMonPalette_Armagatton),
    SPECIES_PAL(FAKYSNAKY, gMonPalette_Fakysnaky),
    SPECIES_PAL(PANTNEY, gMonPalette_Pantney),
    SPECIES_PAL(NYARLY, gMonPalette_Nyarly),
    SPECIES_PAL(SUDCUB, gMonPalette_Sudcub),
    SPECIES_PAL(TARDRITCH, gMonPalette_Tardritch),
    SPECIES_PAL(BLABBU, gMonPalette_Blabbu),
    SPECIES_PAL(TURRYTURRY, gMonPalette_Turryturry),
    SPECIES_PAL(FAERED, gMonPalette_Faered),
    SPECIES_PAL(PROMISCBUS, gMonPalette_Promiscbus),
    SPECIES_PAL(GUMBORREE, gMonPalette_Gumborree),
    SPECIES_PAL(KOREMAI, gMonPalette_Koremai),
    SPECIES_PAL(KORESATO, gMonPalette_Koresato),
    SPECIES_PAL(DRAKULARK, gMonPalette_Drakulark),
    SPECIES_PAL(NOSFERAPTR, gMonPalette_Nosferaptr),
    SPECIES_PAL(OLFLOOKIE, gMonPalette_OlFlookie),
    SPECIES_PAL(JUSTRICHA, gMonPalette_Justricha),
    SPECIES_PAL(AJOKUJOKU, gMonPalette_Ajokujoku),
    SPECIES_PAL(GARJIRA, gMonPalette_Garjira),
    SPECIES_PAL(GARZILLA, gMonPalette_Garzilla),
    SPECIES_PAL(YANDEMIC, gMonPalette_Yandemic),
    SPECIES_PAL(LUNASTER, gMonPalette_Lunaster),
    SPECIES_PAL(JACKABOX, gMonPalette_Jackabox),
    SPECIES_PAL(FOOLTAGE, gMonPalette_Fooltage),
    SPECIES_PAL(AETHEREAL, gMonPalette_Aethereal),
    SPECIES_PAL(MOTHRAMITY, gMonPalette_Mothramity),
    SPECIES_PAL(GLAREYALE, gMonPalette_Glareyale),
    SPECIES_PAL(LEVIALAGO, gMonPalette_Levialago),
    SPECIES_PAL(RETROROACH, gMonPalette_Retroroach),
    SPECIES_PAL(NEOROACH, gMonPalette_Neoroach),
    SPECIES_PAL(SPITFAX, gMonPalette_Spitfax),
    SPECIES_PAL(RAPSCALEON, gMonPalette_Rapscaleon),
    SPECIES_PAL(AGOMAGO, gMonPalette_Agomago),
    SPECIES_PAL(MORFTREE, gMonPalette_Morftree),
    SPECIES_PAL(EPOCHOTL, gMonPalette_Epochotl),
    SPECIES_PAL(VIVISU, gMonPalette_Vivisu),
    SPECIES_PAL(SOLASU, gMonPalette_Solasu),
    SPECIES_PAL(SUMMERASU, gMonPalette_Summerasu),
    SPECIES_PAL(OROFLOW, gMonPalette_Oroflow),
    SPECIES_PAL(ORROCAST, gMonPalette_Orrocast),
    SPECIES_PAL(ORROWHELM, gMonPalette_Orrowhelm),
    SPECIES_PAL(SHAYON, gMonPalette_ShaYon),
    SPECIES_PAL(LUOSHAN, gMonPalette_LuoShan),
    SPECIES_PAL(LOTTABATS, gMonPalette_Lottabats),
    SPECIES_PAL(LOTTABATS_DISPERSED, gMonPalette_LottabatsDispersed),
    SPECIES_PAL(GAOTERRA, gMonPalette_Gaoterra),
    SPECIES_PAL(GAOTERRA_SOLAR, gMonPalette_GaoterraSolar),
    SPECIES_PAL(GAOTERRA_LUNAR, gMonPalette_GaoterraLunar),
    SPECIES_PAL(BISHOUCHA, gMonPalette_Bishoucha),
    ...
    SPECIES_PAL(SHUNYONG, gMonPalette_Shunyong),
    ...
    SPECIES_PAL(DAKKAPOD, gMonPalette_Dakkapod),
    ...
    SPECIES_PAL(YOLKWEEN, gMonPalette_Yolkween),
    SPECIES_PAL(SHISHIMA_ALT, gMonPalette_Shishima),
    SPECIES_PAL(SHISHIMA_PUNISHER_ALT, gMonPalette_ShishimaPunisherAlt),
    SPECIES_PAL(LYOLICA, gMonPalette_Lyolica),
    SPECIES_PAL(WALLY, gMonPalette_Wally),
    SPECIES_PAL(POTTRICIA, gMonPalette_Pottricia),
    SPECIES_PAL(POTTRICIA_SHATTERED, gMonPalette_PottriciaShattered),
    SPECIES_PAL(FAKYSNAKY_BUSTED, gMonPalette_FakysnakyBusted),
    SPECIES_PAL(FLAGUE_PRINCE, gMonPalette_FlaguePrince),
#endif
    ...
    SPECIES_PAL(ZYGARDE_10_DORMANT, gMonPalette_Zygarde10),
    SPECIES_PAL(ZYGARDE_50_DORMANT, gMonPalette_Zygarde),
...
#endif
    SPECIES_PAL(KARODORAUG, gMonPalette_KarodoraugF),
