const struct CompressedSpriteSheet gMonFrontPicTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(SPINDA_CAVE, gMonFrontPic_SpindaCave),
    SPECIES_SPRITE(SPINDA_DESERT, gMonFrontPic_SpindaDesert),
    SPECIES_SPRITE(SPINDA_FOREST, gMonFrontPic_SpindaForest),
    SPECIES_SPRITE(SPINDA_MOUNTAIN, gMonFrontPic_SpindaMountain),
    SPECIES_SPRITE(SPINDA_PLAINS, gMonFrontPic_SpindaPlains),
    ...
    SPECIES_SPRITE(TIDPIT, gMonFrontPic_Tidpit),
    SPECIES_SPRITE(SLIDLOW, gMonFrontPic_Slidlow),
    SPECIES_SPRITE(CARDIOVOR, gMonFrontPic_Cardiovor),
    SPECIES_SPRITE(FIEFREET, gMonFrontPic_Fiefreet),
    SPECIES_SPRITE(BALBYRN, gMonFrontPic_Balbyrn),
    SPECIES_SPRITE(BLAZIZAHAK, gMonFrontPic_Blazizahak),
    SPECIES_SPRITE(PRONGY, gMonFrontPic_Prongy),
    SPECIES_SPRITE(TRIDALIER, gMonFrontPic_Tridalier),
    SPECIES_SPRITE(TRITONAUT, gMonFrontPic_Tritonaut),
    SPECIES_SPRITE(SNELFREND, gMonFrontPic_Snelfrend),
    SPECIES_SPRITE(SYCOPLOD, gMonFrontPic_Sycoplod),
    SPECIES_SPRITE(SYCOSTROM, gMonFrontPic_Sycostrom),
    SPECIES_SPRITE(GUPSPAR, gMonFrontPic_Gupspar),
    SPECIES_SPRITE(VANGAR, gMonFrontPic_Vangar),
    SPECIES_SPRITE(GHAERIAL, gMonFrontPic_Ghaerial),
    SPECIES_SPRITE(QUILWARD, gMonFrontPic_Quilward),
    SPECIES_SPRITE(BONFEU, gMonFrontPic_Bonfeu),
    SPECIES_SPRITE(INFRAREC, gMonFrontPic_Infrarec),
    SPECIES_SPRITE(BERM, gMonFrontPic_Berm),
    SPECIES_SPRITE(MOODA, gMonFrontPic_Mooda),
    SPECIES_SPRITE(BERMUDON, gMonFrontPic_Bermudon),
    SPECIES_SPRITE(MARINAROC, gMonFrontPic_Marinaroc),
    SPECIES_SPRITE(METTATOLL, gMonFrontPic_Mettatoll),
    SPECIES_SPRITE(ICKSQUEEK, gMonFrontPic_Icksqueek),
    SPECIES_SPRITE(KOMORODE, gMonFrontPic_Komorode),
    SPECIES_SPRITE(ANNIHILAPE, gMonFrontPic_Annihilape),
    SPECIES_SPRITE(EBIBI, gMonFrontPic_Ebibi),
    SPECIES_SPRITE(MAKIBI, gMonFrontPic_Makibi),
    SPECIES_SPRITE(EBIROSASHI, gMonFrontPic_Ebirosashi),
    SPECIES_SPRITE(KITIKITI, gMonFrontPic_Kitikiti),
    SPECIES_SPRITE(MOSKOPO, gMonFrontPic_Moskopo),
    SPECIES_SPRITE(ABSOLARIA, gMonFrontPic_Absolaria),
    SPECIES_SPRITE(KYUDI, gMonFrontPic_Kyudi),
    SPECIES_SPRITE(KOMBAKYU, gMonFrontPic_Kombakyu),
    SPECIES_SPRITE(FLUFFSIR, gMonFrontPic_Fluffsir),
    SPECIES_SPRITE(FLUFFREAR, gMonFrontPic_Fluffrear),
    SPECIES_SPRITE(SAINTISOW, gMonFrontPic_Saintisow),
    SPECIES_SPRITE(SANCTISOW, gMonFrontPic_Sanctisow),
    SPECIES_SPRITE(SOWPHIROTH, gMonFrontPic_Sowphiroth),
    SPECIES_SPRITE(TOXEXOT, gMonFrontPic_Toxexot),
    SPECIES_SPRITE(PSEUDRA, gMonFrontPic_Pseudra),
    SPECIES_SPRITE(MANDIMYTE, gMonFrontPic_Mandimyte),
    SPECIES_SPRITE(TERMINYTE, gMonFrontPic_Terminyte),
    SPECIES_SPRITE(SNOTLOUD, gMonFrontPic_Snotloud),
    SPECIES_SPRITE(SICKBEAT, gMonFrontPic_Sickbeat),
    SPECIES_SPRITE(SPRYTE, gMonFrontPic_Spryte),
    SPECIES_SPRITE(GUMONA, gMonFrontPic_Gumona),
    SPECIES_SPRITE(NANGGAL, gMonFrontPic_Nanggal),
    SPECIES_SPRITE(SHEEDRAKE, gMonFrontPic_Sheedrake),
    SPECIES_SPRITE(TRANSERA, gMonFrontPic_Transera),
    SPECIES_SPRITE(BIVAGUE, gMonFrontPic_Bivague),
    SPECIES_SPRITE(LUSCKAW, gMonFrontPic_Lusckaw),
    SPECIES_SPRITE(SADSOD, gMonFrontPic_Sadsod),
    SPECIES_SPRITE(MAERACHOLY, gMonFrontPic_Maeracholy),
    SPECIES_SPRITE(LUMELMO, gMonFrontPic_Lumelmo),
    SPECIES_SPRITE(LUMENDELA, gMonFrontPic_Lumendela),
    SPECIES_SPRITE(STOMAWAY, gMonFrontPic_Stomaway),
    SPECIES_SPRITE(CRAWLAXY, gMonFrontPic_Crawlaxy),
    SPECIES_SPRITE(MAGNALURE, gMonFrontPic_Magnalure),
    SPECIES_SPRITE(MAGNANICOR, gMonFrontPic_Magnanicor),
    SPECIES_SPRITE(CRYPLIN, gMonFrontPic_Cryplin),
    SPECIES_SPRITE(UHEFOE, gMonFrontPic_Uhefoe),
    SPECIES_SPRITE(MYSTOMANIA, gMonFrontPic_Mystomania),
    SPECIES_SPRITE(LYORESA, gMonFrontPic_Lyoresa),
    SPECIES_SPRITE(KODOUGH, gMonFrontPic_Kodough),
    SPECIES_SPRITE(SLICKSLICE, gMonFrontPic_Slickslice),
    SPECIES_SPRITE(LOAFOOF, gMonFrontPic_Loafoof),
    SPECIES_SPRITE(SPIRITOAST, gMonFrontPic_Spiritoast),
    SPECIES_SPRITE(HAPPEA, gMonFrontPic_Happea),
    SPECIES_SPRITE(DUDUNSPARS, gMonFrontPic_Dudunspars),
    SPECIES_SPRITE(DUDUNSPARS_THREE_SEGMENT, gMonFrontPic_DudunsparsThreeSegment),
    SPECIES_SPRITE(DUDUNSPARS_EIGHT_SEGMENT, gMonFrontPic_DudunsparsEightSegment),
    ...
    SPECIES_SPRITE(POMELONIAN, gMonFrontPic_Pomelonian),
    SPECIES_SPRITE(GOURDOUG, gMonFrontPic_Gourdoug),
    SPECIES_SPRITE(FOGGLEHIND, gMonFrontPic_Fogglehind),
    SPECIES_SPRITE(MATCHLIT, gMonFrontPic_Matchlit),
    SPECIES_SPRITE(YAGANGRAN, gMonFrontPic_Yagangran),
    SPECIES_SPRITE(PIDIUM, gMonFrontPic_Pidium),
    SPECIES_SPRITE(MEDGEON, gMonFrontPic_Medgeon),
    SPECIES_SPRITE(MAGGORDE, gMonFrontPic_Maggorde),
    SPECIES_SPRITE(FLAGUE, gMonFrontPic_Flague),
    SPECIES_SPRITE(CULTIPEX, gMonFrontPic_Cultipex),
    SPECIES_SPRITE(EERIKO, gMonFrontPic_Eeriko),
    SPECIES_SPRITE(MANNIKO, gMonFrontPic_Manniko),
    SPECIES_SPRITE(KOWAKO, gMonFrontPic_Kowako),
    SPECIES_SPRITE(UMBRAT, gMonFrontPic_Umbrat),
    SPECIES_SPRITE(CHIROBERRA, gMonFrontPic_Chiroberra),
    SPECIES_SPRITE(WEROBERRA, gMonFrontPic_Weroberra),
    SPECIES_SPRITE(SACKYTWACK, gMonFrontPic_Sackytwack),
    SPECIES_SPRITE(STRAWNGMAN, gMonFrontPic_Strawngman),
    SPECIES_SPRITE(LAWPARD, gMonFrontPic_Lawpard),
    SPECIES_SPRITE(OOHBAABA, gMonFrontPic_Oohbaaba),
    SPECIES_SPRITE(GOLDEROCK, gMonFrontPic_Golderock),
    SPECIES_SPRITE(MAYNIMO, gMonFrontPic_Maynimo),
    SPECIES_SPRITE(BUTTERWEE, gMonFrontPic_Butterwee),
    SPECIES_SPRITE(PETRIPA, gMonFrontPic_Petripa),
    SPECIES_SPRITE(CATTOWYRM, gMonFrontPic_Cattowyrm),
    SPECIES_SPRITE(BRAMBOOZLE, gMonFrontPic_Bramboozle),
    SPECIES_SPRITE(HOAXPOCUS, gMonFrontPic_Hoaxpocus),
    SPECIES_SPRITE(PITAGON, gMonFrontPic_Pitagon),
    SPECIES_SPRITE(PUTREGON, gMonFrontPic_Putregon),
    SPECIES_SPRITE(GOLTIGATOR, gMonFrontPic_Goltigator),
    SPECIES_SPRITE(KAPRIKOLA, gMonFrontPic_Kaprikola),
    SPECIES_SPRITE(BLOTTA, gMonFrontPic_Blotta),
    SPECIES_SPRITE(SCHACHTTA, gMonFrontPic_Schachtta),
    SPECIES_SPRITE(SYLVREIGN, gMonFrontPic_Sylvreign),
    SPECIES_SPRITE(CATTUCLID, gMonFrontPic_Cattuclid),
    SPECIES_SPRITE(FRACTOFLY, gMonFrontPic_Fractofly),
    SPECIES_SPRITE(GRAVELITO, gMonFrontPic_Gravelito),
    SPECIES_SPRITE(MEGALITO, gMonFrontPic_Megalito),
    SPECIES_SPRITE(COMBUN, gMonFrontPic_Combun),
    SPECIES_SPRITE(HAIBUN, gMonFrontPic_Haibun),
    SPECIES_SPRITE(BURBUN, gMonFrontPic_Burbun),
    SPECIES_SPRITE(INGBUN, gMonFrontPic_Ingbun),
    SPECIES_SPRITE(CHAFFAW, gMonFrontPic_Chaffaw),
    SPECIES_SPRITE(FERROR, gMonFrontPic_Ferror),
    SPECIES_SPRITE(COBBTLE, gMonFrontPic_Cobbtle),
    SPECIES_SPRITE(MONTORT, gMonFrontPic_Montort),
    SPECIES_SPRITE(BOLTEROCK, gMonFrontPic_Bolterock),
    SPECIES_SPRITE(VOREON, gMonFrontPic_Voreon),
    SPECIES_SPRITE(CORISP, gMonFrontPic_Corisp),
    SPECIES_SPRITE(KROLPYRE, gMonFrontPic_Krolpyre),
    SPECIES_SPRITE(TOXITIDE, gMonFrontPic_Toxitide),
    SPECIES_SPRITE(TOXITURF, gMonFrontPic_Toxiturf),
    SPECIES_SPRITE(PEBBLER, gMonFrontPic_Pebbler),
    SPECIES_SPRITE(DUNEWICH, gMonFrontPic_Dunewich),
    SPECIES_SPRITE(MAJADIJUNN, gMonFrontPic_Majadijunn),
    SPECIES_SPRITE(CAPYBARA, gMonFrontPic_Capybara),
    SPECIES_SPRITE(ABARBINASH, gMonFrontPic_Abarbinash),
    SPECIES_SPRITE(JARAMERA, gMonFrontPic_Jaramera),
    SPECIES_SPRITE(BLINGUIN, gMonFrontPic_Blinguin),
    SPECIES_SPRITE(BIYAKO, gMonFrontPic_Biyako),
    SPECIES_SPRITE(BEHEKO, gMonFrontPic_Beheko),
    SPECIES_SPRITE(HEMOKO, gMonFrontPic_Hemoko),
    SPECIES_SPRITE(LEPUCYTE, gMonFrontPic_Lepucyte),
    SPECIES_SPRITE(LEUKUNEHO, gMonFrontPic_Leukuneho),
    SPECIES_SPRITE(WELPROOT, gMonFrontPic_Welproot),
    SPECIES_SPRITE(DRAEKAROT, gMonFrontPic_Draekarot),
    SPECIES_SPRITE(KARODORAUG, gMonFrontPic_Karodoraug),
    SPECIES_SPRITE(COFORCHEE, gMonFrontPic_Coforchee),
    SPECIES_SPRITE(MUSTYBANE, gMonFrontPic_Mustybane),
    SPECIES_SPRITE(WANNEGG, gMonFrontPic_Wannegg),
    SPECIES_SPRITE(EGGNEGGMA, gMonFrontPic_Eggneggma),
    SPECIES_SPRITE(LEVLADE, gMonFrontPic_Levlade),
    SPECIES_SPRITE(SHOCKORE, gMonFrontPic_Shockore),
    SPECIES_SPRITE(PLASMANTIS, gMonFrontPic_Plasmantis),
    SPECIES_SPRITE(HARACE, gMonFrontPic_Harace),
    SPECIES_SPRITE(TORSTEVIC, gMonFrontPic_Torstevic),
    SPECIES_SPRITE(CHIKA, gMonFrontPic_Chika),
    SPECIES_SPRITE(SWORDUC, gMonFrontPic_Sworduc),
    SPECIES_SPRITE(GOSMARK, gMonFrontPic_Gosmark),
    SPECIES_SPRITE(CORDELICT, gMonFrontPic_Cordelict),
    SPECIES_SPRITE(MERALCORE, gMonFrontPic_Meralcore),
    SPECIES_SPRITE(RAITAIC, gMonFrontPic_Raitaic),
    SPECIES_SPRITE(NIMBOZOA, gMonFrontPic_Nimbozoa),
    SPECIES_SPRITE(MINOTE, gMonFrontPic_Minote),
    SPECIES_SPRITE(TUNAP, gMonFrontPic_Tunap),
    SPECIES_SPRITE(BASSHARK, gMonFrontPic_Basshark),
    SPECIES_SPRITE(SHARGUY, gMonFrontPic_Sharguy),
    SPECIES_SPRITE(SHARPREY, gMonFrontPic_Sharprey),
    SPECIES_SPRITE(CHUNGRIM, gMonFrontPic_Chungrim),
    SPECIES_SPRITE(SQUEESHY, gMonFrontPic_Squeeshy),
    SPECIES_SPRITE(SQUISHIME, gMonFrontPic_Squishime),
    SPECIES_SPRITE(OCTOHIME, gMonFrontPic_Octohime),
    SPECIES_SPRITE(COLFIN, gMonFrontPic_Colfin),
    SPECIES_SPRITE(MYSTICIAN, gMonFrontPic_Mystician),
    SPECIES_SPRITE(WALRUST, gMonFrontPic_Walrust),
    SPECIES_SPRITE(SCALLYWARG, gMonFrontPic_Scallywarg),
    SPECIES_SPRITE(WAARGH, gMonFrontPic_Waargh),
    SPECIES_SPRITE(SKELLYWARG, gMonFrontPic_Skellywarg),
    SPECIES_SPRITE(CASOWARY, gMonFrontPic_Casowary),
    SPECIES_SPRITE(PASSAWARY, gMonFrontPic_Passawary),
    SPECIES_SPRITE(BOOZARD, gMonFrontPic_Boozard),
    SPECIES_SPRITE(COCKABOO, gMonFrontPic_Cockaboo),
    SPECIES_SPRITE(AXELFIN, gMonFrontPic_Axelfin),
    SPECIES_SPRITE(MORAGAN, gMonFrontPic_Moragan),
    SPECIES_SPRITE(SHIVERSNAP, gMonFrontPic_Shiversnap),
    SPECIES_SPRITE(EXCATATOR, gMonFrontPic_Excatator),
    SPECIES_SPRITE(MARSOYART, gMonFrontPic_Marsoyart),
    SPECIES_SPRITE(CINDRILLON, gMonFrontPic_Cindrillon),
    SPECIES_SPRITE(ARMAGATTON, gMonFrontPic_Armagatton),
    SPECIES_SPRITE(FAKYSNAKY, gMonFrontPic_Fakysnaky),
    SPECIES_SPRITE(PANTNEY, gMonFrontPic_Pantney),
    SPECIES_SPRITE(NYARLY, gMonFrontPic_Nyarly),
    SPECIES_SPRITE(SUDCUB, gMonFrontPic_Sudcub),
    SPECIES_SPRITE(TARDRITCH, gMonFrontPic_Tardritch),
    SPECIES_SPRITE(BLABBU, gMonFrontPic_Blabbu),
    SPECIES_SPRITE(TURRYTURRY, gMonFrontPic_Turryturry),
    SPECIES_SPRITE(FAERED, gMonFrontPic_Faered),
    SPECIES_SPRITE(PROMISCBUS, gMonFrontPic_Promiscbus),
    SPECIES_SPRITE(GUMBORREE, gMonFrontPic_Gumborree),
    SPECIES_SPRITE(KOREMAI, gMonFrontPic_Koremai),
    SPECIES_SPRITE(KORESATO, gMonFrontPic_Koresato),
    SPECIES_SPRITE(DRAKULARK, gMonFrontPic_Drakulark),
    SPECIES_SPRITE(NOSFERAPTR, gMonFrontPic_Nosferaptr),
    SPECIES_SPRITE(OLFLOOKIE, gMonFrontPic_OlFlookie),
    SPECIES_SPRITE(JUSTRICHA, gMonFrontPic_Justricha),
    SPECIES_SPRITE(AJOKUJOKU, gMonFrontPic_Ajokujoku),
    SPECIES_SPRITE(GARJIRA, gMonFrontPic_Garjira),
    SPECIES_SPRITE(GARZILLA, gMonFrontPic_Garzilla),
    SPECIES_SPRITE(YANDEMIC, gMonFrontPic_Yandemic),
    SPECIES_SPRITE(LUNASTER, gMonFrontPic_Lunaster),
    SPECIES_SPRITE(JACKABOX, gMonFrontPic_Jackabox),
    SPECIES_SPRITE(FOOLTAGE, gMonFrontPic_Fooltage),
    SPECIES_SPRITE(AETHEREAL, gMonFrontPic_Aethereal),
    SPECIES_SPRITE(MOTHRAMITY, gMonFrontPic_Mothramity),
    SPECIES_SPRITE(GLAREYALE, gMonFrontPic_Glareyale),
    SPECIES_SPRITE(LEVIALAGO, gMonFrontPic_Levialago),
    SPECIES_SPRITE(RETROROACH, gMonFrontPic_Retroroach),
    SPECIES_SPRITE(NEOROACH, gMonFrontPic_Neoroach),
    SPECIES_SPRITE(SPITFAX, gMonFrontPic_Spitfax),
    SPECIES_SPRITE(RAPSCALEON, gMonFrontPic_Rapscaleon),
    SPECIES_SPRITE(AGOMAGO, gMonFrontPic_Agomago),
    SPECIES_SPRITE(MORFTREE, gMonFrontPic_Morftree),
    SPECIES_SPRITE(EPOCHOTL, gMonFrontPic_Epochotl),
    SPECIES_SPRITE(VIVISU, gMonFrontPic_Vivisu),
    SPECIES_SPRITE(SOLASU, gMonFrontPic_Solasu),
    SPECIES_SPRITE(SUMMERASU, gMonFrontPic_Summerasu),
    SPECIES_SPRITE(OROFLOW, gMonFrontPic_Oroflow),
    SPECIES_SPRITE(ORROCAST, gMonFrontPic_Orrocast),
    SPECIES_SPRITE(ORROWHELM, gMonFrontPic_Orrowhelm),
    ...
    SPECIES_SPRITE(BISHOUCHA, gMonFrontPic_Bishoucha),
    SPECIES_SPRITE(BISHOUCHA_WARMONGER, gMonFrontPic_BishouchaWarmonger),
    SPECIES_SPRITE(PAPYPUS, gMonFrontPic_Papypus),
    SPECIES_SPRITE(PAPYPUS_FEMALE, gMonFrontPic_PapypusFemale),
    SPECIES_SPRITE(CINDRILLON_PIROUETTE, gMonFrontPic_CindrillonPirouette),
    SPECIES_SPRITE(CINDRILLON_FEAROUETTE, gMonFrontPic_CindrillonFearouette),
    SPECIES_SPRITE(SHISHIMA, gMonFrontPic_Shishima),
    SPECIES_SPRITE(SHISHIMA_PUNISHER, gMonFrontPic_ShishimaPunisher),
    SPECIES_SPRITE(SHUNYONG, gMonFrontPic_Shunyong),
    SPECIES_SPRITE(SHUNYONG_GOLDEN_OFFENSE, gMonFrontPic_ShunyongGoldenOffense),
    SPECIES_SPRITE(KINGAMBIT, gMonFrontPic_Kingambit),
    SPECIES_SPRITE(SHELLYLOUH, gMonFrontPic_Shellylouh),
    SPECIES_SPRITE(INFAIRNO, gMonFrontPic_Infairno),
    SPECIES_SPRITE(PURGATIVAL, gMonFrontPic_Purgatival),
    SPECIES_SPRITE(DETERIOTL, gMonFrontPic_Deteriotl),
    SPECIES_SPRITE(DAKKAPOD, gMonFrontPic_Dakkapod),
    SPECIES_SPRITE(UNBERRABLE, gMonFrontPic_Unberrable),
    SPECIES_SPRITE(PEBLRANIUM, gMonFrontPic_Peblranium),
    SPECIES_SPRITE(VAIKING, gMonFrontPic_Vaiking),
    SPECIES_SPRITE(KODOUGH_BLUNT, gMonFrontPic_KodoughBlunt),
    SPECIES_SPRITE(CASTFORM_SANDY, gMonFrontPic_CastformSandy),
    SPECIES_SPRITE(YOLKWEEN, gMonFrontPic_Yolkween),
    SPECIES_SPRITE(SHISHIMA_ALT, gMonFrontPic_Shishima),
    SPECIES_SPRITE(SHISHIMA_PUNISHER_ALT, gMonFrontPic_ShishimaPunisherAlt),
    SPECIES_SPRITE(LYOLICA, gMonFrontPic_Lyolica),
    SPECIES_SPRITE(WALLY, gMonFrontPic_Wally),
    SPECIES_SPRITE(POTTRICIA, gMonFrontPic_Pottricia),
    SPECIES_SPRITE(POTTRICIA_SHATTERED, gMonFrontPic_PottriciaShattered),
    SPECIES_SPRITE(FAKYSNAKY_BUSTED, gMonFrontPic_FakysnakyBusted),
    SPECIES_SPRITE(FLAGUE_PRINCE, gMonFrontPic_FlaguePrince),
#endif
