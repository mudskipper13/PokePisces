const struct CompressedSpriteSheet gMonBackPicTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(SPINDA_PLAINS, gMonBackPic_SpindaPlains),
    ...
    SPECIES_SPRITE(TIDPIT, gMonBackPic_Tidpit),
    SPECIES_SPRITE(SLIDLOW, gMonBackPic_Slidlow),
    SPECIES_SPRITE(CARDIOVOR, gMonBackPic_Cardiovor),
    SPECIES_SPRITE(FIEFREET, gMonBackPic_Fiefreet),
    SPECIES_SPRITE(BALBYRN, gMonBackPic_Balbyrn),
    SPECIES_SPRITE(BLAZIZAHAK, gMonBackPic_Blazizahak),
    SPECIES_SPRITE(PRONGY, gMonBackPic_Prongy),
    SPECIES_SPRITE(TRIDALIER, gMonBackPic_Tridalier),
    SPECIES_SPRITE(TRITONAUT, gMonBackPic_Tritonaut),
    SPECIES_SPRITE(SNELFREND, gMonBackPic_Snelfrend),
    SPECIES_SPRITE(SYCOPLOD, gMonBackPic_Sycoplod),
    SPECIES_SPRITE(SYCOSTROM, gMonBackPic_Sycostrom),
    SPECIES_SPRITE(GUPSPAR, gMonBackPic_Gupspar),
    SPECIES_SPRITE(VANGAR, gMonBackPic_Vangar),
    SPECIES_SPRITE(GHAERIAL, gMonBackPic_Ghaerial),
    SPECIES_SPRITE(QUILWARD, gMonBackPic_Quilward),
    SPECIES_SPRITE(BONFEU, gMonBackPic_Bonfeu),
    SPECIES_SPRITE(INFRAREC, gMonBackPic_Infrarec),
    SPECIES_SPRITE(BERM, gMonBackPic_Berm),
    SPECIES_SPRITE(MOODA, gMonBackPic_Mooda),
    SPECIES_SPRITE(BERMUDON, gMonBackPic_Bermudon),
    SPECIES_SPRITE(MARINAROC, gMonBackPic_Marinaroc),
    SPECIES_SPRITE(METTATOLL, gMonBackPic_Mettatoll),
    SPECIES_SPRITE(ICKSQUEEK, gMonBackPic_Icksqueek),
    SPECIES_SPRITE(KOMORODE, gMonBackPic_Komorode),
    SPECIES_SPRITE(ANNIHILAPE, gMonBackPic_Annihilape),
    SPECIES_SPRITE(EBIBI, gMonBackPic_Ebibi),
    SPECIES_SPRITE(MAKIBI, gMonBackPic_Makibi),
    SPECIES_SPRITE(EBIROSASHI, gMonBackPic_Ebirosashi),
    SPECIES_SPRITE(KITIKITI, gMonBackPic_Kitikiti),
    SPECIES_SPRITE(MOSKOPO, gMonBackPic_Moskopo),
    SPECIES_SPRITE(ABSOLARIA, gMonBackPic_Absolaria),
    SPECIES_SPRITE(KYUDI, gMonBackPic_Kyudi),
    SPECIES_SPRITE(KOMBAKYU, gMonBackPic_Kombakyu),
    SPECIES_SPRITE(FLUFFSIR, gMonBackPic_Fluffsir),
    SPECIES_SPRITE(FLUFFREAR, gMonBackPic_Fluffrear),
    SPECIES_SPRITE(SAINTISOW, gMonBackPic_Saintisow),
    SPECIES_SPRITE(SANCTISOW, gMonBackPic_Sanctisow),
    SPECIES_SPRITE(SOWPHIROTH, gMonBackPic_Sowphiroth),
    SPECIES_SPRITE(TOXEXOT, gMonBackPic_Toxexot),
    SPECIES_SPRITE(PSEUDRA, gMonBackPic_Pseudra),
    SPECIES_SPRITE(MANDIMYTE, gMonBackPic_Mandimyte),
    SPECIES_SPRITE(TERMINYTE, gMonBackPic_Terminyte),
    SPECIES_SPRITE(SNOTLOUD, gMonBackPic_Snotloud),
    SPECIES_SPRITE(SICKBEAT, gMonBackPic_Sickbeat),
    SPECIES_SPRITE(SPRYTE, gMonBackPic_Spryte),
    SPECIES_SPRITE(GUMONA, gMonBackPic_Gumona),
    SPECIES_SPRITE(NANGGAL, gMonBackPic_Nanggal),
    SPECIES_SPRITE(SHEEDRAKE, gMonBackPic_Sheedrake),
    SPECIES_SPRITE(TRANSERA, gMonBackPic_Transera),
    SPECIES_SPRITE(BIVAGUE, gMonBackPic_Bivague),
    SPECIES_SPRITE(LUSCKAW, gMonBackPic_Lusckaw),
    SPECIES_SPRITE(SADSOD, gMonBackPic_Sadsod),
    SPECIES_SPRITE(MAERACHOLY, gMonBackPic_Maeracholy),
    SPECIES_SPRITE(LUMELMO, gMonBackPic_Lumelmo),
    SPECIES_SPRITE(LUMENDELA, gMonBackPic_Lumendela),
    SPECIES_SPRITE(STOMAWAY, gMonBackPic_Stomaway),
    SPECIES_SPRITE(CRAWLAXY, gMonBackPic_Crawlaxy),
    SPECIES_SPRITE(MAGNALURE, gMonBackPic_Magnalure),
    SPECIES_SPRITE(MAGNANICOR, gMonBackPic_Magnanicor),
    SPECIES_SPRITE(CRYPLIN, gMonBackPic_Cryplin),
    SPECIES_SPRITE(UHEFOE, gMonBackPic_Uhefoe),
    SPECIES_SPRITE(MYSTOMANIA, gMonBackPic_Mystomania),
    SPECIES_SPRITE(LYORESA, gMonBackPic_Lyoresa),
    SPECIES_SPRITE(KODOUGH, gMonBackPic_Kodough),
    SPECIES_SPRITE(SLICKSLICE, gMonBackPic_Slickslice),
    SPECIES_SPRITE(LOAFOOF, gMonBackPic_Loafoof),
    SPECIES_SPRITE(SPIRITOAST, gMonBackPic_Spiritoast),
    ...
    SPECIES_SPRITE(COOLMUTTE, gMonBackPic_Coolmutte),
    SPECIES_SPRITE(CREAM, gMonBackPic_Cream),
    SPECIES_SPRITE(CREMELETTS, gMonBackPic_Cremeletts),
    SPECIES_SPRITE(SNURROWL, gMonBackPic_Snurrowl),
    SPECIES_SPRITE(STOLYCE, gMonBackPic_Stolyce),
    SPECIES_SPRITE(POMELONIAN, gMonBackPic_Pomelonian),
    SPECIES_SPRITE(GOURDOUG, gMonBackPic_Gourdoug),
    SPECIES_SPRITE(FOGGLEHIND, gMonBackPic_Fogglehind),
    SPECIES_SPRITE(MATCHLIT, gMonBackPic_Matchlit),
    ...
    SPECIES_SPRITE(MAGGORDE, gMonBackPic_Maggorde),
    SPECIES_SPRITE(FLAGUE, gMonBackPic_Flague),
    SPECIES_SPRITE(CULTIPEX, gMonBackPic_Cultipex),
    SPECIES_SPRITE(EERIKO, gMonBackPic_Eeriko),
    SPECIES_SPRITE(MANNIKO, gMonBackPic_Manniko),
    SPECIES_SPRITE(KOWAKO, gMonBackPic_Kowako),
    SPECIES_SPRITE(UMBRAT, gMonBackPic_Umbrat),
    SPECIES_SPRITE(CHIROBERRA, gMonBackPic_Chiroberra),
    SPECIES_SPRITE(WEROBERRA, gMonBackPic_Weroberra),
    SPECIES_SPRITE(SACKYTWACK, gMonBackPic_Sackytwack),
    SPECIES_SPRITE(STRAWNGMAN, gMonBackPic_Strawngman),
    SPECIES_SPRITE(LAWPARD, gMonBackPic_Lawpard),
    SPECIES_SPRITE(OOHBAABA, gMonBackPic_Oohbaaba),
    SPECIES_SPRITE(GOLDEROCK, gMonBackPic_Golderock),
    SPECIES_SPRITE(MAYNIMO, gMonBackPic_Maynimo),
    SPECIES_SPRITE(BUTTERWEE, gMonBackPic_Butterwee),
    SPECIES_SPRITE(PETRIPA, gMonBackPic_Petripa),
    SPECIES_SPRITE(CATTOWYRM, gMonBackPic_Cattowyrm),
    SPECIES_SPRITE(BRAMBOOZLE, gMonBackPic_Bramboozle),
    SPECIES_SPRITE(HOAXPOCUS, gMonBackPic_Hoaxpocus),
    SPECIES_SPRITE(PITAGON, gMonBackPic_Pitagon),
    SPECIES_SPRITE(PUTREGON, gMonBackPic_Putregon),
    SPECIES_SPRITE(GOLTIGATOR, gMonBackPic_Goltigator),
    SPECIES_SPRITE(KAPRIKOLA, gMonBackPic_Kaprikola),
    SPECIES_SPRITE(BLOTTA, gMonBackPic_Blotta),
    SPECIES_SPRITE(SCHACHTTA, gMonBackPic_Schachtta),
    SPECIES_SPRITE(SYLVREIGN, gMonBackPic_Sylvreign),
    SPECIES_SPRITE(CATTUCLID, gMonBackPic_Cattuclid),
    SPECIES_SPRITE(FRACTOFLY, gMonBackPic_Fractofly),
    SPECIES_SPRITE(GRAVELITO, gMonBackPic_Gravelito),
    SPECIES_SPRITE(MEGALITO, gMonBackPic_Megalito),
    SPECIES_SPRITE(COMBUN, gMonBackPic_Combun),
    SPECIES_SPRITE(HAIBUN, gMonBackPic_Haibun),
    SPECIES_SPRITE(BURBUN, gMonBackPic_Burbun),
    SPECIES_SPRITE(INGBUN, gMonBackPic_Ingbun),
    SPECIES_SPRITE(CHAFFAW, gMonBackPic_Chaffaw),
    SPECIES_SPRITE(FERROR, gMonBackPic_Ferror),
    SPECIES_SPRITE(COBBTLE, gMonBackPic_Cobbtle),
    SPECIES_SPRITE(MONTORT, gMonBackPic_Montort),
    SPECIES_SPRITE(BOLTEROCK, gMonBackPic_Bolterock),
    SPECIES_SPRITE(VOREON, gMonBackPic_Voreon),
    SPECIES_SPRITE(CORISP, gMonBackPic_Corisp),
    SPECIES_SPRITE(KROLPYRE, gMonBackPic_Krolpyre),
    SPECIES_SPRITE(TOXITIDE, gMonBackPic_Toxitide),
    SPECIES_SPRITE(TOXITURF, gMonBackPic_Toxiturf),
    SPECIES_SPRITE(PEBBLER, gMonBackPic_Pebbler),
    SPECIES_SPRITE(DUNEWICH, gMonBackPic_Dunewich),
    SPECIES_SPRITE(MAJADIJUNN, gMonBackPic_Majadijunn),
    SPECIES_SPRITE(CAPYBARA, gMonBackPic_Capybara),
    SPECIES_SPRITE(ABARBINASH, gMonBackPic_Abarbinash),
    SPECIES_SPRITE(JARAMERA, gMonBackPic_Jaramera),
    SPECIES_SPRITE(BLINGUIN, gMonBackPic_Blinguin),
    SPECIES_SPRITE(BIYAKO, gMonBackPic_Biyako),
    SPECIES_SPRITE(BEHEKO, gMonBackPic_Beheko),
    SPECIES_SPRITE(HEMOKO, gMonBackPic_Hemoko),
    SPECIES_SPRITE(LEPUCYTE, gMonBackPic_Lepucyte),
    SPECIES_SPRITE(LEUKUNEHO, gMonBackPic_Leukuneho),
    SPECIES_SPRITE(WELPROOT, gMonBackPic_Welproot),
    SPECIES_SPRITE(DRAEKAROT, gMonBackPic_Draekarot),
    SPECIES_SPRITE(KARODORAUG, gMonBackPic_Karodoraug),
    SPECIES_SPRITE(COFORCHEE, gMonBackPic_Coforchee),
    SPECIES_SPRITE(MUSTYBANE, gMonBackPic_Mustybane),
    SPECIES_SPRITE(WANNEGG, gMonBackPic_Wannegg),
    SPECIES_SPRITE(EGGNEGGMA, gMonBackPic_Eggneggma),
    SPECIES_SPRITE(LEVLADE, gMonBackPic_Levlade),
    SPECIES_SPRITE(SHOCKORE, gMonBackPic_Shockore),
    SPECIES_SPRITE(PLASMANTIS, gMonBackPic_Plasmantis),
    SPECIES_SPRITE(HARACE, gMonBackPic_Harace),
    SPECIES_SPRITE(TORSTEVIC, gMonBackPic_Torstevic),
    SPECIES_SPRITE(CHIKA, gMonBackPic_Chika),
    SPECIES_SPRITE(SWORDUC, gMonBackPic_Sworduc),
    SPECIES_SPRITE(GOSMARK, gMonBackPic_Gosmark),
    SPECIES_SPRITE(CORDELICT, gMonBackPic_Cordelict),
    SPECIES_SPRITE(MERALCORE, gMonBackPic_Meralcore),
    SPECIES_SPRITE(RAITAIC, gMonBackPic_Raitaic),
    SPECIES_SPRITE(NIMBOZOA, gMonBackPic_Nimbozoa),
    SPECIES_SPRITE(MINOTE, gMonBackPic_Minote),
    SPECIES_SPRITE(TUNAP, gMonBackPic_Tunap),
    SPECIES_SPRITE(BASSHARK, gMonBackPic_Basshark),
    SPECIES_SPRITE(SHARGUY, gMonBackPic_Sharguy),
    SPECIES_SPRITE(SHARPREY, gMonBackPic_Sharprey),
    SPECIES_SPRITE(CHUNGRIM, gMonBackPic_Chungrim),
    SPECIES_SPRITE(SQUEESHY, gMonBackPic_Squeeshy),
    SPECIES_SPRITE(SQUISHIME, gMonBackPic_Squishime),
    SPECIES_SPRITE(OCTOHIME, gMonBackPic_Octohime),
    SPECIES_SPRITE(COLFIN, gMonBackPic_Colfin),
    SPECIES_SPRITE(MYSTICIAN, gMonBackPic_Mystician),
    SPECIES_SPRITE(WALRUST, gMonBackPic_Walrust),
    SPECIES_SPRITE(SCALLYWARG, gMonBackPic_Scallywarg),
    SPECIES_SPRITE(WAARGH, gMonBackPic_Waargh),
    SPECIES_SPRITE(SKELLYWARG, gMonBackPic_Skellywarg),
    SPECIES_SPRITE(CASOWARY, gMonBackPic_Casowary),
    SPECIES_SPRITE(PASSAWARY, gMonBackPic_Passawary),
    SPECIES_SPRITE(BOOZARD, gMonBackPic_Boozard),
    SPECIES_SPRITE(COCKABOO, gMonBackPic_Cockaboo),
    SPECIES_SPRITE(AXELFIN, gMonBackPic_Axelfin),
    SPECIES_SPRITE(MORAGAN, gMonBackPic_Moragan),
    SPECIES_SPRITE(SHIVERSNAP, gMonBackPic_Shiversnap),
    SPECIES_SPRITE(EXCATATOR, gMonBackPic_Excatator),
    SPECIES_SPRITE(MARSOYART, gMonBackPic_Marsoyart),
    SPECIES_SPRITE(CINDRILLON, gMonBackPic_Cindrillon),
    SPECIES_SPRITE(ARMAGATTON, gMonBackPic_Armagatton),
    SPECIES_SPRITE(FAKYSNAKY, gMonBackPic_Fakysnaky),
    SPECIES_SPRITE(PANTNEY, gMonBackPic_Pantney),
    SPECIES_SPRITE(NYARLY, gMonBackPic_Nyarly),
    SPECIES_SPRITE(SUDCUB, gMonBackPic_Sudcub),
    SPECIES_SPRITE(TARDRITCH, gMonBackPic_Tardritch),
    SPECIES_SPRITE(BLABBU, gMonBackPic_Blabbu),
    SPECIES_SPRITE(TURRYTURRY, gMonBackPic_Turryturry),
    SPECIES_SPRITE(FAERED, gMonBackPic_Faered),
    SPECIES_SPRITE(PROMISCBUS, gMonBackPic_Promiscbus),
    SPECIES_SPRITE(GUMBORREE, gMonBackPic_Gumborree),
    SPECIES_SPRITE(KOREMAI, gMonBackPic_Koremai),
    SPECIES_SPRITE(KORESATO, gMonBackPic_Koresato),
    SPECIES_SPRITE(DRAKULARK, gMonBackPic_Drakulark),
    SPECIES_SPRITE(NOSFERAPTR, gMonBackPic_Nosferaptr),
    SPECIES_SPRITE(OLFLOOKIE, gMonBackPic_OlFlookie),
    SPECIES_SPRITE(JUSTRICHA, gMonBackPic_Justricha),
    SPECIES_SPRITE(AJOKUJOKU, gMonBackPic_Ajokujoku),
    SPECIES_SPRITE(GARJIRA, gMonBackPic_Garjira),
    SPECIES_SPRITE(GARZILLA, gMonBackPic_Garzilla),
    SPECIES_SPRITE(YANDEMIC, gMonBackPic_Yandemic),
    SPECIES_SPRITE(LUNASTER, gMonBackPic_Lunaster),
    SPECIES_SPRITE(JACKABOX, gMonBackPic_Jackabox),
    SPECIES_SPRITE(FOOLTAGE, gMonBackPic_Fooltage),
    SPECIES_SPRITE(AETHEREAL, gMonBackPic_Aethereal),
    SPECIES_SPRITE(MOTHRAMITY, gMonBackPic_Mothramity),
    SPECIES_SPRITE(GLAREYALE, gMonBackPic_Glareyale),
    SPECIES_SPRITE(LEVIALAGO, gMonBackPic_Levialago),
    SPECIES_SPRITE(RETROROACH, gMonBackPic_Retroroach),
    SPECIES_SPRITE(NEOROACH, gMonBackPic_Neoroach),
    SPECIES_SPRITE(SPITFAX, gMonBackPic_Spitfax),
    SPECIES_SPRITE(RAPSCALEON, gMonBackPic_Rapscaleon),
    SPECIES_SPRITE(AGOMAGO, gMonBackPic_Agomago),
    SPECIES_SPRITE(MORFTREE, gMonBackPic_Morftree),
    SPECIES_SPRITE(EPOCHOTL, gMonBackPic_Epochotl),
    SPECIES_SPRITE(VIVISU, gMonBackPic_Vivisu),
    SPECIES_SPRITE(SOLASU, gMonBackPic_Solasu),
    SPECIES_SPRITE(SUMMERASU, gMonBackPic_Summerasu),
    SPECIES_SPRITE(OROFLOW, gMonBackPic_Oroflow),
    SPECIES_SPRITE(ORROCAST, gMonBackPic_Orrocast),
    ...
    SPECIES_SPRITE(BISHOUCHA, gMonBackPic_Bishoucha),
    ...
    SPECIES_SPRITE(SHUNYONG, gMonBackPic_Shunyong),
    SPECIES_SPRITE(SHUNYONG_GOLDEN_OFFENSE, gMonBackPic_ShunyongGoldenOffense),
    SPECIES_SPRITE(KINGAMBIT, gMonBackPic_Kingambit),
    SPECIES_SPRITE(SHELLYLOUH, gMonBackPic_Shellylouh),
    SPECIES_SPRITE(INFAIRNO, gMonBackPic_Infairno),
    SPECIES_SPRITE(PURGATIVAL, gMonBackPic_Purgatival),
    SPECIES_SPRITE(DETERIOTL, gMonBackPic_Deteriotl),
    SPECIES_SPRITE(DAKKAPOD, gMonBackPic_Dakkapod),
    ...
    SPECIES_SPRITE(SHISHIMA_ALT, gMonBackPic_Shishima),
