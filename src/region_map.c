...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(LITTLEROOT_NEW), MAP_NUM(LITTLEROOT_NEW), HEAL_LOCATION_LITTLEROOT_NEW},
    [MAPSEC_OLDALE_TOWN] = {MAP_GROUP(OLDALE_NEW), MAP_NUM(OLDALE_NEW), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_DEWFORD_TOWN] = {MAP_GROUP(DEWFORD_NEW), MAP_NUM(DEWFORD_NEW), HEAL_LOCATION_DEWFORD_NEW},
    [MAPSEC_LAVARIDGE_TOWN] = {MAP_GROUP(LAVARIDGE_TOWN), MAP_NUM(LAVARIDGE_TOWN), HEAL_LOCATION_LAVARIDGE_TOWN},
    [MAPSEC_FALLARBOR_TOWN] = {MAP_GROUP(FALLARBOR_NEW), MAP_NUM(FALLARBOR_NEW), HEAL_LOCATION_FALLARBOR_TOWN},
    [MAPSEC_VERDANTURF_TOWN] = {MAP_GROUP(VERDANTURF_NEW), MAP_NUM(VERDANTURF_NEW), HEAL_LOCATION_VERDANTURF_NEW},
    [MAPSEC_PACIFIDLOG_TOWN] = {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), HEAL_LOCATION_PACIFIDLOG_TOWN},
    [MAPSEC_PETALBURG_CITY] = {MAP_GROUP(PETALBURG_NEW), MAP_NUM(PETALBURG_NEW), HEAL_LOCATION_PETALBURG_NEW},
    [MAPSEC_SLATEPORT_CITY] = {MAP_GROUP(SEA_MAUVILLE), MAP_NUM(SEA_MAUVILLE), HEAL_LOCATION_SEA_MAUVILLE},
    [MAPSEC_MAUVILLE_CITY] = {MAP_GROUP(MAUVILLE_NEW), MAP_NUM(MAUVILLE_NEW), HEAL_LOCATION_MAUVILLE_NEW},
    [MAPSEC_RUSTBORO_CITY] = {MAP_GROUP(RUSTBORO_NEW), MAP_NUM(RUSTBORO_NEW), HEAL_LOCATION_RUSTBORO_NEW},
    ...
    [MAPSEC_SOOTOPOLIS_CITY] = {MAP_GROUP(NEW_SOOTO), MAP_NUM(NEW_SOOTO), HEAL_LOCATION_NEW_SOOTO},
    ...
    [MAPSEC_ROUTE_109] = {MAP_GROUP(OZONE_INSTITUTE), MAP_NUM(OZONE_INSTITUTE), HEAL_LOCATION_OZONE_INSTITUTE},
    [MAPSEC_ROUTE_110] = {MAP_GROUP(ROUTE122), MAP_NUM(ROUTE122), HEAL_LOCATION_ZOTPYRE_VILLAGE},
    ...
    [MAPSEC_ROUTE_122] = {MAP_GROUP(ROUTE122), MAP_NUM(ROUTE122), HEAL_LOCATION_ZOTPYRE_VILLAGE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_ROUTE_110:
        return FlagGet(FLAG_VISITED_ZOTPYRE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROUTE_109:
        return FlagGet(FLAG_VISITED_OZONE_INSTITUTE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
