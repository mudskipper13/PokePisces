...
{
    SPECIES_TO_HOENN(TIDPIT),
    SPECIES_TO_HOENN(SLIDLOW),
    SPECIES_TO_HOENN(CARDIOVOR),
    SPECIES_TO_HOENN(FIEFREET),
    SPECIES_TO_HOENN(BALBYRN),
    SPECIES_TO_HOENN(BLAZIZAHAK),
    ...
    SPECIES_TO_HOENN(QUILWARD),
    SPECIES_TO_HOENN(BONFEU),
    SPECIES_TO_HOENN(INFRAREC),
    SPECIES_TO_HOENN(BERM),
    SPECIES_TO_HOENN(MOODA),
    SPECIES_TO_HOENN(BERMUDON),
    SPECIES_TO_HOENN(ICKSQUEEK),
    SPECIES_TO_HOENN(KOMORODE),
    SPECIES_TO_HOENN(EBIBI),
    SPECIES_TO_HOENN(MAKIBI),
    SPECIES_TO_HOENN(EBIROSASHI),
    SPECIES_TO_HOENN(KITIKITI),
    SPECIES_TO_HOENN(MOSKOPO),
    SPECIES_TO_HOENN(ABSOLARIA),
    ...
    SPECIES_TO_HOENN(SNOTLOUD),
    SPECIES_TO_HOENN(SICKBEAT),
    SPECIES_TO_HOENN(SPRYTE),
    SPECIES_TO_HOENN(GUMONA),
    SPECIES_TO_HOENN(NANGGAL),
    SPECIES_TO_HOENN(SHEEDRAKE),
    SPECIES_TO_HOENN(TRANSERA),
    SPECIES_TO_HOENN(BIVAGUE),
    SPECIES_TO_HOENN(LUSCKAW),
    SPECIES_TO_HOENN(SADSOD),
    SPECIES_TO_HOENN(MAERACHOLY),
    SPECIES_TO_HOENN(LUMELMO),
    SPECIES_TO_HOENN(LUMENDELA),
    SPECIES_TO_HOENN(STOMAWAY),
    SPECIES_TO_HOENN(CRAWLAXY),
    SPECIES_TO_HOENN(MAGNALURE),
    SPECIES_TO_HOENN(MAGNANICOR),
    SPECIES_TO_HOENN(CRYPLIN),
    SPECIES_TO_HOENN(UHEFOE),
    SPECIES_TO_HOENN(MYSTOMANIA),
    SPECIES_TO_HOENN(LYORESA),
    ...
    SPECIES_TO_HOENN(POMELONIAN),
    SPECIES_TO_HOENN(GOURDOUG),
    SPECIES_TO_HOENN(SNORUNT),
    SPECIES_TO_HOENN(GLALIE),
    SPECIES_TO_HOENN(FROSLASS),
    SPECIES_TO_HOENN(FOGGLEHIND),
    SPECIES_TO_HOENN(MATCHLIT),
    SPECIES_TO_HOENN(YAGANGRAN),
    SPECIES_TO_HOENN(PIDIUM),
    SPECIES_TO_HOENN(MEDGEON),
    SPECIES_TO_HOENN(MAGGORDE),
    SPECIES_TO_HOENN(FLAGUE),
    SPECIES_TO_HOENN(CULTIPEX),
    SPECIES_TO_HOENN(EERIKO),
    SPECIES_TO_HOENN(MANNIKO),
    SPECIES_TO_HOENN(KOWAKO),
    SPECIES_TO_HOENN(UMBRAT),
    SPECIES_TO_HOENN(CHIROBERRA),
    SPECIES_TO_HOENN(WEROBERRA),
    SPECIES_TO_HOENN(SACKYTWACK),
    SPECIES_TO_HOENN(STRAWNGMAN),
    SPECIES_TO_HOENN(LAWPARD),
    SPECIES_TO_HOENN(OOHBAABA),
    SPECIES_TO_HOENN(GOLDEROCK),
    SPECIES_TO_HOENN(MAYNIMO),
    SPECIES_TO_HOENN(BUTTERWEE),
    SPECIES_TO_HOENN(PETRIPA),
    SPECIES_TO_HOENN(CATTOWYRM),
    SPECIES_TO_HOENN(BRAMBOOZLE),
    SPECIES_TO_HOENN(HOAXPOCUS),
    SPECIES_TO_HOENN(PITAGON),
    SPECIES_TO_HOENN(PUTREGON),
    SPECIES_TO_HOENN(GOLTIGATOR),
    SPECIES_TO_HOENN(KAPRIKOLA),
    SPECIES_TO_HOENN(BLOTTA),
    SPECIES_TO_HOENN(SCHACHTTA),
    SPECIES_TO_HOENN(SYLVREIGN),
    SPECIES_TO_HOENN(CATTUCLID),
    SPECIES_TO_HOENN(FRACTOFLY),
    SPECIES_TO_HOENN(GRAVELITO),
    SPECIES_TO_HOENN(MEGALITO),
    SPECIES_TO_HOENN(COMBUN),
    SPECIES_TO_HOENN(HAIBUN),
    SPECIES_TO_HOENN(BURBUN),
    SPECIES_TO_HOENN(INGBUN),
    SPECIES_TO_HOENN(CHAFFAW),
    SPECIES_TO_HOENN(FERROR),
    SPECIES_TO_HOENN(COBBTLE),
    SPECIES_TO_HOENN(MONTORT),
    SPECIES_TO_HOENN(BOLTEROCK),
    SPECIES_TO_HOENN(VOREON),
    SPECIES_TO_HOENN(CORISP),
    SPECIES_TO_HOENN(KROLPYRE),
    SPECIES_TO_HOENN(TOXITIDE),
    SPECIES_TO_HOENN(TOXITURF),
    SPECIES_TO_HOENN(PEBBLER),
    SPECIES_TO_HOENN(DUNEWICH),
    SPECIES_TO_HOENN(MAJADIJUNN),
    SPECIES_TO_HOENN(CAPYBARA),
    SPECIES_TO_HOENN(ABARBINASH),
    SPECIES_TO_HOENN(JARAMERA),
    SPECIES_TO_HOENN(BLINGUIN),
    SPECIES_TO_HOENN(BIYAKO),
    SPECIES_TO_HOENN(BEHEKO),
    SPECIES_TO_HOENN(HEMOKO),
    SPECIES_TO_HOENN(LEPUCYTE),
    SPECIES_TO_HOENN(LEUKUNEHO),
    SPECIES_TO_HOENN(WELPROOT),
    SPECIES_TO_HOENN(DRAEKAROT),
    SPECIES_TO_HOENN(KARODORAUG),
    SPECIES_TO_HOENN(COFORCHEE),
    SPECIES_TO_HOENN(MUSTYBANE),
    SPECIES_TO_HOENN(WANNEGG),
    SPECIES_TO_HOENN(EGGNEGGMA),
    SPECIES_TO_HOENN(LEVLADE),
    SPECIES_TO_HOENN(SHOCKORE),
    SPECIES_TO_HOENN(PLASMANTIS),
    SPECIES_TO_HOENN(HARACE),
    SPECIES_TO_HOENN(TORSTEVIC),
    SPECIES_TO_HOENN(CHIKA),
    SPECIES_TO_HOENN(SWORDUC),
    SPECIES_TO_HOENN(GOSMARK),
    SPECIES_TO_HOENN(CORDELICT),
    SPECIES_TO_HOENN(MERALCORE),
    SPECIES_TO_HOENN(RAITAIC),
    SPECIES_TO_HOENN(NIMBOZOA),
    SPECIES_TO_HOENN(MINOTE),
    SPECIES_TO_HOENN(TUNAP),
    SPECIES_TO_HOENN(BASSHARK),
    SPECIES_TO_HOENN(SHARGUY),
    SPECIES_TO_HOENN(SHARPREY),
    SPECIES_TO_HOENN(CHUNGRIM),
    SPECIES_TO_HOENN(SQUEESHY),
    SPECIES_TO_HOENN(SQUISHIME),
    SPECIES_TO_HOENN(OCTOHIME),
    SPECIES_TO_HOENN(COLFIN),
    SPECIES_TO_HOENN(MYSTICIAN),
    SPECIES_TO_HOENN(WALRUST),
    SPECIES_TO_HOENN(SCALLYWARG),
    SPECIES_TO_HOENN(WAARGH),
    SPECIES_TO_HOENN(SKELLYWARG),
    SPECIES_TO_HOENN(CASOWARY),
    SPECIES_TO_HOENN(PASSAWARY),
    SPECIES_TO_HOENN(BOOZARD),
    SPECIES_TO_HOENN(COCKABOO),
    SPECIES_TO_HOENN(AXELFIN),
    SPECIES_TO_HOENN(MORAGAN),
    SPECIES_TO_HOENN(SHIVERSNAP),
    SPECIES_TO_HOENN(EXCATATOR),
    SPECIES_TO_HOENN(MARSOYART),
    SPECIES_TO_HOENN(CINDRILLON),
    SPECIES_TO_HOENN(ARMAGATTON),
    SPECIES_TO_HOENN(FAKYSNAKY),
    SPECIES_TO_HOENN(PANTNEY),
    SPECIES_TO_HOENN(NYARLY),
    SPECIES_TO_HOENN(SUDCUB),
    SPECIES_TO_HOENN(TARDRITCH),
    SPECIES_TO_HOENN(BLABBU),
    SPECIES_TO_HOENN(TURRYTURRY),
    SPECIES_TO_HOENN(FAERED),
    SPECIES_TO_HOENN(PROMISCBUS),
    SPECIES_TO_HOENN(GUMBORREE),
    SPECIES_TO_HOENN(KOREMAI),
    SPECIES_TO_HOENN(KORESATO),
    SPECIES_TO_HOENN(DRAKULARK),
    SPECIES_TO_HOENN(NOSFERAPTR),
    SPECIES_TO_HOENN(OLFLOOKIE),
    SPECIES_TO_HOENN(JUSTRICHA),
    SPECIES_TO_HOENN(AJOKUJOKU),
    SPECIES_TO_HOENN(GARJIRA),
    SPECIES_TO_HOENN(GARZILLA),
    SPECIES_TO_HOENN(YANDEMIC),
    SPECIES_TO_HOENN(LUNASTER),
    SPECIES_TO_HOENN(JACKABOX),
    SPECIES_TO_HOENN(FOOLTAGE),
    SPECIES_TO_HOENN(AETHEREAL),
    SPECIES_TO_HOENN(MOTHRAMITY),
    SPECIES_TO_HOENN(GLAREYALE),
    SPECIES_TO_HOENN(LEVIALAGO),
    SPECIES_TO_HOENN(RETROROACH),
    SPECIES_TO_HOENN(NEOROACH),
    SPECIES_TO_HOENN(SPITFAX),
    SPECIES_TO_HOENN(RAPSCALEON),
    SPECIES_TO_HOENN(AGOMAGO),
    SPECIES_TO_HOENN(MORFTREE),
    SPECIES_TO_HOENN(EPOCHOTL),
    SPECIES_TO_HOENN(VIVISU),
    SPECIES_TO_HOENN(SOLASU),
    SPECIES_TO_HOENN(SUMMERASU),
    SPECIES_TO_HOENN(OROFLOW),
    SPECIES_TO_HOENN(ORROCAST),
    SPECIES_TO_HOENN(ORROWHELM),
    SPECIES_TO_HOENN(SHAYON),
    SPECIES_TO_HOENN(LUOSHAN),
    ...
    [SPECIES_SPINDA_PLAINS - 1] = HOENN_DEX_SPINDA,
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(TIDPIT),
    SPECIES_TO_NATIONAL(SLIDLOW),
    SPECIES_TO_NATIONAL(CARDIOVOR),
    SPECIES_TO_NATIONAL(FIEFREET),
    SPECIES_TO_NATIONAL(BALBYRN),
    SPECIES_TO_NATIONAL(BLAZIZAHAK),
    ...
    SPECIES_TO_NATIONAL(QUILWARD),
    SPECIES_TO_NATIONAL(BONFEU),
    SPECIES_TO_NATIONAL(INFRAREC),
    SPECIES_TO_NATIONAL(BERM),
    SPECIES_TO_NATIONAL(MOODA),
    SPECIES_TO_NATIONAL(BERMUDON),
    SPECIES_TO_NATIONAL(ICKSQUEEK),
    SPECIES_TO_NATIONAL(KOMORODE),
    SPECIES_TO_NATIONAL(ANNIHILAPE),
    SPECIES_TO_NATIONAL(EBIBI),
    SPECIES_TO_NATIONAL(MAKIBI),
    SPECIES_TO_NATIONAL(EBIROSASHI),
    SPECIES_TO_NATIONAL(KITIKITI),
    SPECIES_TO_NATIONAL(MOSKOPO),
    SPECIES_TO_NATIONAL(ABSOLARIA),
    ...
    SPECIES_TO_NATIONAL(SNOTLOUD),
    SPECIES_TO_NATIONAL(SICKBEAT),
    SPECIES_TO_NATIONAL(SPRYTE),
    SPECIES_TO_NATIONAL(GUMONA),
    SPECIES_TO_NATIONAL(NANGGAL),
    SPECIES_TO_NATIONAL(SHEEDRAKE),
    SPECIES_TO_NATIONAL(TRANSERA),
    SPECIES_TO_NATIONAL(BIVAGUE),
    SPECIES_TO_NATIONAL(LUSCKAW),
    SPECIES_TO_NATIONAL(SADSOD),
    SPECIES_TO_NATIONAL(MAERACHOLY),
    SPECIES_TO_NATIONAL(LUMELMO),
    SPECIES_TO_NATIONAL(LUMENDELA),
    SPECIES_TO_NATIONAL(STOMAWAY),
    SPECIES_TO_NATIONAL(CRAWLAXY),
    SPECIES_TO_NATIONAL(MAGNALURE),
    SPECIES_TO_NATIONAL(MAGNANICOR),
    SPECIES_TO_NATIONAL(CRYPLIN),
    SPECIES_TO_NATIONAL(UHEFOE),
    SPECIES_TO_NATIONAL(MYSTOMANIA),
    SPECIES_TO_NATIONAL(LYORESA),
    SPECIES_TO_NATIONAL(KODOUGH),
    SPECIES_TO_NATIONAL(SLICKSLICE),
    SPECIES_TO_NATIONAL(LOAFOOF),
    SPECIES_TO_NATIONAL(SPIRITOAST),
    SPECIES_TO_NATIONAL(DUDUNSPARS),
    SPECIES_TO_NATIONAL(POMELONIAN),
    SPECIES_TO_NATIONAL(GOURDOUG),
    SPECIES_TO_NATIONAL(FOGGLEHIND),
    SPECIES_TO_NATIONAL(MATCHLIT),
    SPECIES_TO_NATIONAL(YAGANGRAN),
    SPECIES_TO_NATIONAL(PIDIUM),
    SPECIES_TO_NATIONAL(MEDGEON),
    SPECIES_TO_NATIONAL(MAGGORDE),
    SPECIES_TO_NATIONAL(FLAGUE),
    SPECIES_TO_NATIONAL(CULTIPEX),
    SPECIES_TO_NATIONAL(EERIKO),
    SPECIES_TO_NATIONAL(MANNIKO),
    SPECIES_TO_NATIONAL(KOWAKO),
    SPECIES_TO_NATIONAL(UMBRAT),
    SPECIES_TO_NATIONAL(CHIROBERRA),
    SPECIES_TO_NATIONAL(WEROBERRA),
    SPECIES_TO_NATIONAL(SACKYTWACK),
    SPECIES_TO_NATIONAL(STRAWNGMAN),
    SPECIES_TO_NATIONAL(LAWPARD),
    SPECIES_TO_NATIONAL(OOHBAABA),
    SPECIES_TO_NATIONAL(GOLDEROCK),
    SPECIES_TO_NATIONAL(MAYNIMO),
    SPECIES_TO_NATIONAL(BUTTERWEE),
    SPECIES_TO_NATIONAL(PETRIPA),
    SPECIES_TO_NATIONAL(CATTOWYRM),
    SPECIES_TO_NATIONAL(BRAMBOOZLE),
    SPECIES_TO_NATIONAL(HOAXPOCUS),
    SPECIES_TO_NATIONAL(PITAGON),
    SPECIES_TO_NATIONAL(PUTREGON),
    SPECIES_TO_NATIONAL(GOLTIGATOR),
    SPECIES_TO_NATIONAL(KAPRIKOLA),
    SPECIES_TO_NATIONAL(BLOTTA),
    SPECIES_TO_NATIONAL(SCHACHTTA),
    SPECIES_TO_NATIONAL(SYLVREIGN),
    SPECIES_TO_NATIONAL(CATTUCLID),
    SPECIES_TO_NATIONAL(FRACTOFLY),
    SPECIES_TO_NATIONAL(GRAVELITO),
    SPECIES_TO_NATIONAL(MEGALITO),
    SPECIES_TO_NATIONAL(COMBUN),
    SPECIES_TO_NATIONAL(HAIBUN),
    SPECIES_TO_NATIONAL(BURBUN),
    SPECIES_TO_NATIONAL(INGBUN),
    SPECIES_TO_NATIONAL(CHAFFAW),
    SPECIES_TO_NATIONAL(FERROR),
    SPECIES_TO_NATIONAL(COBBTLE),
    SPECIES_TO_NATIONAL(MONTORT),
    SPECIES_TO_NATIONAL(BOLTEROCK),
    SPECIES_TO_NATIONAL(VOREON),
    SPECIES_TO_NATIONAL(CORISP),
    SPECIES_TO_NATIONAL(KROLPYRE),
    SPECIES_TO_NATIONAL(TOXITIDE),
    SPECIES_TO_NATIONAL(TOXITURF),
    SPECIES_TO_NATIONAL(PEBBLER),
    SPECIES_TO_NATIONAL(DUNEWICH),
    SPECIES_TO_NATIONAL(MAJADIJUNN),
    SPECIES_TO_NATIONAL(CAPYBARA),
    SPECIES_TO_NATIONAL(ABARBINASH),
    SPECIES_TO_NATIONAL(JARAMERA),
    SPECIES_TO_NATIONAL(BLINGUIN),
    SPECIES_TO_NATIONAL(BIYAKO),
    SPECIES_TO_NATIONAL(BEHEKO),
    SPECIES_TO_NATIONAL(HEMOKO),
    SPECIES_TO_NATIONAL(LEPUCYTE),
    SPECIES_TO_NATIONAL(LEUKUNEHO),
    SPECIES_TO_NATIONAL(WELPROOT),
    SPECIES_TO_NATIONAL(DRAEKAROT),
    SPECIES_TO_NATIONAL(KARODORAUG),
    SPECIES_TO_NATIONAL(COFORCHEE),
    SPECIES_TO_NATIONAL(MUSTYBANE),
    SPECIES_TO_NATIONAL(WANNEGG),
    SPECIES_TO_NATIONAL(EGGNEGGMA),
    SPECIES_TO_NATIONAL(LEVLADE),
    SPECIES_TO_NATIONAL(SHOCKORE),
    SPECIES_TO_NATIONAL(PLASMANTIS),
    SPECIES_TO_NATIONAL(HARACE),
    SPECIES_TO_NATIONAL(TORSTEVIC),
    SPECIES_TO_NATIONAL(CHIKA),
    SPECIES_TO_NATIONAL(SWORDUC),
    SPECIES_TO_NATIONAL(GOSMARK),
    SPECIES_TO_NATIONAL(CORDELICT),
    SPECIES_TO_NATIONAL(MERALCORE),
    SPECIES_TO_NATIONAL(RAITAIC),
    SPECIES_TO_NATIONAL(NIMBOZOA),
    SPECIES_TO_NATIONAL(MINOTE),
    SPECIES_TO_NATIONAL(TUNAP),
    SPECIES_TO_NATIONAL(BASSHARK),
    SPECIES_TO_NATIONAL(SHARGUY),
    SPECIES_TO_NATIONAL(SHARPREY),
    SPECIES_TO_NATIONAL(CHUNGRIM),
    SPECIES_TO_NATIONAL(SQUEESHY),
    SPECIES_TO_NATIONAL(SQUISHIME),
    SPECIES_TO_NATIONAL(OCTOHIME),
    SPECIES_TO_NATIONAL(COLFIN),
    SPECIES_TO_NATIONAL(MYSTICIAN),
    SPECIES_TO_NATIONAL(WALRUST),
    SPECIES_TO_NATIONAL(SCALLYWARG),
    SPECIES_TO_NATIONAL(WAARGH),
    SPECIES_TO_NATIONAL(SKELLYWARG),
    SPECIES_TO_NATIONAL(CASOWARY),
    SPECIES_TO_NATIONAL(PASSAWARY),
    SPECIES_TO_NATIONAL(BOOZARD),
    SPECIES_TO_NATIONAL(COCKABOO),
    SPECIES_TO_NATIONAL(AXELFIN),
    SPECIES_TO_NATIONAL(MORAGAN),
    SPECIES_TO_NATIONAL(SHIVERSNAP),
    SPECIES_TO_NATIONAL(EXCATATOR),
    SPECIES_TO_NATIONAL(MARSOYART),
    SPECIES_TO_NATIONAL(CINDRILLON),
    SPECIES_TO_NATIONAL(ARMAGATTON),
    SPECIES_TO_NATIONAL(FAKYSNAKY),
    SPECIES_TO_NATIONAL(PANTNEY),
    SPECIES_TO_NATIONAL(NYARLY),
    SPECIES_TO_NATIONAL(SUDCUB),
    SPECIES_TO_NATIONAL(TARDRITCH),
    SPECIES_TO_NATIONAL(BLABBU),
    SPECIES_TO_NATIONAL(TURRYTURRY),
    SPECIES_TO_NATIONAL(FAERED),
    SPECIES_TO_NATIONAL(PROMISCBUS),
    SPECIES_TO_NATIONAL(GUMBORREE),
    SPECIES_TO_NATIONAL(KOREMAI),
    SPECIES_TO_NATIONAL(KORESATO),
    SPECIES_TO_NATIONAL(DRAKULARK),
    SPECIES_TO_NATIONAL(NOSFERAPTR),
    SPECIES_TO_NATIONAL(OLFLOOKIE),
    SPECIES_TO_NATIONAL(JUSTRICHA),
    SPECIES_TO_NATIONAL(AJOKUJOKU),
    SPECIES_TO_NATIONAL(GARJIRA),
    SPECIES_TO_NATIONAL(GARZILLA),
    SPECIES_TO_NATIONAL(YANDEMIC),
    SPECIES_TO_NATIONAL(LUNASTER),
    SPECIES_TO_NATIONAL(JACKABOX),
    SPECIES_TO_NATIONAL(FOOLTAGE),
    SPECIES_TO_NATIONAL(AETHEREAL),
    SPECIES_TO_NATIONAL(MOTHRAMITY),
    SPECIES_TO_NATIONAL(GLAREYALE),
    SPECIES_TO_NATIONAL(LEVIALAGO),
    SPECIES_TO_NATIONAL(RETROROACH),
    SPECIES_TO_NATIONAL(NEOROACH),
    SPECIES_TO_NATIONAL(SPITFAX),
    SPECIES_TO_NATIONAL(RAPSCALEON),
    SPECIES_TO_NATIONAL(AGOMAGO),
    SPECIES_TO_NATIONAL(MORFTREE),
    SPECIES_TO_NATIONAL(EPOCHOTL),
    SPECIES_TO_NATIONAL(VIVISU),
    SPECIES_TO_NATIONAL(SOLASU),
    SPECIES_TO_NATIONAL(SUMMERASU),
    SPECIES_TO_NATIONAL(OROFLOW),
    SPECIES_TO_NATIONAL(ORROCAST),
    SPECIES_TO_NATIONAL(ORROWHELM),
    SPECIES_TO_NATIONAL(SHAYON),
    SPECIES_TO_NATIONAL(LUOSHAN),
    ...
    SPECIES_TO_NATIONAL(YOLKWEEN),
    SPECIES_TO_NATIONAL(WALLY),
    SPECIES_TO_NATIONAL(POTTRICIA),
#endif
    ...
    [SPECIES_SPINDA_PLAINS - 1] = NATIONAL_DEX_SPINDA,
...
//Hisuian Forms
    ...
    [SPECIES_ZYGARDE_10_DORMANT - 1] = NATIONAL_DEX_ZYGARDE,
    [SPECIES_ZYGARDE_50_DORMANT - 1] = NATIONAL_DEX_ZYGARDE,
...
{
    HOENN_TO_NATIONAL(TIDPIT),
    HOENN_TO_NATIONAL(SLIDLOW),
    HOENN_TO_NATIONAL(CARDIOVOR),
    HOENN_TO_NATIONAL(FIEFREET),
    HOENN_TO_NATIONAL(BALBYRN),
    HOENN_TO_NATIONAL(BLAZIZAHAK),
    ...
    HOENN_TO_NATIONAL(QUILWARD),
    HOENN_TO_NATIONAL(BONFEU),
    HOENN_TO_NATIONAL(INFRAREC),
    HOENN_TO_NATIONAL(BERM),
    HOENN_TO_NATIONAL(MOODA),
    HOENN_TO_NATIONAL(BERMUDON),
    HOENN_TO_NATIONAL(ICKSQUEEK),
    HOENN_TO_NATIONAL(KOMORODE),
    HOENN_TO_NATIONAL(EBIBI),
    HOENN_TO_NATIONAL(MAKIBI),
    HOENN_TO_NATIONAL(EBIROSASHI),
    HOENN_TO_NATIONAL(KITIKITI),
    HOENN_TO_NATIONAL(MOSKOPO),
    HOENN_TO_NATIONAL(ABSOLARIA),
    ...
    HOENN_TO_NATIONAL(SNOTLOUD),
    HOENN_TO_NATIONAL(SICKBEAT),
    HOENN_TO_NATIONAL(SPRYTE),
    HOENN_TO_NATIONAL(GUMONA),
    HOENN_TO_NATIONAL(NANGGAL),
    HOENN_TO_NATIONAL(SHEEDRAKE),
    HOENN_TO_NATIONAL(TRANSERA),
    HOENN_TO_NATIONAL(BIVAGUE),
    HOENN_TO_NATIONAL(LUSCKAW),
    HOENN_TO_NATIONAL(SADSOD),
    HOENN_TO_NATIONAL(MAERACHOLY),
    HOENN_TO_NATIONAL(LUMELMO),
    HOENN_TO_NATIONAL(LUMENDELA),
    HOENN_TO_NATIONAL(STOMAWAY),
    HOENN_TO_NATIONAL(CRAWLAXY),
    HOENN_TO_NATIONAL(MAGNALURE),
    HOENN_TO_NATIONAL(MAGNANICOR),
    HOENN_TO_NATIONAL(CRYPLIN),
    HOENN_TO_NATIONAL(UHEFOE),
    HOENN_TO_NATIONAL(MYSTOMANIA),
    HOENN_TO_NATIONAL(LYORESA),
    ...
    HOENN_TO_NATIONAL(POMELONIAN),
    HOENN_TO_NATIONAL(GOURDOUG),
    HOENN_TO_NATIONAL(SNORUNT),
    HOENN_TO_NATIONAL(GLALIE),
    HOENN_TO_NATIONAL(FROSLASS),
    HOENN_TO_NATIONAL(FOGGLEHIND),
    HOENN_TO_NATIONAL(MATCHLIT),
    HOENN_TO_NATIONAL(YAGANGRAN),
    HOENN_TO_NATIONAL(PIDIUM),
    HOENN_TO_NATIONAL(MEDGEON),
    HOENN_TO_NATIONAL(MAGGORDE),
    HOENN_TO_NATIONAL(FLAGUE),
    HOENN_TO_NATIONAL(CULTIPEX),
    HOENN_TO_NATIONAL(EERIKO),
    HOENN_TO_NATIONAL(MANNIKO),
    HOENN_TO_NATIONAL(KOWAKO),
    HOENN_TO_NATIONAL(UMBRAT),
    HOENN_TO_NATIONAL(CHIROBERRA),
    HOENN_TO_NATIONAL(WEROBERRA),
    HOENN_TO_NATIONAL(SACKYTWACK),
    HOENN_TO_NATIONAL(STRAWNGMAN),
    HOENN_TO_NATIONAL(LAWPARD),
    HOENN_TO_NATIONAL(OOHBAABA),
    HOENN_TO_NATIONAL(GOLDEROCK),
    HOENN_TO_NATIONAL(MAYNIMO),
    HOENN_TO_NATIONAL(BUTTERWEE),
    HOENN_TO_NATIONAL(PETRIPA),
    HOENN_TO_NATIONAL(CATTOWYRM),
    HOENN_TO_NATIONAL(BRAMBOOZLE),
    HOENN_TO_NATIONAL(HOAXPOCUS),
    HOENN_TO_NATIONAL(PITAGON),
    HOENN_TO_NATIONAL(PUTREGON),
    HOENN_TO_NATIONAL(GOLTIGATOR),
    HOENN_TO_NATIONAL(KAPRIKOLA),
    HOENN_TO_NATIONAL(BLOTTA),
    HOENN_TO_NATIONAL(SCHACHTTA),
    HOENN_TO_NATIONAL(SYLVREIGN),
    HOENN_TO_NATIONAL(CATTUCLID),
    HOENN_TO_NATIONAL(FRACTOFLY),
    HOENN_TO_NATIONAL(GRAVELITO),
    HOENN_TO_NATIONAL(MEGALITO),
    HOENN_TO_NATIONAL(COMBUN),
    HOENN_TO_NATIONAL(HAIBUN),
    HOENN_TO_NATIONAL(BURBUN),
    HOENN_TO_NATIONAL(INGBUN),
    HOENN_TO_NATIONAL(CHAFFAW),
    HOENN_TO_NATIONAL(FERROR),
    HOENN_TO_NATIONAL(COBBTLE),
    HOENN_TO_NATIONAL(MONTORT),
    HOENN_TO_NATIONAL(BOLTEROCK),
    HOENN_TO_NATIONAL(VOREON),
    HOENN_TO_NATIONAL(CORISP),
    HOENN_TO_NATIONAL(KROLPYRE),
    HOENN_TO_NATIONAL(TOXITIDE),
    HOENN_TO_NATIONAL(TOXITURF),
    HOENN_TO_NATIONAL(PEBBLER),
    HOENN_TO_NATIONAL(DUNEWICH),
    HOENN_TO_NATIONAL(MAJADIJUNN),
    HOENN_TO_NATIONAL(CAPYBARA),
    HOENN_TO_NATIONAL(ABARBINASH),
    HOENN_TO_NATIONAL(JARAMERA),
    HOENN_TO_NATIONAL(BLINGUIN),
    HOENN_TO_NATIONAL(BIYAKO),
    HOENN_TO_NATIONAL(BEHEKO),
    HOENN_TO_NATIONAL(HEMOKO),
    HOENN_TO_NATIONAL(LEPUCYTE),
    HOENN_TO_NATIONAL(LEUKUNEHO),
    HOENN_TO_NATIONAL(WELPROOT),
    HOENN_TO_NATIONAL(DRAEKAROT),
    HOENN_TO_NATIONAL(KARODORAUG),
    HOENN_TO_NATIONAL(COFORCHEE),
    HOENN_TO_NATIONAL(MUSTYBANE),
    HOENN_TO_NATIONAL(WANNEGG),
    HOENN_TO_NATIONAL(EGGNEGGMA),
    HOENN_TO_NATIONAL(LEVLADE),
    HOENN_TO_NATIONAL(SHOCKORE),
    HOENN_TO_NATIONAL(PLASMANTIS),
    HOENN_TO_NATIONAL(HARACE),
    HOENN_TO_NATIONAL(TORSTEVIC),
    HOENN_TO_NATIONAL(CHIKA),
    HOENN_TO_NATIONAL(SWORDUC),
    HOENN_TO_NATIONAL(GOSMARK),
    HOENN_TO_NATIONAL(CORDELICT),
    HOENN_TO_NATIONAL(MERALCORE),
    HOENN_TO_NATIONAL(RAITAIC),
    HOENN_TO_NATIONAL(NIMBOZOA),
    HOENN_TO_NATIONAL(MINOTE),
    HOENN_TO_NATIONAL(TUNAP),
    HOENN_TO_NATIONAL(BASSHARK),
    HOENN_TO_NATIONAL(SHARGUY),
    HOENN_TO_NATIONAL(SHARPREY),
    HOENN_TO_NATIONAL(CHUNGRIM),
    HOENN_TO_NATIONAL(SQUEESHY),
    HOENN_TO_NATIONAL(SQUISHIME),
    HOENN_TO_NATIONAL(OCTOHIME),
    HOENN_TO_NATIONAL(COLFIN),
    HOENN_TO_NATIONAL(MYSTICIAN),
    HOENN_TO_NATIONAL(WALRUST),
    HOENN_TO_NATIONAL(SCALLYWARG),
    HOENN_TO_NATIONAL(WAARGH),
    HOENN_TO_NATIONAL(SKELLYWARG),
    HOENN_TO_NATIONAL(CASOWARY),
    HOENN_TO_NATIONAL(PASSAWARY),
    HOENN_TO_NATIONAL(BOOZARD),
    HOENN_TO_NATIONAL(COCKABOO),
    HOENN_TO_NATIONAL(AXELFIN),
    HOENN_TO_NATIONAL(MORAGAN),
    HOENN_TO_NATIONAL(SHIVERSNAP),
    HOENN_TO_NATIONAL(EXCATATOR),
    HOENN_TO_NATIONAL(MARSOYART),
    HOENN_TO_NATIONAL(CINDRILLON),
    HOENN_TO_NATIONAL(ARMAGATTON),
    HOENN_TO_NATIONAL(FAKYSNAKY),
    HOENN_TO_NATIONAL(PANTNEY),
    HOENN_TO_NATIONAL(NYARLY),
    HOENN_TO_NATIONAL(SUDCUB),
    HOENN_TO_NATIONAL(TARDRITCH),
    HOENN_TO_NATIONAL(BLABBU),
    HOENN_TO_NATIONAL(TURRYTURRY),
    HOENN_TO_NATIONAL(FAERED),
    HOENN_TO_NATIONAL(PROMISCBUS),
    HOENN_TO_NATIONAL(GUMBORREE),
    HOENN_TO_NATIONAL(KOREMAI),
    HOENN_TO_NATIONAL(KORESATO),
    HOENN_TO_NATIONAL(DRAKULARK),
    HOENN_TO_NATIONAL(NOSFERAPTR),
    HOENN_TO_NATIONAL(OLFLOOKIE),
    HOENN_TO_NATIONAL(JUSTRICHA),
    HOENN_TO_NATIONAL(AJOKUJOKU),
    HOENN_TO_NATIONAL(GARJIRA),
    HOENN_TO_NATIONAL(GARZILLA),
    HOENN_TO_NATIONAL(YANDEMIC),
    HOENN_TO_NATIONAL(LUNASTER),
    HOENN_TO_NATIONAL(JACKABOX),
    HOENN_TO_NATIONAL(FOOLTAGE),
    HOENN_TO_NATIONAL(AETHEREAL),
    HOENN_TO_NATIONAL(MOTHRAMITY),
    HOENN_TO_NATIONAL(GLAREYALE),
    HOENN_TO_NATIONAL(LEVIALAGO),
    HOENN_TO_NATIONAL(RETROROACH),
    HOENN_TO_NATIONAL(NEOROACH),
    HOENN_TO_NATIONAL(SPITFAX),
    HOENN_TO_NATIONAL(RAPSCALEON),
    HOENN_TO_NATIONAL(AGOMAGO),
    HOENN_TO_NATIONAL(MORFTREE),
    HOENN_TO_NATIONAL(EPOCHOTL),
    HOENN_TO_NATIONAL(VIVISU),
    HOENN_TO_NATIONAL(SOLASU),
    HOENN_TO_NATIONAL(SUMMERASU),
    HOENN_TO_NATIONAL(OROFLOW),
    HOENN_TO_NATIONAL(ORROCAST),
    HOENN_TO_NATIONAL(ORROWHELM),
    HOENN_TO_NATIONAL(SHAYON),
    HOENN_TO_NATIONAL(LUOSHAN),
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_TIDPIT - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SLIDLOW - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CARDIOVOR - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FIEFREET - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BALBYRN - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BLAZIZAHAK - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_QUILWARD - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BONFEU - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_INFRAREC - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BERM - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MOODA - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BERMUDON - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_EBIBI - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAKIBI - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EBIROSASHI - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KITIKITI - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MOSKOPO - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ABSOLARIA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_SNOTLOUD - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SICKBEAT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SPRYTE - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GUMONA - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NANGGAL - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHEEDRAKE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TRANSERA - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BIVAGUE - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LUSCKAW - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SADSOD - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAERACHOLY - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LUMELMO - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LUMENDELA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_STOMAWAY - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CRAWLAXY - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAGNALURE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAGNANICOR - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CRYPLIN - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_UHEFOE - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MYSTOMANIA - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LYORESA - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KODOUGH - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_COFFIDDLE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CRAVERAVE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FUZKY - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_COOLMUTTE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CREAM - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_LOTTABATS - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUDUNSPARS - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_POMELONIAN - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GOURDOUG - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FOGGLEHIND - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MATCHLIT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_YAGANGRAN - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PIDIUM - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MEDGEON - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAGGORDE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FLAGUE - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CULTIPEX - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EERIKO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MANNIKO - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KOWAKO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_UMBRAT - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CHIROBERRA - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WEROBERRA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SACKYTWACK - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_STRAWNGMAN - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LAWPARD - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_OOHBAABA - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GOLDEROCK - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAYNIMO - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BUTTERWEE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PETRIPA - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CATTOWYRM - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BRAMBOOZLE - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HOAXPOCUS - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PITAGON - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PUTREGON - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GOLTIGATOR - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KAPRIKOLA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BLOTTA - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SCHACHTTA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SYLVREIGN - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CATTUCLID - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FRACTOFLY - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GRAVELITO - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MEGALITO - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_COMBUN - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HAIBUN - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BURBUN - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_INGBUN - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CHAFFAW - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FERROR - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_COBBTLE - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MONTORT - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BOLTEROCK - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VOREON - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CORISP - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KROLPYRE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TOXITIDE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TOXITURF - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PEBBLER - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUNEWICH - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MAJADIJUNN - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CAPYBARA - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ABARBINASH - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_JARAMERA - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BLINGUIN - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BIYAKO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BEHEKO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HEMOKO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LEPUCYTE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LEUKUNEHO - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WELPROOT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DRAEKAROT - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KARODORAUG - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_COFORCHEE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MUSTYBANE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WANNEGG - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EGGNEGGMA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LEVLADE - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHOCKORE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PLASMANTIS - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HARACE - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TORSTEVIC - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CHIKA - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SWORDUC - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GOSMARK - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CORDELICT - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MERALCORE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RAITAIC - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NIMBOZOA - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MINOTE - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TUNAP - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BASSHARK - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHARGUY - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHARPREY - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CHUNGRIM - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SQUEESHY - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SQUISHIME - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_OCTOHIME - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_COLFIN - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MYSTICIAN - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WALRUST - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SCALLYWARG - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WAARGH - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SKELLYWARG - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CASOWARY - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PASSAWARY - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BOOZARD - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_COCKABOO - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AXELFIN - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MORAGAN - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHIVERSNAP - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EXCATATOR - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MARSOYART - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CINDRILLON - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ARMAGATTON - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FAKYSNAKY - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PANTNEY - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NYARLY - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SUDCUB - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TARDRITCH - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BLABBU - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TURRYTURRY - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FAERED - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PROMISCBUS - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GUMBORREE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KOREMAI - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KORESATO - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DRAKULARK - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NOSFERAPTR - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_OLFLOOKIE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_JUSTRICHA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AJOKUJOKU - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GARJIRA - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GARZILLA - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_YANDEMIC - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LUNASTER - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_JACKABOX - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FOOLTAGE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AETHEREAL - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MOTHRAMITY - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GLAREYALE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LEVIALAGO - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RETROROACH - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NEOROACH - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SPITFAX - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_RAPSCALEON - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AGOMAGO - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MORFTREE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_EPOCHOTL - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VIVISU - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SOLASU - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SUMMERASU - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_OROFLOW - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ORROCAST - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_WALLY - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_POTTRICIA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_ZYGARDE_10_DORMANT - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ZYGARDE_50_DORMANT - 1]   = ANIM_TIP_MOVE_FORWARD,
...
void CalculateMonStats(struct Pokemon *mon)
{
    ...
    else if ((species == SPECIES_SHUNYONG || species == SPECIES_SHUNYONG_GOLDEN_OFFENSE) && IsShunyongBattle())
    {
        newMaxHP = 2500;
    }
                ...
                if (effectFlags & 1)
                {
                    ...
                    case 1: // ITEM4_EV_ATK
                        ...
                        if (evChange > 0) // Increasing EV (HP or Atk)
                        {
                            ...
                            if (evCount + temp2 > maxTotalEVs)
                                temp2 += maxTotalEVs - (evCount + temp2);
