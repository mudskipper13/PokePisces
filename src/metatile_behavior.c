...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_PINK_GRASS]                      = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
    ...
    [MB_ENCOUNTER_SHALLOW_WATER]         = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_LONG_GRASS || metatileBehavior == MB_CHIMNEY_GRASS
    || metatileBehavior == MB_PINK_GRASS || metatileBehavior == MB_SNOWY_GRASS || metatileBehavior == MB_GOLD_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsChimneyGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_CHIMNEY_GRASS)
        return TRUE;
    else
        return FALSE;
}

bool8 MetatileBehavior_IsPinkGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_PINK_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsGoldGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_GOLD_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsShallowFlowingWater(u8 metatileBehavior)
{
    if (metatileBehavior == MB_SHALLOW_WATER
     || metatileBehavior == MB_STAIRS_OUTSIDE_ABANDONED_SHIP
     || metatileBehavior == MB_SHOAL_CAVE_ENTRANCE
     || metatileBehavior == MB_ENCOUNTER_SHALLOW_WATER)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsCuttableGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_TALL_GRASS
     ...
     || metatileBehavior == MB_PINK_GRASS
     || metatileBehavior == MB_SNOWY_GRASS
     || metatileBehavior == MB_GOLD_GRASS)
        return TRUE;
    else
        return FALSE;
}
