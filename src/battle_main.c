...
static const u8 sText_ShedinjaJpnName[] = _(""); // Nukenin
...
{
    [TRAINER_CLASS_BIRD_WATCHER] = ITEM_NEST_BALL,
    [TRAINER_CLASS_SEA_SHELLER] = ITEM_LURE_BALL,
    [TRAINER_CLASS_TUBER_M] = ITEM_LURE_BALL,
    [TRAINER_CLASS_TUBER_F] = ITEM_LURE_BALL,
    [TRAINER_CLASS_FAIRYTALE_GIRL] = ITEM_LOVE_BALL,
    [TRAINER_CLASS_LADY] = ITEM_LUXURY_BALL,
    [TRAINER_CLASS_NINJA_BOY] = ITEM_NEST_BALL,
    [TRAINER_CLASS_BUG_MANIAC] = ITEM_NET_BALL,
    [TRAINER_CLASS_BIRD_KEEPER] = ITEM_NEST_BALL,
    [TRAINER_CLASS_AROMA_LADY] = ITEM_HEAL_BALL,
    [TRAINER_CLASS_CHARMER] = ITEM_LOVE_BALL,
    [TRAINER_CLASS_BEAUTY] = ITEM_GREAT_BALL,
    [TRAINER_CLASS_HIKER] = ITEM_HEAVY_BALL,
    [TRAINER_CLASS_MECHANIC] = ITEM_TIMER_BALL,
    [TRAINER_CLASS_INTERVIEWER] = ITEM_REPEAT_BALL,
    [TRAINER_CLASS_METEOROLOGISTS] = ITEM_TIMER_BALL,
    [TRAINER_CLASS_RICH_BOY] = ITEM_LUXURY_BALL,
    [TRAINER_CLASS_RUIN_MANIAC] = ITEM_SAFARI_BALL,
    [TRAINER_CLASS_RUIN_HUNTER] = ITEM_SAFARI_BALL,
    [TRAINER_CLASS_SKIER] = ITEM_PREMIER_BALL,
    [TRAINER_CLASS_ICE_POPS] = ITEM_GREAT_BALL,
    [TRAINER_CLASS_HARDHATTER] = ITEM_HEAVY_BALL,
    [TRAINER_CLASS_GAMBLER] = ITEM_LUXURY_BALL,
    [TRAINER_CLASS_SR_AND_JR] = ITEM_LEVEL_BALL,
    [TRAINER_CLASS_GILDED_MONK] = ITEM_PARK_BALL,
    [TRAINER_CLASS_CHEERLEADERS] = ITEM_SPORT_BALL,
    [TRAINER_CLASS_HUNTER] = ITEM_MOON_BALL,
    [TRAINER_CLASS_LEADER] = ITEM_ULTRA_BALL,
    [TRAINER_CLASS_DOME_ACE] = ITEM_DREAM_BALL,
    [TRAINER_CLASS_MAGMA_ADMIN] = ITEM_FRIEND_BALL,
    [TRAINER_CLASS_AQUA_LEADER] = ITEM_SAFARI_BALL,
    [TRAINER_CLASS_AQUA_ADMIN] = ITEM_FRIEND_BALL,
    [TRAINER_CLASS_RIVAL] = ITEM_DUSK_BALL,
    [TRAINER_CLASS_TEAM_AQUA] = ITEM_FRIEND_BALL,
    [TRAINER_CLASS_TEAM_MAGMA] = ITEM_FRIEND_BALL,
    [TRAINER_CLASS_YOU_TUBER] = ITEM_SPORT_BALL,
    [TRAINER_CLASS_SNOW_KID] = ITEM_PREMIER_BALL,
    [TRAINER_CLASS_SNOW_CHILD] = ITEM_PREMIER_BALL,
    [TRAINER_CLASS_POKEFAN] = ITEM_LEVEL_BALL,
    [TRAINER_CLASS_OLD_COUPLE] = ITEM_LEVEL_BALL,
    [TRAINER_CLASS_FISHERMAN] = ITEM_NET_BALL,
    [TRAINER_CLASS_ANGLER] = ITEM_LURE_BALL,
    [TRAINER_CLASS_VANDAL] = ITEM_QUICK_BALL,
    [TRAINER_CLASS_PRESENTER] = ITEM_SPORT_BALL,
    [TRAINER_CLASS_GUITARIST] = ITEM_MOON_BALL,
    [TRAINER_CLASS_BASSIST] = ITEM_QUICK_BALL,
    [TRAINER_CLASS_HEX_MANIAC] = ITEM_DUSK_BALL,
    [TRAINER_CLASS_COLLECTOR] = ITEM_BEAST_BALL,
    [TRAINER_CLASS_PKMN_BREEDER] = ITEM_NEST_BALL,
    [TRAINER_CLASS_PKMN_RANCHER] = ITEM_NEST_BALL,
    ...
    [TRAINER_CLASS_SHRINE_MAIDEN] = ITEM_CHERISH_BALL,
    [TRAINER_CLASS_PLUMBER] = ITEM_GREAT_BALL,
    [TRAINER_CLASS_WALTZER] = ITEM_MOON_BALL,
    [TRAINER_CLASS_DANCER] = ITEM_DREAM_BALL,
    [TRAINER_CLASS_JANITOR] = ITEM_REPEAT_BALL,
    ...
    [TRAINER_CLASS_PSYCHIC] = ITEM_PREMIER_BALL,
    [TRAINER_CLASS_ESPER] = ITEM_PREMIER_BALL,
    [TRAINER_CLASS_GENTLEMAN] = ITEM_LUXURY_BALL,
    [TRAINER_CLASS_MADAME] = ITEM_LUXURY_BALL,
    [TRAINER_CLASS_PROFITEER] = ITEM_PARK_BALL,
    [TRAINER_CLASS_MOGUL] = ITEM_HEAL_BALL,
    [TRAINER_CLASS_RESEARCHER] = ITEM_ULTRA_BALL,
    [TRAINER_CLASS_SCIENTIST] = ITEM_ULTRA_BALL,
    [TRAINER_CLASS_GO_GETTER] = ITEM_DREAM_BALL,
    [TRAINER_CLASS_UPSTART] = ITEM_MOON_BALL,
    [TRAINER_CLASS_DRAGON_TAMER] = ITEM_CHERISH_BALL,
    [TRAINER_CLASS_DRAGON_CALLER] = ITEM_CHERISH_BALL,
    [TRAINER_CLASS_COOLTRAINER] = ITEM_BEAST_BALL,
    [TRAINER_CLASS_TWINS] = ITEM_LOVE_BALL,
    [TRAINER_CLASS_YOUNG_COUPLE] = ITEM_LOVE_BALL,
    [TRAINER_CLASS_ANGY_WANGY] = ITEM_REPEAT_BALL,
    [TRAINER_CLASS_LANDSCAPERS] = ITEM_SPORT_BALL,
    [TRAINER_CLASS_BREADWINNER] = ITEM_HEAL_BALL,
    [TRAINER_CLASS_TOPAZ_ACOLYTE] = ITEM_PARK_BALL,
    [TRAINER_CLASS_MARCHONESS] = ITEM_DREAM_BALL,
};
#endif
...
void FaintClearSetData(u32 battler)
{
    ...
    gProtectStructs[battler].drakenGuarded = FALSE;
        ...
        else
        {
            ...
            for (battler = 0; battler < gBattlersCount; battler++)
            {
                  ...
                  && gChosenActionByBattler[battler] != B_ACTION_THROW_BALL)
                {
                    ...
                    gBattleStruct->quickDrawRandom[battler] = RandomPercentage(RNG_QUICK_DRAW, 50);
                    turnOrderId++;
                }
            }
            for (i = 0; i < gBattlersCount - 1; i++)
...
static void TurnValuesCleanUp(bool8 var0)
{
    ...
    gSideStatuses[B_SIDE_PLAYER] &= ~(SIDE_STATUS_QUICK_GUARD | SIDE_STATUS_WIDE_GUARD | SIDE_STATUS_MAT_BLOCK);
    gSideStatuses[B_SIDE_OPPONENT] &= ~(SIDE_STATUS_QUICK_GUARD | SIDE_STATUS_WIDE_GUARD | SIDE_STATUS_MAT_BLOCK);
