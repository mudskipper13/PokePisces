...
BattleScript_EffectTidyUpDoMoveAnimation::
	...
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_SPEED, MAX_STAT_STAGE, BattleScript_TidyUpEnd
BattleScript_TidyUpDoMoveAnim::
	...
	playstatchangeanimation BS_ATTACKER, BIT_ATK | BIT_SPEED, 0
	setstatchanger STAT_ATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_TidyUpTrySpeed
...
BattleScript_TidyUpTrySpeed::
	setstatchanger STAT_SPEED, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_TidyUpEnd
...
BattleScript_EffectNightmare::
	jumpifstatus BS_TARGET, STATUS1_SLEEP, BattleScript_TryNightmareSpDefDrop
	jumpifability BS_TARGET, ABILITY_COMATOSE, BattleScript_TryNightmareSpDefDrop
	attackcanceler
	attackstring
	ppreduce
	jumpifsubstituteblocks BattleScript_ButItFailed
	...
	goto BattleScript_MoveEnd
BattleScript_TryNightmareSpDefDrop:
...
BattleScript_GulpMissileGulping::
	...
	jumpifterucharmprotected BS_ATTACKER, BattleScript_GulpMissileNoDmgGulping
	healthbarupdate BS_ATTACKER
	datahpupdate BS_ATTACKER
	tryfaintmon BS_ATTACKER
...
BattleScript_MockingPrevented:
	...
	setbyte gBattleCommunication STAT_SPATK
	stattextbuffer BS_TARGET
	printstring STRINGID_DEFENSESWERENOTLOWERED
	waitmessage B_WAIT_TIME_LONG
	call BattleScript_TryAdrenalineOrb
