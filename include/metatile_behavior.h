...
bool8 MetatileBehavior_IsChimneyGrass(u8);
bool8 MetatileBehavior_IsPinkGrass(u8);
bool8 MetatileBehavior_IsSnowyGrass(u8);
bool8 MetatileBehavior_IsGoldGrass(u8);
...
bool8 MetatileBehavior_IsWooden(u8);
bool8 MetatileBehavior_IsWhitePath(u8);
