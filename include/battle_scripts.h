...
extern const u8 BattleScript_Boundary90[];
...
extern const u8 BattleScript_DragonPokerThreeOfAKind[];
extern const u8 BattleScript_DragonPokerStraight[];
extern const u8 BattleScript_DragonPokerFlush[];
extern const u8 BattleScript_DragonPokerFullHouse[];
extern const u8 BattleScript_DragonPokerFourOfAKind[];
...
extern const u8 BattleScript_TickedFree[];
...
extern const u8 BattleScript_AtkSpAtkDown2[];
...
extern const u8 BattleScript_AtkSpdUp[];
extern const u8 BattleScript_SpAtkSpDefUp[];
...
extern const u8 BattleScript_AtkDownAgain[];
...
extern const u8 BattleScript_InfernalReignTurnDmg[];
...
extern const u8 BattleScript_WatcherActivates[];
...
extern const u8 BattleScript_ItemNoSpecificStatLoss[];
...
extern const u8 BattleScript_SteadFastFlinchPrevention[];
...
extern const u8 BattleScript_CuteCharmActivates2[];
...
extern const u8 BattleScript_BerryCurePanicEnd2[];
extern const u8 BattleScript_BerryCurePanicRet[];
extern const u8 BattleScript_BerryCureBloomEnd2[];
extern const u8 BattleScript_BerryCureBloomRet[];
...
extern const u8 BattleScript_FavorScarfCuredStatusEnd2[];
...
extern const u8 BattleScript_ResetActivates[];
extern const u8 BattleScript_ResetActivates2[];
extern const u8 BattleScript_ResetActivates3[];
extern const u8 BattleScript_NormaliseBuffs[];
...
extern const u8 BattleScript_InvertStats2[];
...
extern const u8 BattleScript_CornnBerryEnd[];
extern const u8 BattleScript_SpelonBerryActivatesRet[];
extern const u8 BattleScript_SpelonBerryEnd[];
extern const u8 BattleScript_BelueBerryActivatesRet[];
extern const u8 BattleScript_BelueBerryEnd[];
extern const u8 BattleScript_PinapBerryActivatesRet[];
extern const u8 BattleScript_PinapBerryEnd[];
extern const u8 BattleScript_RizzBerryActivatesRet[];
extern const u8 BattleScript_RizzBerryEnd[];
extern const u8 BattleScript_RabutaBerryActivatesRet[];
extern const u8 BattleScript_RabutaBerryEnd[];
...
extern const u8 BattleScript_HondewBerryEnd[];
extern const u8 BattleScript_WepearBerryActivatesRet[];
extern const u8 BattleScript_WepearBerryEnd[];
...
extern const u8 BattleScript_HearthwarmHeal[];
...
extern const u8 BattleScript_ReversiActivated[];
extern const u8 BattleScript_ReversiDeactivated[];
...
extern const u8 BattleScript_MoveStatDrain2[];
extern const u8 BattleScript_MoveStatDrain2_PPLoss[];
extern const u8 BattleScript_MoveStatNegativeDrain[];
extern const u8 BattleScript_MoveStatNegativeDrain_PPLoss[];
...
extern const u8 BattleScript_SolarPowerActivatesEveryone[];
extern const u8 BattleScript_CursedBodyActivatesDisable[];
extern const u8 BattleScript_CursedBodyActivatesTorment[];
...
extern const u8 BattleScript_SelectingNotAllowedMoveStronghold[];
...
extern const u8 BattleScript_MoveEffectWildCharge[];
...
extern const u8 BattleScript_StickyBarb[];
extern const u8 BattleScript_HeartGift[];
...
extern const u8 BattleScript_BloomOrb[];
extern const u8 BattleScript_PanicOrb[];
...
extern const u8 BattleScript_DefenderFormChange[];
extern const u8 BattleScript_AttackerFormChangeEnd3[];
extern const u8 BattleScript_TargetFormChange[];
extern const u8 BattleScript_TargetFormChangeDisguise[];
extern const u8 BattleScript_AnticipationActivates[];
extern const u8 BattleScript_SlowStartEnds[];
extern const u8 BattleScript_SilenceActivatesArcane[];
extern const u8 BattleScript_SilenceActivatesNonArcane[];
extern const u8 BattleScript_SilenceContinues[];
extern const u8 BattleScript_StarsGraceStarts[];
extern const u8 BattleScript_HealerActivates[];
extern const u8 BattleScript_HealerActivates2[];
...
extern const u8 BattleScript_MudWaterSportActivates[];
extern const u8 BattleScript_MudSportActivates[];
extern const u8 BattleScript_WaterSportActivates[];
...
extern const u8 BattleScript_SpiderWebEndTurn[];
...
extern const u8 BattleScript_ToxicSpikesActivates[];
...
extern const u8 BattleScript_SpAtkDown[];
extern const u8 BattleScript_EvaDown[];
extern const u8 BattleScript_SpDefDown[];
extern const u8 BattleScript_AccDownAgain[];
extern const u8 BattleScript_AccDown2[];
extern const u8 BattleScript_AtkDown2Again[];
extern const u8 BattleScript_DefDown2[];
extern const u8 BattleScript_SpAtkDown2Again[];
extern const u8 BattleScript_SpDefDown2[];
extern const u8 BattleScript_SpeedDown2[];
extern const u8 BattleScript_EvaDown2[];
extern const u8 BattleScript_AtkRaise1OU[];
extern const u8 BattleScript_DefRaise1OU[];
extern const u8 BattleScript_SpAtkRaise1OU[];
extern const u8 BattleScript_SpDefRaise1OU[];
extern const u8 BattleScript_SpeedRaise1OU[];
...
extern const u8 BattleScript_SolarPowerActivatesSun[];
extern const u8 BattleScript_FairyLockEndTurn[];
