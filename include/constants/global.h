...
#define BAG_KEYITEMS_COUNT 150
#define BAG_POKEBALLS_COUNT 150
#define BAG_TMHM_COUNT 100
#define BAG_BERRIES_COUNT 46
#define BAG_MEDICINE_COUNT 150 // adjust saveblock to expand this e.g. remove unused save space
#define BAG_BATTLEITEMS_COUNT 150 // adjust saveblock to expand this e.g. remove unused save space
