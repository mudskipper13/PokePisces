...
#define GROUND_EFFECT_FLAG_CHIMNEY_GRASS_ON_SPAWN   (1 << 20)
#define GROUND_EFFECT_FLAG_CHIMNEY_GRASS_ON_MOVE    (1 << 21)
#define GROUND_EFFECT_FLAG_LAND_IN_CHIMNEY_GRASS    (1 << 22)
#define GROUND_EFFECT_FLAG_PINK_GRASS_ON_SPAWN   (1 << 23)
#define GROUND_EFFECT_FLAG_PINK_GRASS_ON_MOVE    (1 << 24)
#define GROUND_EFFECT_FLAG_LAND_IN_PINK_GRASS    (1 << 25)
#define GROUND_EFFECT_FLAG_SNOWY_GRASS_ON_SPAWN  (1 << 26)
#define GROUND_EFFECT_FLAG_SNOWY_GRASS_ON_MOVE   (1 << 27)
#define GROUND_EFFECT_FLAG_LAND_IN_SNOWY_GRASS   (1 << 28)
#define GROUND_EFFECT_FLAG_GOLD_GRASS_ON_SPAWN   (1 << 29)
#define GROUND_EFFECT_FLAG_GOLD_GRASS_ON_MOVE    (1 << 30)
#define GROUND_EFFECT_FLAG_LAND_IN_GOLD_GRASS    (1 << 31)
